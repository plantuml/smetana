...
/**
 * Offset of a data in a C structure.
 * 
...
public class OFFSET {
	...
	public OFFSET(Class reference, String name) {
		this.name = name;
		this.reference = reference;
		this.isPositiveOrZero = true;
	}

	public String toString() {
		return "OFFSET:" + reference + "->" + name;
	}

	public static boolean isStrictNegative(OFFSET v) {
		if (v == null) {
			return false;
		}
	...
	public static boolean isPositiveOrZero(OFFSET v) {
		if (v == null) {
			return true;
		}
		return v.isPositiveOrZero;
