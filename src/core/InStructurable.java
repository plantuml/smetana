...
/**
 * Something that can be in a C struct.
 * This is used to emulate pointer arithmetic in C.
 * <code>
 *   struct foo {
 *     char *data;
 *     dummy *dummy;
 ...
 *
 */
public interface InStructurable {

	/**
	 * Retrieve the structure that contains this object.
	 * 
	 * @return the parent structure.
	 */
