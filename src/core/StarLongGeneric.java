...
public class StarLongGeneric implements StarLong {

	private StarLong delegated = null;

	@Override
	public String toString() {
		return super.toString() + " " + delegated;
	}
	...
	public void set(int value) {
		if (delegated == null) {
			delegated = new StarLongNormalInteger();
		}
		if (delegated != null) {
			delegated.set(value);
			return;
	...
	public void set(StarVoid value) {
		if (delegated == null) {
			delegated = new StarLongFromStarVoid();
		}
		if (delegated != null) {
			delegated.set(value);
			return;
	...
	public int getIntegerValue() {
		return delegated.getIntegerValue();
	}
