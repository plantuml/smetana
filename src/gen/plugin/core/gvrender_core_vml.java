...
public class gvrender_core_vml {
...
// btjrd0itqwulq8xqtw1togigv
// unsigned int  graphHeight,graphWidth


// bevzgi4opmmgxwksl1lssepxc
// static int xml_isentity(char *s) 
public static Object xml_isentity() {
throw new UnsupportedOperationException();
}


// 4b9su7anr30347e1zthtrc5ym
// static void vml_bzptarray(GVJ_t * job, pointf * A, int n) 
public static Object vml_bzptarray() {
throw new UnsupportedOperationException();
}


// c7gxm1yprlzzrruo8zduf87vr
// static void vml_print_color(GVJ_t * job, gvcolor_t color) 
public static Object vml_print_color() {
throw new UnsupportedOperationException();
}


// eev3wa4msf4zlx50e30mpo9cg
// static void vml_grstroke(GVJ_t * job, int filled) 
public static Object vml_grstroke() {
throw new UnsupportedOperationException();
}


// 5pomyedqfnet64wh6uod6vb2q
// static void vml_grfill(GVJ_t * job, int filled) 
public static Object vml_grfill() {
throw new UnsupportedOperationException();
}


// dyzsyf54kn673uhch0r5fwpg
// char *html_string(char *s) 
public static Object html_string() {
throw new UnsupportedOperationException();
}


// dur880fsg5atx9nvy1p3ela10
// static void vml_comment(GVJ_t * job, char *str) 
public static Object vml_comment() {
throw new UnsupportedOperationException();
}


// 5oyyq924hjocedbpq4l7oehzv
// static void vml_begin_job(GVJ_t * job) 
public static Object vml_begin_job() {
throw new UnsupportedOperationException();
}


// 3xv9atzf4fzy1912qmp1uvq0m
// static void vml_begin_graph(GVJ_t * job) 
public static Object vml_begin_graph() {
throw new UnsupportedOperationException();
}


// 9qyew5qsglzdy9qx7swdfe7mp
// static void vml_end_graph(GVJ_t * job) 
public static Object vml_end_graph() {
throw new UnsupportedOperationException();
}


// bl9rzlwd1nwcpeg5ugnuzqa5e
// static void vml_begin_anchor(GVJ_t * job, char *href, char *tooltip, char *target, char *id) 
public static Object vml_begin_anchor() {
throw new UnsupportedOperationException();
}


// 1x3m9i59qmjupolfx4vhxw0v7
// static void vml_end_anchor(GVJ_t * job) 
public static Object vml_end_anchor() {
throw new UnsupportedOperationException();
}


// 3w9m053yxsneu33cud9timt9t
// static void vml_textspan(GVJ_t * job, pointf p, textspan_t * span) 
public static Object vml_textspan() {
throw new UnsupportedOperationException();
}


// 7uemnirlwr6y4ngurfwnenkrx
// static void vml_ellipse(GVJ_t * job, pointf * A, int filled) 
public static Object vml_ellipse() {
throw new UnsupportedOperationException();
}


// b5kmfiqdu9573i9iqip2kkynm
// static void vml_bezier(GVJ_t * job, pointf * A, int n, int arrow_at_start, 	      int arrow_at_end, int filled) 
public static Object vml_bezier() {
throw new UnsupportedOperationException();
}


// 5k4nobte06p1zh3op4d1ubct2
// static void vml_polygon(GVJ_t * job, pointf * A, int n, int filled) 
public static Object vml_polygon() {
throw new UnsupportedOperationException();
}


// elv8mlcw3hix4jbez3msjvwl3
// static void vml_polyline(GVJ_t * job, pointf * A, int n) 
public static Object vml_polyline() {
throw new UnsupportedOperationException();
}


// d0v2ctv7fk7xyjshwyllfkcpt
// static char *vml_knowncolors[] = 


// i4obs2vdal7jcgzcmqpiabad
// gvrender_engine_t vml_engine = 


// f19ql4f0xzpd3o01gsqdld6hy
// gvrender_features_t render_features_vml = 


// do5wawnnfhzf2g7r3wftgsy4o
// gvdevice_features_t device_features_vml = 


// 8yst1dqk2z5q83e32t3wmrr75
// gvdevice_features_t device_features_vmlz = 


// 65n0gf390fc3raflk4vdbxp9y
// gvplugin_installed_t gvrender_vml_types[] = 


// 2pmjyl28in77fbh1nf0xxn20c
