...
public class gvrender_core_fig {
...
// 4ywl2my7bw54moba4jmobv1yt
// static int Depth


// 24aq6p5lcdj2syp7x3lzhrm2z
// static void figptarray(GVJ_t *job, pointf * A, int n, int close) 
public static Object figptarray() {
throw new UnsupportedOperationException();
}


// awvjm7vo78a8gt65eab40rjv3
// static char *fig_string(char *s) 
public static Object fig_string() {
throw new UnsupportedOperationException();
}


// c9fcem04fcrcl4xar0xmrikcd
// static int figColorResolve(int *new, int r, int g, int b) 
public static Object figColorResolve() {
throw new UnsupportedOperationException();
}


// 11cnk7gp9g9cdub4ga2u8jszp
// static char *figcolor[] = 


// gzljm8fc35nb7t3z7v13qxsl
// static void fig_resolve_color(GVJ_t *job, gvcolor_t * color) 
public static Object fig_resolve_color() {
throw new UnsupportedOperationException();
}


// c3uupx3hhjief1a1ojoxqlei8
// static void fig_line_style(obj_state_t *obj, int *line_style, double *style_val) 
public static Object fig_line_style() {
throw new UnsupportedOperationException();
}


// 68usbfogj1fgje2tybh6k9wpv
// static void fig_comment(GVJ_t *job, char *str) 
public static Object fig_comment() {
throw new UnsupportedOperationException();
}


// chft6a85fdy4m0a4qvlktap4v
// static void fig_begin_graph(GVJ_t * job) 
public static Object fig_begin_graph() {
throw new UnsupportedOperationException();
}


// bkqqnus0p5047dqnvj8xcmwcg
// static void fig_end_graph(GVJ_t * job) 
public static Object fig_end_graph() {
throw new UnsupportedOperationException();
}


// 4fe9t0bc320bhbivcpnyky0mw
// static void fig_begin_page(GVJ_t * job) 
public static Object fig_begin_page() {
throw new UnsupportedOperationException();
}


// c1nntth6qdw8345t3z9utbg2i
// static void fig_begin_node(GVJ_t * job) 
public static Object fig_begin_node() {
throw new UnsupportedOperationException();
}


// cn90ubz6l6mp7s7mvo837mo8z
// static void fig_end_node(GVJ_t * job) 
public static Object fig_end_node() {
throw new UnsupportedOperationException();
}


// 6al11pypki5kl1rtaf7punyjv
// static void fig_begin_edge(GVJ_t * job) 
public static Object fig_begin_edge() {
throw new UnsupportedOperationException();
}


// 7a9nvpozbckjvcqfyiziwmerf
// static void fig_end_edge(GVJ_t * job) 
public static Object fig_end_edge() {
throw new UnsupportedOperationException();
}


// atanrd109mhjit7l5yznk1hv5
// static void fig_textspan(GVJ_t * job, pointf p, textspan_t * span) 
public static Object fig_textspan() {
throw new UnsupportedOperationException();
}


// 7ixqa0qdgr9opq7q4q5jpx74w
// static void fig_ellipse(GVJ_t * job, pointf * A, int filled) 
public static Object fig_ellipse() {
throw new UnsupportedOperationException();
}


// dpdbiw2hwpr0l9d7twix3alfg
// static void fig_bezier(GVJ_t * job, pointf * A, int n, int arrow_at_start, 	      int arrow_at_end, int filled) 
public static Object fig_bezier() {
throw new UnsupportedOperationException();
}


// b6u8ndxbe2p5x3otn62y515vj
// static void fig_polygon(GVJ_t * job, pointf * A, int n, int filled) 
public static Object fig_polygon() {
throw new UnsupportedOperationException();
}


// 1afauosj6wr5u4dhbjovifgei
// static void fig_polyline(GVJ_t * job, pointf * A, int n) 
public static Object fig_polyline() {
throw new UnsupportedOperationException();
}


// am7q7qqmqp3cj87eqv61ag2tt
// gvrender_engine_t fig_engine = 


// ar7bi3fv0al906tc46yku4qmt
// static char *fig_knowncolors[] = 


// 2qcp4lauqvs4msrc3ulasniqr
// gvrender_features_t render_features_fig = 


// 1hl171y3pew4vgjt6v4vsax61
// gvdevice_features_t device_features_fig = 


// 472dfp6vcnqblz1b82crth1dc
// gvplugin_installed_t gvrender_fig_types[] = 


// 3dtvxqen0zlfmzz1ygg4lnixq
