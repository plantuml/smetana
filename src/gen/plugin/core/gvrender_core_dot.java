...
public class gvrender_core_dot {
...
// 9u9ddh5oeqjnkh6gb2tfp88y1
// static agxbuf* xbufs[] = 


// cf69o2d8bfvl354bx5dd5ac0e
// static double penwidth [] = 


// 9wf85aesqstltvkdjt9p083n0
// static unsigned int textflags[EMIT_ELABEL+1]


// 7ivt3fjvux748h2yxbenc8bqq
// static xdot_state_t* xd


// 1wkd9anhtvlykvgmpcy4zkduu
// static void xdot_str_xbuf (agxbuf* xb, char* pfx, char* s) 
public static Object xdot_str_xbuf() {
throw new UnsupportedOperationException();
}


// mk0pj46oyko8l6ihsvvttvsc
// static void xdot_str (GVJ_t *job, char* pfx, char* s) 
public static Object xdot_str() {
throw new UnsupportedOperationException();
}


// 9uxhmu9h5insv750upobc4o0l
// static void xdot_trim_zeros (char* buf, int addSpace) 
public static Object xdot_trim_zeros() {
throw new UnsupportedOperationException();
}


// cot7kk25j8se9g2df0gbmku2a
// static void xdot_fmt_num (char* buf, double v) 
public static Object xdot_fmt_num() {
throw new UnsupportedOperationException();
}


// d2kq7iarnvxb8dkbj93p7ug4v
// static void xdot_point(agxbuf *xbuf, pointf p) 
public static Object xdot_point() {
throw new UnsupportedOperationException();
}


// 633vtcrwss117gqzfi65hphsk
// static void xdot_num(agxbuf *xbuf, double v) 
public static Object xdot_num() {
throw new UnsupportedOperationException();
}


// 21r3xgncf7w8o613kfnmva18a
// static void xdot_points(GVJ_t *job, char c, pointf * A, int n) 
public static Object xdot_points() {
throw new UnsupportedOperationException();
}


// 9kyijycd11rekgoyg64rgqh44
// static char* color2str (unsigned char rgba[4]) 
public static Object color2str() {
throw new UnsupportedOperationException();
}


// blqpsel4jzy8tyzcf9wk6ratz
// static void xdot_pencolor (GVJ_t *job) 
public static Object xdot_pencolor() {
throw new UnsupportedOperationException();
}


// 3aob3mp6ea6z3uiuz7je5xgnp
// static void xdot_fillcolor (GVJ_t *job) 
public static Object xdot_fillcolor() {
throw new UnsupportedOperationException();
}


// akblfseh504uvt16lpiz8w2rs
// static void xdot_style (GVJ_t *job) 
public static Object xdot_style() {
throw new UnsupportedOperationException();
}


// djj0v1y6ft33l01s92mhmr3j1
// static void xdot_end_node(GVJ_t* job) 
public static Object xdot_end_node() {
throw new UnsupportedOperationException();
}


// ephot24v485u441t22spc1qxd
// static void xdot_end_edge(GVJ_t* job) 
public static Object xdot_end_edge() {
throw new UnsupportedOperationException();
}


// bjiut4wm6v5m0rmxi0pc6gjd1
// static void xdot_end_cluster(GVJ_t * job) 
public static Object xdot_end_cluster() {
throw new UnsupportedOperationException();
}


// 8w9h04r6wb5w595zzittoeka4
// static unsigned short versionStr2Version (char* str) 
public static Object versionStr2Version() {
throw new UnsupportedOperationException();
}


// 8r74hkcombshpb14abtof5jos
// static void xdot_begin_graph (graph_t *g, int s_arrows, int e_arrows, format_type id) 
public static Object xdot_begin_graph() {
throw new UnsupportedOperationException();
}


// 7gmldg0t56v9tzo0t8s47hbd0
// static void dot_begin_graph(GVJ_t *job) 
public static Object dot_begin_graph() {
throw new UnsupportedOperationException();
}


// adu5nn8dymsuz32epd4iqns6u
// static void xdot_end_graph(graph_t* g) 
public static Object xdot_end_graph() {
throw new UnsupportedOperationException();
}


// 70q1wuw3ttjfmzsmxk0h9lmaw
// static void dot_end_graph(GVJ_t *job) 
public static Object dot_end_graph() {
throw new UnsupportedOperationException();
}


// miu9dqoprpn4z02dr1v5dp5m
// static unsigned int flag_masks[] = 


// cxy8ygsrutpg71gnj7rvevr82
// static void xdot_textspan(GVJ_t * job, pointf p, textspan_t * span) 
public static Object xdot_textspan() {
throw new UnsupportedOperationException();
}


// 951oub23cl7586oxghh5so2n4
// static void xdot_color_stop (agxbuf* xb, float v, gvcolor_t* clr) 
public static Object xdot_color_stop() {
throw new UnsupportedOperationException();
}


// 9mnvpmkdmaic8u0kc4m2n4lat
// static void xdot_gradient_fillcolor (GVJ_t* job, int filled, pointf* A, int n) 
public static Object xdot_gradient_fillcolor() {
throw new UnsupportedOperationException();
}


// elpdgf7i39797gvcc6b2t7ff0
// static void xdot_ellipse(GVJ_t * job, pointf * A, int filled) 
public static Object xdot_ellipse() {
throw new UnsupportedOperationException();
}


// 4lnrf12q3ldkwy8zf6gci2pks
// static void xdot_bezier(GVJ_t * job, pointf * A, int n, int arrow_at_start, int arrow_at_end, int filled) 
public static Object xdot_bezier() {
throw new UnsupportedOperationException();
}


// dqb35ass6fhia5ed3fazmq2me
// static void xdot_polygon(GVJ_t * job, pointf * A, int n, int filled) 
public static Object xdot_polygon() {
throw new UnsupportedOperationException();
}


// e7grmvqgv9168jtqtt87zmzyy
// static void xdot_polyline(GVJ_t * job, pointf * A, int n) 
public static Object xdot_polyline() {
throw new UnsupportedOperationException();
}


// eykvrl427om1rgwd7xrbbwrzk
// void core_loadimage_xdot(GVJ_t * job, usershape_t *us, boxf b, boolean filled) 
public static Object core_loadimage_xdot() {
throw new UnsupportedOperationException();
}


// 8pi2ts65r8gsvbkjt5wq965nq
// gvrender_engine_t dot_engine = 


// 1plhtdsvqvsimvarzf4jj1eq7
// gvrender_engine_t xdot_engine = 


// au6z2onamntzabqj683rh3n3a
// gvrender_features_t render_features_dot = 


// 6f9e1l4u72pnxzq9wtm1r9lti
// gvrender_features_t render_features_xdot = 


// 3lwgnw04i5fjt5ies1vspsbt6
// gvdevice_features_t device_features_canon = 


// blql9jmu6ahfd8lqid7tast8h
// gvdevice_features_t device_features_dot = 


// 8t8p2uw0f9lt9lbs33nt9zhpy
// gvplugin_installed_t gvrender_dot_types[] = 


// 4p12wx67x4s3z9tqpkk0xnq2g
