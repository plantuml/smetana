...
public class gvtextlayout_quartz {
...
// 52u8uvto61st1yybermmoobx4
// boolean quartz_textlayout(textspan_t *para, char **fontpath) 
public static Object quartz_textlayout() {
throw new UnsupportedOperationException();
}


// de5sywhq8wh5pzoq0sfq132nv
// static gvtextlayout_engine_t quartz_textlayout_engine = 
@TranslatedBy("plantuml")
public static gvtextlayout_engine_t quartz_textlayout_engine = new gvtextlayout_engine_t(new h.gvtextlayout_engine_s.textlayout() {
	public boolean function(textspan_t span, StarStarChar fontpath) {
		throw new UnsupportedOperationException();
	}
});
// ellcmweumipu7atjflo4ohiaz
// gvplugin_installed_t gvtextlayout_quartz_types[] = 
@TranslatedBy("plantuml") 
public static gvplugin_installed_t[] gvtextlayout_quartz_types = new gvplugin_installed_t[]{
new gvplugin_installed_t(0, JUtils.asStarChar("textlayout"), 8, quartz_textlayout_engine, null),
null
};
