...
public class gvlayout_dot_layout {
...
// 3rtanuqep8p4j1ff0fu8pc317
// gvlayout_engine_t dotgen_engine = 
@TranslatedBy("plantuml") 
public static gvlayout_engine_t dotgen_engine = new gvlayout_engine_t(
		new h.gvlayout_engine_s.layout(){
			public StarVoid function(Agraph_s g) {
				throw new UnsupportedOperationException();
			}}
		,
		new h.gvlayout_engine_s.cleanup() {
			public StarVoid function(Agraph_s g) {
				throw new UnsupportedOperationException();
			}}
);
// d72gzhpu1133ozfmxotx96w15
// gvlayout_features_t dotgen_features = 
@TranslatedBy("plantuml") 
public static gvlayout_features_t dotgen_features = new gvlayout_features_t(1<<0);
// b4znay22fp8g1gn9bsyovltke
// gvplugin_installed_t gvlayout_dot_layout[] = 
@TranslatedBy("plantuml") 
public static gvplugin_installed_t[] gvlayout_dot_layout = new gvplugin_installed_t[]{
new gvplugin_installed_t(0, JUtils.asStarChar("dot"), 0, dotgen_engine, dotgen_features),
null
};
}
