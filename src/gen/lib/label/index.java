...
public class index {
// 1rfaqe5urty5uyp5xb2r0idce
// LeafList_t *RTreeNewLeafList(Leaf_t * lp) 
public static Object RTreeNewLeafList() {
throw new UnsupportedOperationException();
}


// 6pvstz7axi8a7saeqe3nrrmg5
// LeafList_t *RTreeLeafListAdd(LeafList_t * llp, Leaf_t * lp) 
public static Object RTreeLeafListAdd() {
throw new UnsupportedOperationException();
}


// 6zraor7x44vrnm19d2igkvow2
// void RTreeLeafListFree(LeafList_t * llp) 
public static Object RTreeLeafListFree() {
throw new UnsupportedOperationException();
}


// 3wss9r0zgt5k06j8ovjv7hq0d
// int RTreeInsert(RTree_t * rtp, Rect_t * r, void *data, Node_t ** n, int level) 
public static Object RTreeInsert() {
throw new UnsupportedOperationException();
}


// bsc9m7d7qc06m8id896e60lkg
// static int RTreeInsert2(RTree_t * rtp, Rect_t * r, void *data, 	     Node_t * n, Node_t ** new, int level) 
public static Object RTreeInsert2() {
throw new UnsupportedOperationException();
}


// eybi74pqddw71yno71n1dxch1
// static void FreeListNode(register struct ListNode *p) 
public static Object FreeListNode() {
throw new UnsupportedOperationException();
}


// a4tq9skwvzdutka9ei6pbydrk
// int RTreeDelete(RTree_t * rtp, Rect_t * r, void *data, Node_t ** nn) 
public static Object RTreeDelete() {
throw new UnsupportedOperationException();
}


// bax12o5n6n8s94wnn7cxgn99
// static int RTreeDelete2(RTree_t * rtp, Rect_t * r, void *data, Node_t * n, 	     ListNode_t ** ee) 
public static Object RTreeDelete2() {
throw new UnsupportedOperationException();
}
