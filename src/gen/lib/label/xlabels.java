...
// 1lrfssuxf2e1e5pvk6j7qrff6
// extern int Verbose


// 17dmpzc4uhvmrcx0x00aw2gbc
// Dtdisc_t Hdisc = 


// 5p3ac8qk4gnne5hj1dc21ysi
// static int icompare(Dt_t * dt, void * v1, void * v2, Dtdisc_t * disc) 
public static Object icompare() {
throw new UnsupportedOperationException();
}


// 88mbfm305igsr7cew5qx6yldp
// static XLabels_t *xlnew(object_t * objs, int n_objs, 			xlabel_t * lbls, int n_lbls, 			label_params_t * params) 
public static Object xlnew() {
throw new UnsupportedOperationException();
}


// apvhod2s1yjb8717rb7gie2kb
// static void xlfree(XLabels_t * xlp) 
public static Object xlfree() {
throw new UnsupportedOperationException();
}


// 6lz36gkh8fla3z6f0lxniy368
// static int floorLog2(unsigned int n) 
public static Object floorLog2() {
throw new UnsupportedOperationException();
}


// uvnzthcpf4xiih05gxie2rx1
// unsigned int xlhorder(XLabels_t * xlp) 
public static Object xlhorder() {
throw new UnsupportedOperationException();
}


// 9lkyvq87bawe3yon7bdwvcjzq
// static unsigned int hd_hil_s_from_xy(point p, int n) 
public static Object hd_hil_s_from_xy() {
throw new UnsupportedOperationException();
}


// bpkzwylrchx5wta1qhytfgbtr
// static double aabbaabb(Rect_t * r, Rect_t * s) 
public static Object aabbaabb() {
throw new UnsupportedOperationException();
}


// 2g71cq6f8w5jbmbnn2x9y5qfq
// static int lblenclosing(object_t * objp, object_t * objp1) 
public static Object lblenclosing() {
throw new UnsupportedOperationException();
}


// dq1wkb4oxshdggv6cwtgas6m
// static void objp2rect(object_t * op, Rect_t * r) 
public static Object objp2rect() {
throw new UnsupportedOperationException();
}


// 71b5ttp3xs7lo9fqgb7ypyqgx
// static void objplp2rect(object_t * objp, Rect_t * r) 
public static Object objplp2rect() {
throw new UnsupportedOperationException();
}


// 1lhc4siezoo1c4qnnp2o264ze
// static Rect_t objplpmks(XLabels_t * xlp, object_t * objp) 
public static Object objplpmks() {
throw new UnsupportedOperationException();
}


// calnhom3s9dqvvi6crrz3h2wp
// static int getintrsxi(XLabels_t * xlp, object_t * op, object_t * cp) 
public static Object getintrsxi() {
throw new UnsupportedOperationException();
}


// 52awwxu810dg9a2pjq45aomam
// static double recordointrsx(XLabels_t * xlp, object_t * op, object_t * cp, Rect_t * rp, 	      double a, object_t * intrsx[9]) 
public static Object recordointrsx() {
throw new UnsupportedOperationException();
}


// 2umrncgkunxoyeuc8i9hd5pwa
// static double recordlintrsx(XLabels_t * xlp, object_t * op, object_t * cp, Rect_t * rp, 	      double a, object_t * intrsx[9]) 
public static Object recordlintrsx() {
throw new UnsupportedOperationException();
}


// 2td62i5hus8obwt8j1lo3ddj9
// static BestPos_t xlintersections(XLabels_t * xlp, object_t * objp, object_t * intrsx[9]) 
public static Object xlintersections() {
throw new UnsupportedOperationException();
}


// 8rxvucqsqnqej6h8p1osfnk4b
// static BestPos_t xladjust(XLabels_t * xlp, object_t * objp) 
public static Object xladjust() {
throw new UnsupportedOperationException();
}


// e29g2hwlogx0zchsnvi464c7t
// static int xlhdxload(XLabels_t * xlp) 
public static Object xlhdxload() {
throw new UnsupportedOperationException();
}


// 26qpvnyd6tmdut8i2wo4itza3
// static void xlhdxunload(XLabels_t * xlp) 
public static Object xlhdxunload() {
throw new UnsupportedOperationException();
}


// 3wrxwwd3y5ts0ekr32o8vhuvv
// static int xlspdxload(XLabels_t * xlp) 
public static Object xlspdxload() {
throw new UnsupportedOperationException();
}


// 6d3fqrllm55toeo3wscwvv4ty
// static int xlinitialize(XLabels_t * xlp) 
public static Object xlinitialize() {
throw new UnsupportedOperationException();
}


// brqgbskh3z4ah8infjompibvu
// int placeLabels(object_t * objs, int n_objs, 	    xlabel_t * lbls, int n_lbls, label_params_t * params) 
public static Object placeLabels() {
throw new UnsupportedOperationException();
}
