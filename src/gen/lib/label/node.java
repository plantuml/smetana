...
public class node {
// 9uj7ni1m6q6drtoh56w82d6m4
// Node_t *RTreeNewNode(RTree_t * rtp) 
public static Object RTreeNewNode() {
throw new UnsupportedOperationException();
}


// 65wa5vy8i5k40218lbhdibrjx
// void RTreeFreeNode(RTree_t * rtp, Node_t * p) 
public static Object RTreeFreeNode() {
throw new UnsupportedOperationException();
}


// 4qk9wkm05q2pwf20ud6g2tufg
// void InitNode(Node_t * n) 
public static Object InitNode() {
throw new UnsupportedOperationException();
}


// ruhxixxei7au9z1iaj0zggwo
// void InitBranch(Branch_t * b) 
public static Object InitBranch() {
throw new UnsupportedOperationException();
}


// 42vjqe8n5yeq2jjby00xzrotk
// Rect_t NodeCover(Node_t * n) 
public static Object NodeCover() {
throw new UnsupportedOperationException();
}


// bek56v2skz6jfvw4uggy2h5w3
// int PickBranch(Rect_t * r, Node_t * n) 
public static Object PickBranch() {
throw new UnsupportedOperationException();
}


// 2njctcrpeff95ysmv9ji34x4s
// int AddBranch(RTree_t * rtp, Branch_t * b, Node_t * n, Node_t ** new) 
public static Object AddBranch() {
throw new UnsupportedOperationException();
}


// eqzamflj58f43cflwns9cemnk
// void DisconBranch(Node_t * n, int i) 
public static Object DisconBranch() {
throw new UnsupportedOperationException();
}
