...
// 35nr8vem824c2o8bbh2eozzdn
// static char *gobble(Match_t * mp, register char *s, register int sub, 		    int *g, int clear) 
public static Object gobble() {
throw new UnsupportedOperationException();
}


// 5z46s68xknedhugxfr43fb2mh
...
// 916lq4nuyik06azjdfdbrghzw
// static int grpmatch(Match_t * mp, int g, char *s, register char *p, char *e, 	 int flags) 
public static Object grpmatch() {
throw new UnsupportedOperationException();
}


// 32fou2izhnx0uskutqir9d3ze
// int strgrpmatch(const char *b, const char *p, int *sub, int n, int flags) 
public static Object strgrpmatch() {
throw new UnsupportedOperationException();
}


// 6dyqhhenzmazw55bpey7d2pn5
// int strmatch(const char *s, const char *p) 
public static Object strmatch() {
throw new UnsupportedOperationException();
}


// 9049jzwl8npe4d4htbs23iyd2
// char *strsubmatch(const char *s, const char *p, int flags) 
public static Object strsubmatch() {
throw new UnsupportedOperationException();
}
