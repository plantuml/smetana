...
// buahkozc6g8fvqlput6871qm4
// static Void_t *poolalloc(Vmalloc_t * vm, register size_t size)      
public static Object poolalloc() {
throw new UnsupportedOperationException();
}


// a7plcpo9t0hokir79vriymtue
// static long pooladdr(Vmalloc_t * vm, register Void_t * addr)      
public static Object pooladdr() {
throw new UnsupportedOperationException();
}


// 72a3585a3d2ijb8n383y1ox3d
// static int poolfree(register Vmalloc_t * vm, register Void_t * data)      
public static Object poolfree() {
throw new UnsupportedOperationException();
}


// btzpnp5yk7mjq8fhe5a9htvcb
// static Void_t *poolresize(Vmalloc_t * vm, Void_t * data, size_t size, 			  int type)        
public static Object poolresize() {
throw new UnsupportedOperationException();
}


// b1solteil51y6n0a7bpeo55uz
// static long poolsize(Vmalloc_t * vm, Void_t * addr)      
public static Object poolsize() {
throw new UnsupportedOperationException();
}


// cpo6a8kl5jgr23gcbfcjxvc82
// static int poolcompact(Vmalloc_t * vm)     
public static Object poolcompact() {
throw new UnsupportedOperationException();
}


// a8ll110l2jw5ok4chbpjuy68z
// static Void_t *poolalign(Vmalloc_t * vm, size_t size, size_t align)       
public static Object poolalign() {
throw new UnsupportedOperationException();
}


// bfpsbg16kcnyfw3ip32erm4qz
