...
// 4hp6yofzka8q0gdm1qeffojze
// typedef unsigned char Vmuchar_t


// 15llxi2og65ax61kz0bv3hg96
...
// dd0tqt5x1tz0hz9dv28i5u88f
// 1 extern Vmextern_t _Vmextern


// 8rh8fk5xh54m09z6g63s041dx
// typedef int ssize_t


// d40755xmxkst0j9vc0pw4h9l1
// static Pfobj_t **Pftable


// ck3nzr0acmx5fux6ss2fe55lz
// static Vmalloc_t *Vmpf


// alurbwhevfnbk4jwmpyojx0nm
// static Pfobj_t *pfsearch(Vmalloc_t * vm, char *file, int line)       
public static Object pfsearch() {
throw new UnsupportedOperationException();
}


// e7ztpls9sdyt7kcutvxg92et5
// static void pfclose(Vmalloc_t * vm)     
public static Object pfclose() {
throw new UnsupportedOperationException();
}


// 76zy0fs0bp5xwpnpi064irhjz
// static void pfsetinfo(Vmalloc_t * vm, Vmuchar_t * data, size_t size, 		      char *file, int line)         
public static Object pfsetinfo() {
throw new UnsupportedOperationException();
}


// 5aykwbltrfurbwyyxhlb8n46f
// static Pfobj_t *pfsort(Pfobj_t * pf)     
public static Object pfsort() {
throw new UnsupportedOperationException();
}


// 9y4ux2gcovg7a2v6dcf2s1nbx
// static char *pfsummary(char *buf, Vmulong_t na, Vmulong_t sa, 		       Vmulong_t nf, Vmulong_t sf, Vmulong_t max, 		       Vmulong_t size)           
public static Object pfsummary() {
throw new UnsupportedOperationException();
}


// 22b9hszdrombc7xm2c0p9ntb8
// int vmprofile(Vmalloc_t * vm, int fd)      
public static Object vmprofile() {
throw new UnsupportedOperationException();
}


// 3u55q7260v0jicirt86k43v4j
// static Void_t *pfalloc(Vmalloc_t * vm, size_t size)      
public static Object pfalloc() {
throw new UnsupportedOperationException();
}


// a542e4fshlrwx1g5ut7cdsm3
// static int pffree(Vmalloc_t * vm, Void_t * data)      
public static Object pffree() {
throw new UnsupportedOperationException();
}


// d1fwoq4x8vr8h7qzthcmvdxal
// static Void_t *pfresize(Vmalloc_t * vm, Void_t * data, size_t size, 			int type)        
public static Object pfresize() {
throw new UnsupportedOperationException();
}


// 2e5uxrn2w7vk9h8kvrbprrz92
// static long pfsize(Vmalloc_t * vm, Void_t * addr)      
public static Object pfsize() {
throw new UnsupportedOperationException();
}


// 81xw1t0ybzrvfpso5ciq25l4v
// static long pfaddr(Vmalloc_t * vm, Void_t * addr)      
public static Object pfaddr() {
throw new UnsupportedOperationException();
}


// 38qny4yj9n0cyiea3sj30sdt6
// static int pfcompact(Vmalloc_t * vm)     
public static Object pfcompact() {
throw new UnsupportedOperationException();
}


// defeoyvhil2p6y3ovvk93eipb
// static Void_t *pfalign(Vmalloc_t * vm, size_t size, size_t align)       
public static Object pfalign() {
throw new UnsupportedOperationException();
}


// 62k4l90cp851pz16nb0fa8vtw
