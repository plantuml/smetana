...
// avzbk67kiot0sb7tktuaomvpk
// static int lastfree(Vmalloc_t * vm, register Void_t * data)      
public static Object lastfree() {
throw new UnsupportedOperationException();
}


// 83xx21rvdytfco8mz61i0qaxu
// static Void_t *lastresize(Vmalloc_t * vm, register Void_t * data, size_t size, 			  int type)        
public static Object lastresize() {
throw new UnsupportedOperationException();
}


// 4rm27ozfesqhu512m5p9cc283
// static long lastaddr(Vmalloc_t * vm, Void_t * addr)      
public static Object lastaddr() {
throw new UnsupportedOperationException();
}


// 1ucz11yq5ei5rhy0exbo23wux
// static long lastsize(Vmalloc_t * vm, Void_t * addr)      
public static Object lastsize() {
throw new UnsupportedOperationException();
}


// el2c5ddmhamts7ssgxm3jumoa
// static int lastcompact(Vmalloc_t * vm)     
public static Object lastcompact() {
throw new UnsupportedOperationException();
}


// 3lafnxjv21vbvnt0dfzcsem7o
// static Void_t *lastalign(Vmalloc_t * vm, size_t size, size_t align)       
public static Object lastalign() {
throw new UnsupportedOperationException();
}


// 4o0kmyjzafhzw9e99gkizjs6c
