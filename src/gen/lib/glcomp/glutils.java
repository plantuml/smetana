...
// drnkjxo5q3qowc2zxk1qvbol8
// int GetFixedOGLPos(int x, int y, float kts, GLfloat * X, GLfloat * Y, 		   GLfloat * Z) 
public static Object GetFixedOGLPos() {
throw new UnsupportedOperationException();
}


// eyqiyw79mjb7pqsk458utzw07
// int GetOGLPosRef(int x, int y, float *X, float *Y, float *Z) 
public static Object GetOGLPosRef() {
throw new UnsupportedOperationException();
}


// 44w028dzxxbhome9exk5ockkz
// float GetOGLDistance(int l) 
public static Object GetOGLDistance() {
throw new UnsupportedOperationException();
}


// eexk5jsjgbtok11yy53ivavep
// void to3D(int x, int y, GLfloat * X, GLfloat * Y, GLfloat * Z) 
public static Object to3D() {
throw new UnsupportedOperationException();
}


// 4bggefvxghklt835k470xnuag
// int GetFixedOGLPoslocal(int x, int y, GLfloat * X, GLfloat * Y, 			GLfloat * Z) 
public static Object GetFixedOGLPoslocal() {
throw new UnsupportedOperationException();
}


// 7lqgr2utjy4b101k8wvdeelfc
...
// a267wvjr7m40l9fl7h5v8d9si
// static double len(glCompPoint p) 
public static Object len() {
throw new UnsupportedOperationException();
}


// x5lqp47pdxujx2cg73f4em20
...
// 4zv4lfiu3gb311cibrldgl4ox
// double point_to_lineseg_dist(glCompPoint p, glCompPoint a, glCompPoint b) 
public static Object point_to_lineseg_dist() {
throw new UnsupportedOperationException();
}


// bnbf756pq2sgxxvyhzercrli
// void replacestr(char *source, char **target) 
public static Object replacestr() {
throw new UnsupportedOperationException();
}


// 888ti38i5icyz17nsvpaascmu
// void glCompSelectionBox(glCompSet * s) 
public static Object glCompSelectionBox() {
throw new UnsupportedOperationException();
}


// 2cawhg41yea7fatykbybglnbo
// void glCompCalcWidget(glCompCommon * parent, glCompCommon * child, 		      glCompCommon * ref) 
public static Object glCompCalcWidget() {
throw new UnsupportedOperationException();
}


// 7fhip2tpus4dibhzmyi9qu002
// static void glCompQuadVertex(glCompPoint * p0, glCompPoint * p1, 			     glCompPoint * p2, glCompPoint * p3) 
public static Object glCompQuadVertex() {
throw new UnsupportedOperationException();
}


// cjm1kz9adllfex2iz5fgrjb9v
// void glCompSetColor(glCompColor * c) 
public static Object glCompSetColor() {
throw new UnsupportedOperationException();
}


// 332vjkyisyedf6muz3zghfig2
// void glCompDrawRectangle(glCompRect * r) 
public static Object glCompDrawRectangle() {
throw new UnsupportedOperationException();
}


// evd9xvh08yc24ob6nia4ljy1p
// void glCompDrawRectPrism(glCompPoint * p, GLfloat w, GLfloat h, GLfloat b, 			 GLfloat d, glCompColor * c, int bumped) 
public static Object glCompDrawRectPrism() {
throw new UnsupportedOperationException();
}


// 65wj1z7471ps6qmkoo7po6v6u
// void copy_glcomp_color(glCompColor * source, glCompColor * target) 
public static Object copy_glcomp_color() {
throw new UnsupportedOperationException();
}


// 4koza3ibvj64y5orpfy7j6g6g
// GLfloat distBetweenPts(glCompPoint A,glCompPoint B,float R) 
public static Object distBetweenPts() {
throw new UnsupportedOperationException();
}


// 3o35zwx3c3kvqghp184hdko0d
// int is_point_in_rectangle(float X, float Y, float RX, float RY, float RW,float RH) 
public static Object is_point_in_rectangle() {
throw new UnsupportedOperationException();
}
