...
public class glcompfont {
// 7xechjgb7jlox80z3yijixg0c
// static void print_bitmap_string(void *font, char *s) 
public static Object print_bitmap_string() {
throw new UnsupportedOperationException();
}


// ae0yeo8ltm213hjkkfomd1zcp
// void glprintfglut(void *font, GLfloat xpos, GLfloat ypos, GLfloat zpos, 		  char *bf) 
public static Object glprintfglut() {
throw new UnsupportedOperationException();
}


// 7eatorxcntow9fr9jncr3m87y
// void glDeleteFont(glCompFont * f) 
public static Object glDeleteFont() {
throw new UnsupportedOperationException();
}


// 5om1jtypvqoap8l4hpj1e2xjt
// glCompFont *glNewFont (glCompSet * s, char *text, glCompColor * c,glCompFontType type, char *fontdesc, int fs,int is2D) 
public static Object glNewFont() {
throw new UnsupportedOperationException();
}


// 6hpisjiy31u4gyhwmsk4x6rd6
// glCompFont *glNewFontFromParent(glCompObj * o, char *text) 
public static Object glNewFontFromParent() {
throw new UnsupportedOperationException();
}


// 10jme71b0io3vxgtqvex1t23n
// void glCompDrawText3D(glCompFont * f,GLfloat x,GLfloat y,GLfloat z,GLfloat w,GLfloat h) 
public static Object glCompDrawText3D() {
throw new UnsupportedOperationException();
}


// 6xmhptys845d2n8xsl3eqt9a
// void glCompDrawText(glCompFont * f,GLfloat x,GLfloat y) 
public static Object glCompDrawText() {
throw new UnsupportedOperationException();
}


// dpuu00tivtg6t2g3kkw10sy07
// void glCompRenderText(glCompFont * f, glCompObj * parentObj) 
public static Object glCompRenderText() {
throw new UnsupportedOperationException();
}
