...
public class glcomptexture {
// zv1x2fbyfdrci5ose15qx2gp
// static glCompTex *glCompSetAddNewTexture(glCompSet * s, int width, 					 int height, unsigned char *data, 					 int is2D,int fs) 
public static Object glCompSetAddNewTexture() {
throw new UnsupportedOperationException();
}


// ckb16ltzggmoti6oz06smx77m
// glCompTex *glCompSetAddNewTexImage(glCompSet * s, int width, int height, 				   unsigned char *data, int is2D) 
public static Object glCompSetAddNewTexImage() {
throw new UnsupportedOperationException();
}


// 8wj9g0i2k6zas2swrvpfpxm7t
// glCompTex *glCompSetAddNewTexLabel(glCompSet * s, char *def, int fs, 				   char *text, int is2D) 
public static Object glCompSetAddNewTexLabel() {
throw new UnsupportedOperationException();
}


// dw3zu7xcr2t0io14tvajsqjam
// void glCompDeleteTexture(glCompTex * t) 
public static Object glCompDeleteTexture() {
throw new UnsupportedOperationException();
}
