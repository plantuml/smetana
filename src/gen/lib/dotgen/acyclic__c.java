...
UNSUPPORTED("erz9ellu8nzuvhl25ffe0dtyk"); // void reverse_edge(edge_t * e)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("6ag74vz3kjmohe4bp89fktey4"); //     edge_t *f;
UNSUPPORTED("8da0h30sdrflxhw99enhfs1d4"); //     delete_fast_edge(e);
UNSUPPORTED("c6u1yhjnc9qydq762vavma64l"); //     if ((f = find_fast_edge(aghead(e), agtail(e))))
UNSUPPORTED("6puh1u3ixmm0jf4nyr18yl03r"); // 	merge_oneway(e, f);
UNSUPPORTED("div10atae09n36x269sl208r1"); //     else
UNSUPPORTED("9dqhlqg21ztmum23kg7ab09xy"); // 	virtual_edge(aghead(e), agtail(e), e);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
