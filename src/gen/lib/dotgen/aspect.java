...
// buo6aw1j4uziggaugy984eotj
// static nodeGroup_t *nodeGroups


// 8pcclsxg8w461gulo0pvihkjp
// static int nNodeGroups = 0


// 58qcv8jq4exppidlq1qj1why9
// static void computeNodeGroups(graph_t * g) 
public static Object computeNodeGroups() {
throw new UnsupportedOperationException();
}


// zow1n89xdh4rv5ipoa0mmxtl
// int countDummyNodes(graph_t * g) 
public static Object countDummyNodes() {
throw new UnsupportedOperationException();
}


// by0sucsgzrupx1vrq0sc82zrb
// static layerWidthInfo_t *layerWidthInfo = NULL


// 2g8u71llxsq207y4p1j8kefuc
// static int *sortedLayerIndex


// 28et5dpanlo1pz361e1ey0l13
// static int nLayers = 0


// d4vffql0o3fhz4i1n8mpn80if
// static void computeLayerWidths(graph_t * g) 
public static Object computeLayerWidths() {
throw new UnsupportedOperationException();
}


// 62on7vg7kkyolc539do3mec4h
// static int compFunction(const void *a, const void *b) 
public static Object compFunction() {
throw new UnsupportedOperationException();
}


// ehhhz69emnjuunlpp23vqc6px
// static void sortLayers(graph_t * g) 
public static Object sortLayers() {
throw new UnsupportedOperationException();
}


// 6evdukaqstizjshbr4oanxa73
// static int getOutDegree(nodeGroup_t * ng) 
public static Object getOutDegree() {
throw new UnsupportedOperationException();
}


// advd4q4a55y9bkee9lm2jlb0b
// static int compFunction2(const void *a, const void *b) 
public static Object compFunction2() {
throw new UnsupportedOperationException();
}


// 86j0q224nxuasvt0pqjyt08lz
// static void reduceMaxWidth2(graph_t * g) 
public static Object reduceMaxWidth2() {
throw new UnsupportedOperationException();
}


// 9m17vsomqcrp49v7i892k9wdz
// static void applyPacking2(graph_t * g) 
public static Object applyPacking2() {
throw new UnsupportedOperationException();
}


// 90r91f9r03xvvyr1p2sd9wlt5
// void initEdgeTypes(graph_t * g) 
public static Object initEdgeTypes() {
throw new UnsupportedOperationException();
}


// ah5kormyl4wzab1anxsmys3ct
// static double computeCombiAR(graph_t * g) 
public static Object computeCombiAR() {
throw new UnsupportedOperationException();
}


// 6rjn839k90bzpa1ao70mci4xb
// static void zapLayers(graph_t * g) 
public static Object zapLayers() {
throw new UnsupportedOperationException();
}


// duy4vptc8o1tjslp9fpuybjpf
// void rank3(graph_t * g, aspect_t * asp) 
public static Object rank3() {
throw new UnsupportedOperationException();
}


// 7ggk146dt13on1e59u5479694
// void init_UF_size(graph_t * g) 
public static Object init_UF_size() {
throw new UnsupportedOperationException();
}


// 5srsfxqlego6qiyj5mm8m4ql2
// aspect_t* setAspect (Agraph_t * g, aspect_t* adata) 
public static Object setAspect() {
throw new UnsupportedOperationException();
}
