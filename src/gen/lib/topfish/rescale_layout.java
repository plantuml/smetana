...
public class rescale_layout {
// cxblzphpetx6zzwomzstlq1n4
// typedef int DistType


// e8hg49wqcww03m9qln9z4rrbc
// static double *compute_densities(v_data * graph, int n, double *x, 				 double *y) 
public static Object compute_densities() {
throw new UnsupportedOperationException();
}


// bdco27qtdifx2ocp1rggo81n7
// static double *recompute_densities(v_data * graph, int n, double *x, 				   double *densities) 
public static Object recompute_densities() {
throw new UnsupportedOperationException();
}


// 105esx2r5rb9oh4jt541wm1kz
// static double *smooth_vec(double *vec, int *ordering, int n, int interval, 			  double *smoothed_vec) 
public static Object smooth_vec() {
throw new UnsupportedOperationException();
}


// 7eaiwz65xmgh92qzi9uacmxk5
// static int split_by_place(double *place, int *nodes, int first, int last) 
public static Object split_by_place() {
throw new UnsupportedOperationException();
}


// p54tmgplas6fvifgcvfzens3
// static int  sorted_place(double * place, int * ordering, int first, int last) 
public static Object sorted_place() {
throw new UnsupportedOperationException();
}


// 95fsa7fpj45yaj0ww1g938mo3
// void quicksort_place(double *place, int *ordering, int first, int last) 
public static Object quicksort_place() {
throw new UnsupportedOperationException();
}


// dc12zbxm830tcvafidzk30upf
// static void rescaleLayout(v_data * graph, int n, double *x_coords, double *y_coords, 	      int interval, double distortion) 
public static Object rescaleLayout() {
throw new UnsupportedOperationException();
}


// 97tx7wx4aj2dyko8x3k2g70q0
// void rescale_layout(double *x_coords, double *y_coords, 	       int n, int interval, double width, double height, 	       double margin, double distortion) 
public static Object rescale_layout() {
throw new UnsupportedOperationException();
}


// 4y30lyisuksaifsmmgz5nyilh
// static void rescale_layout_polarFocus(v_data * graph, int n, 	  double *x_coords, double *y_coords, 	  double x_focus, double y_focus, int interval, double distortion) 
public static Object rescale_layout_polarFocus() {
throw new UnsupportedOperationException();
}


// 3q8x11q5wra6gxdupl3wtreip
// void rescale_layout_polar(double *x_coords, double *y_coords, 		     double *x_foci, double *y_foci, int num_foci, 		     int n, int interval, double width, 		     double height, double margin, double distortion) 
public static Object rescale_layout_polar() {
throw new UnsupportedOperationException();
}
