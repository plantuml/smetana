...
// 80ukhcuw72e3e2p60zlfa2879
// static int _uexcept(register Sfio_t * f, register int type, Void_t * val, 		    register Sfdisc_t * disc)        
public static Object _uexcept() {
throw new UnsupportedOperationException();
}


// 4vgoze9qnz4m9row7462sgghx
// int sfungetc(register Sfio_t * f, register int c)      
public static Object sfungetc() {
throw new UnsupportedOperationException();
}
