...
// 8gc6qx26bev5xyi01w728tfwc
// static int delpool(register Sfpool_t * p)     
public static Object delpool() {
throw new UnsupportedOperationException();
}


// 3qzwuvvsmf5c622wfxfdxuomh
// static Sfpool_t *newpool(register int mode)     
public static Object newpool() {
throw new UnsupportedOperationException();
}


// 8f84rtmm2h306hzu995bkb2b1
// static int _sfphead(Sfpool_t * p, Sfio_t * f, int n)       
public static Object _sfphead() {
throw new UnsupportedOperationException();
}


// 62bm2amro9w4l5tzc6b4oamb4
// static int _sfpdelete(Sfpool_t * p, Sfio_t * f, int n)       
public static Object _sfpdelete() {
throw new UnsupportedOperationException();
}


// 4mcfzj4jk28xdo7f56vvvqd48
// static int _sfpmove(register Sfio_t * f, register int type)      
public static Object _sfpmove() {
throw new UnsupportedOperationException();
}


// 1n4bpjcbmsfzjjy0bdd9qzbh7
// Sfio_t *sfpool(register Sfio_t * f, register Sfio_t * pf, register int mode)       
public static Object sfpool() {
throw new UnsupportedOperationException();
}
