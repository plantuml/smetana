...
// btaticnvqvav6giyqk5dhvl0b
// static gvplugin_package_t * gvplugin_package_record(GVC_t * gvc, char *path, char *name) 
public static Object gvplugin_package_record() {
throw new UnsupportedOperationException();
}


// 7b32j8w9cd211oy7f26zd2ld6
// void gvconfig_plugin_install_from_library(GVC_t * gvc, char *path, gvplugin_library_t *library) 
public static Object gvconfig_plugin_install_from_library() {
throw new UnsupportedOperationException();
}


// a0u25p4ndz2d3mpylo4jnz9cc
// static void gvconfig_plugin_install_builtins(GVC_t * gvc) 
@TranslatedBy("plantuml")
public static void gvconfig_plugin_install_builtins(GVC_t gvc) {
    lt_symlist_t s;
    StarChar name;
...
// f5fyxnkmknydgjt6dtc035z9w
// void gvconfig(GVC_t * gvc, boolean rescan) 
@TranslatedBy("plantuml")
public static void gvconfig(GVC_t gvc, boolean rescan) {
