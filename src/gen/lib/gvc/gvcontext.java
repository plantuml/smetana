...
// 9xccaaawyqf5atj8e59ems07n
// static char *LibInfo[] = 
@TranslatedBy("plantuml")
public static StarStarChar LibInfo = Memory.mallocStarStarChar(new String[] {"graphviz", "PACKAGE_VERSION", "BUILDDATE"});
// 8jwauh4lo3kcvxhomy40s94b
// GVC_t *gvNEWcontext(const lt_symlist_t *builtins, int demand_loading) 
@TranslatedBy("plantuml")
public static GVC_t gvNEWcontext(lt_symlist_t builtins, boolean demand_loading) {
    GVC_t gvc = (GVC_t) zmalloc(sizeof(GVC_t.class));

    if (gvc!=null) {
	gvc.common.info = LibInfo;
	gvc.common.errorfn = new GVCOMMON_t.errorfn() {
...
// 7i8lj0jlmprrj5kmbegtkh46n
// void gvFinalize(GVC_t * gvc) 
public static Object gvFinalize() {
throw new UnsupportedOperationException();
}


// ctg42qeu1yvs2g9r5wcv4zzrl
// int gvFreeContext(GVC_t * gvc) 
public static Object gvFreeContext() {
throw new UnsupportedOperationException();
}
