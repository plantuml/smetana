...
// 69klqm9cdcnu5ck9eeudgejqe
// PriorityQueue PriorityQueue_new(int n, int ngain)
public static Object PriorityQueue_new() {
throw new UnsupportedOperationException();
}


// 71n7rvevqacsxroc0rw7cg6v4
// void PriorityQueue_delete(PriorityQueue q)
public static Object PriorityQueue_delete() {
throw new UnsupportedOperationException();
}


// eo46ma6omrul277dgp9kt1oak
// PriorityQueue PriorityQueue_push(PriorityQueue q, int i, int gain)
public static Object PriorityQueue_push() {
throw new UnsupportedOperationException();
}


// 280yrgt6r06a966e9o5gnxflq
// int PriorityQueue_pop(PriorityQueue q, int *i, int *gain)
public static Object PriorityQueue_pop() {
throw new UnsupportedOperationException();
}


// 98arg93cwpkxbjnc8bzhu9ry9
// int PriorityQueue_get_gain(PriorityQueue q, int i)
public static Object PriorityQueue_get_gain() {
throw new UnsupportedOperationException();
}


// ackpti4cgawlndnnm2kbng4id
// int PriorityQueue_remove(PriorityQueue q, int i)
public static Object PriorityQueue_remove() {
throw new UnsupportedOperationException();
}
