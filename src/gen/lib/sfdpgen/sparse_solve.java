...
// 2i3ev49887l4mqkvqit7l4w2n
// void Operator_uniform_stress_matmul_delete(Operator o)
public static Object Operator_uniform_stress_matmul_delete() {
throw new UnsupportedOperationException();
}


// 46pdzbqle3sdqkb1iq2kvg8dg
// double *Operator_uniform_stress_matmul_apply(Operator o, double *x, double *y)
public static Object Operator_uniform_stress_matmul_apply() {
throw new UnsupportedOperationException();
}


// 675h8yjo8fo6w9pmqmkd4lokz
// Operator Operator_uniform_stress_matmul(SparseMatrix A, double alpha)
public static Object Operator_uniform_stress_matmul() {
throw new UnsupportedOperationException();
}


// 7lrf61f9yemj61b348xp3y61d
// double *Operator_matmul_apply(Operator o, double *x, double *y)
public static Object Operator_matmul_apply() {
throw new UnsupportedOperationException();
}


// 27tok5ips4bhivn9zq8nydn32
// Operator Operator_matmul_new(SparseMatrix A)
public static Object Operator_matmul_new() {
throw new UnsupportedOperationException();
}


// 85sabzc130fc0jt37blczsc2i
// void Operator_matmul_delete(Operator o)
public static Object Operator_matmul_delete() {
throw new UnsupportedOperationException();
}


// 4fv6jv4cb6p4p9n1l4tfiva7r
// double* Operator_diag_precon_apply(Operator o, double *x, double *y)
public static Object Operator_diag_precon_apply() {
throw new UnsupportedOperationException();
}


// 7q181phe4h72ss46cccicw34w
// Operator Operator_uniform_stress_diag_precon_new(SparseMatrix A, double alpha)
public static Object Operator_uniform_stress_diag_precon_new() {
throw new UnsupportedOperationException();
}


// 7837z36qctdlehhclfmd78wuj
// Operator Operator_diag_precon_new(SparseMatrix A)
public static Object Operator_diag_precon_new() {
throw new UnsupportedOperationException();
}


// 15po0yf52yw0mditm3h0x6jic
// void Operator_diag_precon_delete(Operator o)
public static Object Operator_diag_precon_delete() {
throw new UnsupportedOperationException();
}


// 3bj5vvaqmkgoged6kf2u4z39l
// static double conjugate_gradient(Operator A, Operator precon, int n, double *x, double *rhs, double tol, int maxit, int *flag)
public static Object conjugate_gradient() {
throw new UnsupportedOperationException();
}


// f4ahrfy7ap9knxeg5gp8i63ua
// double cg(Operator Ax, Operator precond, int n, int dim, double *x0, double *rhs, double tol, int maxit, int *flag)
public static Object cg() {
throw new UnsupportedOperationException();
}


// maiifwgfsddp3q1xjf1ws69r
// double* jacobi(SparseMatrix A, int dim, double *x0, double *rhs, int maxit, int *flag)
public static Object jacobi() {
throw new UnsupportedOperationException();
}


// 9w5vnrpjmrcwei69yca35x5qr
// double SparseMatrix_solve(SparseMatrix A, int dim, double *x0, double *rhs, double tol, int maxit, int method, int *flag)
public static Object SparseMatrix_solve() {
throw new UnsupportedOperationException();
}
