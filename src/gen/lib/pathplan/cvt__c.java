...
public static Object Bezier(Object... arg) {
UNSUPPORTED("8pbtw4bwd0e9674ihse2ntk7l"); // static ilcoord_t Bezier(ilcoord_t * V, int degree, double t,
UNSUPPORTED("86pbib7kpz2s9nak379i0qd3q"); // 			ilcoord_t * Left, ilcoord_t * Right)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("62ofdunb15w3wt47efa79libq"); //     int i, j;			/* Index variables  */
