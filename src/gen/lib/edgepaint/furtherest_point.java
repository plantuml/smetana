...
public static Object furtherest_point() {
throw new UnsupportedOperationException();
}


// bom2jyrtwr7jwgjd9w3eop595
// void furtherest_point_in_list(int k, int dim, double *wgt, double *pts, QuadTree qt, int max_level,  			      double (*usr_dist)(int, double*, double*), double *dist_max, double **argmax)
public static Object furtherest_point_in_list() {
throw new UnsupportedOperationException();
}
