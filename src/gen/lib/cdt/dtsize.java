...
// 6j49zum5hqto1t7fyrz8qjv1u
// static int treecount(register Dtlink_t* e)     
@TranslatedBy("plantuml")
public static int treecount(Dtlink_t e) {
throw new UnsupportedOperationException();
}

// bci0ea1fa7egf4aads6gdgvsq
// int dtsize(Dt_t* dt)     
@TranslatedBy("plantuml")
public static int dtsize(Dict_t dt) {
	Dtlink_t	t;
	int		size;
	...
	{	if((dt.data.type&(0000004|0000010))!=0)
		...
		{	for(size = 0, t = dt.data.hh._head(); t!=null; t = t.right)
				size += 1;
			dt.data.size = size;
		}
	}
