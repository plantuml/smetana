...
// 1duz2zmve5bdooct0ezmnnaxq
// static int chain_idx, mon_idx


// 67uj2vwqlb937zf3jgzd5bre1
// static monchain_t* mchain


// b7wevmtwi3ljzl56axez0c18m
// static vertexchain_t* vert


// 2owm4aavvrdgcsmzw0xh1keul
// static int* mon


// c5f2ppu5vis7zj6x1ehr7ipb8
...
// 86pkmn254w4mzlbm1tvtj0utl
// static void genSegments (cell* cells, int ncells, boxf bb, segment_t* seg, int flip) 
public static Object genSegments() {
throw new UnsupportedOperationException();
}


// adiv3g0l2lfgmsrp6nszkbu7e
// static void  generateRandomOrdering(int n, int* permute) 
public static Object generateRandomOrdering() {
throw new UnsupportedOperationException();
}


// br58atlnnfc5imy9qtmq3a4bq
// static int  inside_polygon (trap_t *t, segment_t* seg) 
public static Object inside_polygon() {
throw new UnsupportedOperationException();
}


// ew088xpoj2s831ch0zbnz5elx
...
// 7gi4ub1tqpupq617koabfz9iy
// static int get_vertex_positions (int v0, int v1, int *ip, int *iq) 
public static Object get_vertex_positions() {
throw new UnsupportedOperationException();
}


// 9a6v0rhhqdmefbgzi11be5g6h
// static int  make_new_monotone_poly (int mcur, int v0, int v1) 
public static Object make_new_monotone_poly() {
throw new UnsupportedOperationException();
}


// cz4jwnok9p2yz1595kvneisdx
...
public static Object traverse_polygon() {
throw new UnsupportedOperationException();
}


// 1q5h2go20arrwvxkwi1dpllun
// static int monotonate_trapezoids(int nsegs, segment_t*seg, trap_t* tr,      int flip, boxf* decomp) 
public static Object monotonate_trapezoids() {
throw new UnsupportedOperationException();
}


// 7dl8o2typqtrtf964o8l9x9mn
// static int  rectIntersect (boxf *d, const boxf *r0, const boxf *r1) 
public static Object rectIntersect() {
throw new UnsupportedOperationException();
}


// ejk703xieoaerzkix6zie6e5d
