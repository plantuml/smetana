...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="pointof", key="ciez0pfggxdljedzsbklq49f0", definition="static inline point pointof(int x, int y)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="boxof", key="7cufnfitrh935ew093mw0i4b7", definition="static inline box boxof(int llx, int lly, int urx, int ury)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="add_point", key="1n5xl70wxuabyf97mclvilsm6", definition="static inline point add_point(point p, point q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="sub_point", key="ai2dprak5y6obdsflguh5qbd7", definition="static inline point sub_point(point p, point q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="sub_pointf", key="16f6pyogcv3j7n2p0n8giqqgh", definition="static inline pointf sub_pointf(pointf p, pointf q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="mid_point", key="9k50jgrhc4f9824vf8ony74rw", definition="static inline point mid_point(point p, point q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="mid_pointf", key="59c4f7im0ftyowhnzzq2v9o1x", definition="static inline pointf mid_pointf(pointf p, pointf q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="interpolate_pointf", key="5r18p38gisvcx3zsvbb9saixx", definition="static inline pointf interpolate_pointf(double t, pointf p, pointf q)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="exch_xy", key="bxzrv2ghq04qk5cbyy68s4mol", definition="static inline point exch_xy(point p)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="exch_xyf", key="9lt3e03tac6h6sydljrcws8fd", definition="static inline pointf exch_xyf(pointf p)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="box_bb", key="8l9qhieokthntzdorlu5zn29b", definition="static inline box box_bb(box b0, box b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="boxf_bb", key="clws9h3bbjm0lw3hexf8nl4c4", definition="static inline boxf boxf_bb(boxf b0, boxf b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="box_intersect", key="bit6ycxo1iqd2al92y8gkzlvb", definition="static inline box box_intersect(box b0, box b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="boxf_intersect", key="8gfybie7k6pgb3o1a6llgpwng", definition="static inline boxf boxf_intersect(boxf b0, boxf b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="box_overlap", key="7z8j2quq65govaaejrz7b4cvb", definition="static inline int box_overlap(box b0, box b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="boxf_overlap", key="4z0suuut2acsay5m8mg9dqjdu", definition="static inline int boxf_overlap(boxf b0, boxf b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="box_contains", key="dd34swz5rmdgu3a2np2a4h1dy", definition="static inline int box_contains(box b0, box b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="boxf_contains", key="8laj1bspbu2i1cjd9upr7xt32", definition="static inline int boxf_contains(boxf b0, boxf b1)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="perp", key="4wf5swkz24xx51ja2dynbycu1", definition="static inline pointf perp (pointf p)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="scale", key="6dtlpzv4mvgzb9o0b252yweuv", definition="static inline pointf scale (double c, pointf p)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="", key="6jjh5wxnkdktgwiietsjulw6z", definition="static degitem *mkItem(Dt_t * d, degitem * obj, Dtdisc_t * disc)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="freeItem", key="dxc5b2nwkbljd2ajty06o3jsb", definition="static void freeItem(Dt_t * d, degitem * obj, Dtdisc_t * disc)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="cmpDegree", key="63kiupllvljfbvo3a449loqbj", definition="static int cmpDegree(Dt_t * d, int *key1, int *key2, Dtdisc_t * disc)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="", key="8s93atp6fs5gev3r499v2zshm", definition="deglist_t *mkDeglist(void)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="freeDeglist", key="583rk1k9h9793rue8tv6fay4g", definition="void freeDeglist(deglist_t * s)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="insertDeglist", key="8ab3eesjs8stuegu0nvbyzepc", definition="void insertDeglist(deglist_t * ns, Agnode_t * n)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="removeDeglist", key="196qf9oo7v4q0vpkmh0offqml", definition="void removeDeglist(deglist_t * list, Agnode_t * n)")
...
@Unused
@Original(version="2.38.0", path="lib/circogen/deglist.c", name="", key="6anrbidvt56pez6p6gbqpydt3", definition="Agnode_t *firstDeglist(deglist_t * list)")
