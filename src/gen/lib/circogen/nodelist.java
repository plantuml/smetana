...
// dtvicq2fjah66wz933ioh4bh2
// static nodelistitem_t *init_nodelistitem(Agnode_t * n) 
public static Object init_nodelistitem() {
throw new UnsupportedOperationException();
}


// dy4cfo30aqhqfs9ohp0qrn7fu
// nodelist_t *mkNodelist() 
public static Object mkNodelist() {
throw new UnsupportedOperationException();
}


// ani6po8xj4sxqbhdawzmq8251
// void freeNodelist(nodelist_t * list) 
public static Object freeNodelist() {
throw new UnsupportedOperationException();
}


// bzpmqsej7l7xiqisk32bw2zm8
// void appendNodelist(nodelist_t * list, nodelistitem_t * one, Agnode_t * n) 
public static Object appendNodelist() {
throw new UnsupportedOperationException();
}


// ctsccyqeaa9wecrwozla2ksu1
// nodelist_t *reverseNodelist(nodelist_t * list) 
public static Object reverseNodelist() {
throw new UnsupportedOperationException();
}


// af9x62teargqqy8dz9adaj72s
// void realignNodelist(nodelist_t * list, nodelistitem_t * np) 
public static Object realignNodelist() {
throw new UnsupportedOperationException();
}


// bknx0j43q6gqf020gmb5mk2g3
// nodelist_t *cloneNodelist(nodelist_t * list) 
public static Object cloneNodelist() {
throw new UnsupportedOperationException();
}


// 9st8dsjp6370v1ctv6tc4q47
// void insertNodelist(nodelist_t * list, Agnode_t * cn, Agnode_t * neighbor, 	       int pos) 
public static Object insertNodelist() {
throw new UnsupportedOperationException();
}


// 3acdwz7swl5xiaa4deeffslb2
// int sizeNodelist(nodelist_t * list) 
public static Object sizeNodelist() {
throw new UnsupportedOperationException();
}


// 8tdiblz4io5sijobmp9ihbl3t
// int node_position(nodelist_t * list, Agnode_t * n) 
public static Object node_position() {
throw new UnsupportedOperationException();
}


// d6risaxfqb2wnfu7t64z2qlhv
// static void concatNodelist(nodelist_t * l1, nodelist_t * l2) 
public static Object concatNodelist() {
throw new UnsupportedOperationException();
}


// bp2bbcnbcxxxpxg843u1hyonh
// void reverseAppend(nodelist_t * l1, nodelist_t * l2) 
public static Object reverseAppend() {
throw new UnsupportedOperationException();
}
