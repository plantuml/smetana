...
// 17rpe6wif72b8ol7hvbo5rud2
// static int lineno = 1


// 1zenm6000rxplycp4tq9ppqo3
// static int col0 = 1


// 4pw80jw71alkgi6ou2tnl71wx
// static int startLine = 1


// bf1kr0dndskofs9t238aw79i2
// static int kwLine = 1


// aahj24ht5hp9pazuazw4d732m
// static char *case_str[] = 


// 50g6pkm8dozw2glzkqj6rb0xq
// static char *caseStr(case_t cs) 
public static Object caseStr() {
throw new UnsupportedOperationException();
}


// 44yudt7l5icslxvw5jy7ixgmm
// static int eol (Sfio_t * str, Sfio_t * ostr) 
public static Object eol() {
throw new UnsupportedOperationException();
}


// psi39bnjzeqd57gfw7jpqile
// static int readc(Sfio_t * str, Sfio_t * ostr) 
public static Object readc() {
throw new UnsupportedOperationException();
}


// 75hek017o12oxxwuhpqf4rqqz
// void unreadc(Sfio_t * str, int c) 
public static Object unreadc() {
throw new UnsupportedOperationException();
}


// chhla1taa25lu5qcblarrnz8t
// static int skipWS(Sfio_t * str) 
public static Object skipWS() {
throw new UnsupportedOperationException();
}


// 2840r24nz5tizdd348bj79auj
// static void parseID(Sfio_t * str, int c, char *buf, size_t bsize) 
public static Object parseID() {
throw new UnsupportedOperationException();
}


// ccgwkfmny5k8qfdna20zjujdv
// static case_t parseKind(Sfio_t * str) 
public static Object parseKind() {
throw new UnsupportedOperationException();
}


// ac3yd0x2k3m6bsarioyxjafyc
// static int endString(Sfio_t * ins, Sfio_t * outs, char ec) 
public static Object endString() {
throw new UnsupportedOperationException();
}


// 67pkqnxjl9oghacu9s2v6k4xz
// static int endBracket(Sfio_t * ins, Sfio_t * outs, char bc, char ec) 
public static Object endBracket() {
throw new UnsupportedOperationException();
}


// 2rdbslyqe2f5saio4tzo8697q
// static char *parseBracket(Sfio_t * str, Sfio_t * buf, int bc, int ec) 
public static Object parseBracket() {
throw new UnsupportedOperationException();
}


// 3uu7asnkkqml7xb29k1gqlz5s
// static char *parseAction(Sfio_t * str, Sfio_t * buf) 
public static Object parseAction() {
throw new UnsupportedOperationException();
}


// 11hfg0t0h4g6y691kvmratgfw
// static char *parseGuard(Sfio_t * str, Sfio_t * buf) 
public static Object parseGuard() {
throw new UnsupportedOperationException();
}


// t9fihufc8wp35xqoin0bycza
// static case_t parseCase(Sfio_t * str, char **guard, int *gline, char **action, 	  int *aline) 
public static Object parseCase() {
throw new UnsupportedOperationException();
}


// d7thsj6mr7c9owiigq0e8fosl
// static parse_block *addBlock (parse_block * last, char *stmt, int line, 	int n_nstmts, case_info *nodelist, int n_estmts, case_info *edgelist) 
public static Object addBlock() {
throw new UnsupportedOperationException();
}


// cu2a2mnrh8hxgrbnatnbooftl
// static case_info *addCase(case_info * last, char *guard, int gline, 			  char *action, int line, int *cnt) 
public static Object addCase() {
throw new UnsupportedOperationException();
}


// apv2kw4ft0o00matvi95trkva
// static void bindAction(case_t cs, char *action, int aline, char **ap, int *lp) 
public static Object bindAction() {
throw new UnsupportedOperationException();
}


// f36p9jp65n3d7yohp5m3q65z8
// parse_prog *parseProg(char *input, int isFile) 
public static Object parseProg() {
throw new UnsupportedOperationException();
}


// 4s4a9estsez91yfoz9oog6405
// static void freeCaseList (case_info* ip) 
public static Object freeCaseList() {
throw new UnsupportedOperationException();
}


// eg3iw0odwbsx5wjhf2em31rla
// static void freeBlocks (parse_block* ip) 
public static Object freeBlocks() {
throw new UnsupportedOperationException();
}


// 99fwaz6me4vlndryy0xrxwkwk
// void  freeParseProg (parse_prog * prog) 
public static Object freeParseProg() {
throw new UnsupportedOperationException();
}
