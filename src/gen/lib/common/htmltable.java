...
// 4ch470ajf5jjpt0x06pdydd7h
// static void pushFontInfo(htmlenv_t * env, textfont_t * fp, textfont_t * savp) 
public static Object pushFontInfo() {
throw new UnsupportedOperationException();
}


// eiqsenv0wvs25ylb29oq7hypz
// static void popFontInfo(htmlenv_t * env, textfont_t * savp) 
public static Object popFontInfo() {
throw new UnsupportedOperationException();
}


// 2fq7cq3v0wodc2zkdz2nrycbr
...
public static Object emit_htextspans() {
throw new UnsupportedOperationException();
}


// dpcnkhm24fk5jwfpzzhm5fgn3
// static void emit_html_txt(GVJ_t * job, htmltxt_t * tp, htmlenv_t * env) 
public static Object emit_html_txt() {
throw new UnsupportedOperationException();
}


// 8aivux1hsy4ynfzwf908d9425
// static void doSide(GVJ_t * job, pointf p, double wd, double ht) 
public static Object doSide() {
throw new UnsupportedOperationException();
}


// 3ae4al308do9z1u91clqx27yk
// static pointf *mkPts(pointf * AF, boxf b, int border) 
public static Object mkPts() {
throw new UnsupportedOperationException();
}


// dce0frvo5rjv19prf2almjrsc
// static void doBorder(GVJ_t * job, htmldata_t * dp, boxf b) 
public static Object doBorder() {
throw new UnsupportedOperationException();
}


// 3sn3xxwciwsnysgpxkk25bbu3
// static int setFill(GVJ_t * job, char *color, int angle, int style, char *clrs[2]) 
public static Object setFill() {
throw new UnsupportedOperationException();
}


// 27rny3qpw3j6r42b1s34uyl25
// static int initAnchor(GVJ_t * job, htmlenv_t * env, htmldata_t * data, boxf b, 	   htmlmap_data_t * save, int closePrev) 
public static Object initAnchor() {
throw new UnsupportedOperationException();
}


// ah2sn0gm8xfyu3faoljt1whui
// static void endAnchor(GVJ_t * job, htmlmap_data_t * save, int openPrev) 
public static Object endAnchor() {
throw new UnsupportedOperationException();
}


// 75if0l45ti15rgx7p5f0f1xy1
// static void emit_html_rules(GVJ_t * job, htmlcell_t * cp, htmlenv_t * env, char *color, htmlcell_t* nextc) 
public static Object emit_html_rules() {
throw new UnsupportedOperationException();
}


// 26zfaec64xs5h6zhbfqva70tp
// static void emit_html_tbl(GVJ_t * job, htmltbl_t * tbl, htmlenv_t * env) 
public static Object emit_html_tbl() {
throw new UnsupportedOperationException();
}


// 670mc3pxpnpmidh6cp90jm5us
// static void emit_html_img(GVJ_t * job, htmlimg_t * cp, htmlenv_t * env) 
public static Object emit_html_img() {
throw new UnsupportedOperationException();
}


// 2yyg33cwscbca36c9p9ls9gmb
// static void emit_html_cell(GVJ_t * job, htmlcell_t * cp, htmlenv_t * env) 
public static Object emit_html_cell() {
throw new UnsupportedOperationException();
}


// 4wy0mqtzrkhcvbguv66mv2zrn
// static void allocObj(GVJ_t * job) 
public static Object allocObj() {
throw new UnsupportedOperationException();
}


// 3mabixy4ji5v1l1l5q9om0x4y
// static void freeObj(GVJ_t * job) 
public static Object freeObj() {
throw new UnsupportedOperationException();
}


// ddm4xxn8hy635ldbmntgizzkh
// static double heightOfLbl (htmllabel_t * lp) 
public static Object heightOfLbl() {
throw new UnsupportedOperationException();
}


// 9kxusredw550222rw4tuvj6tw
// void emit_html_label(GVJ_t * job, htmllabel_t * lp, textlabel_t * tp) 
public static Object emit_html_label() {
throw new UnsupportedOperationException();
}


// bzoc2l4jkwpjnu8uhijkh7jqn
// void free_html_data(htmldata_t * dp) 
public static Object free_html_data() {
throw new UnsupportedOperationException();
}


// 4250mxcggii14uzmucxqskd4h
// void free_html_text(htmltxt_t * t) 
public static Object free_html_text() {
throw new UnsupportedOperationException();
}


// 1ag0y1j2z1j2lll9sqzo80ds5
// void free_html_img(htmlimg_t * ip) 
public static Object free_html_img() {
throw new UnsupportedOperationException();
}


// 8zewpo49ed6tnn0j5hunzms6n
// static void free_html_cell(htmlcell_t * cp) 
public static Object free_html_cell() {
throw new UnsupportedOperationException();
}


// 4ajotfuuo16w4bnu75faio9aw
// static void free_html_tbl(htmltbl_t * tbl) 
public static Object free_html_tbl() {
throw new UnsupportedOperationException();
}


// 4jhvo7ir2kbb8ephhue06iewo
// void free_html_label(htmllabel_t * lp, int root) 
public static Object free_html_label() {
throw new UnsupportedOperationException();
}


// 5c34vls2f3ixvg8t5410ax0db
// static htmldata_t *portToCell(htmlcell_t * cp, char *id) 
public static Object portToCell() {
throw new UnsupportedOperationException();
}


// 6xsutw08hlknw0tpar5xs0i21
// static htmldata_t *portToTbl(htmltbl_t * tp, char *id) 
public static Object portToTbl() {
throw new UnsupportedOperationException();
}


// 6iu9j2vkjyh4jb3nehucnay2d
// boxf *html_port(node_t * n, char *pname, int *sides) 
public static Object html_port() {
throw new UnsupportedOperationException();
}


// 73uo7f1blvl7rkz3l1k3z9l6g
// int html_path(node_t * n, port * p, int side, boxf * rv, int *k) 
public static Object html_path() {
throw new UnsupportedOperationException();
}


// egic8540meaxzc7tifp5ciuhv
// static int size_html_txt(GVC_t *gvc, htmltxt_t * ftxt, htmlenv_t * env) 
public static Object size_html_txt() {
throw new UnsupportedOperationException();
}


// 7m5l8kjubsukhhlb1kvg7426w
// static int size_html_img(htmlimg_t * img, htmlenv_t * env) 
public static Object size_html_img() {
throw new UnsupportedOperationException();
}


// crx5m7iorc9xt1iws13b0zv92
// static int size_html_cell(graph_t * g, htmlcell_t * cp, htmltbl_t * parent, 	       htmlenv_t * env) 
public static Object size_html_cell() {
throw new UnsupportedOperationException();
}


// 2srxlzkxe960nczu4z5nrauej
// static int findCol(PointSet * ps, int row, int col, htmlcell_t * cellp) 
public static Object findCol() {
throw new UnsupportedOperationException();
}


// 2fg326d4b2e8q5060pchi2sum
// static int processTbl(graph_t * g, htmltbl_t * tbl, htmlenv_t * env) 
public static Object processTbl() {
throw new UnsupportedOperationException();
}


// 4u1lrk8plm8lny95u53i5hoeu
// void sizeLinearArray(htmltbl_t * tbl) 
public static Object sizeLinearArray() {
throw new UnsupportedOperationException();
}


// 9u21vrho83xozf1mugcyz8al8
// static char *nnames[] = 


// 4i4kof2mbmyuy7554t99luv2d
// char *nToName(int c) 
public static Object nToName() {
throw new UnsupportedOperationException();
}


// 9iuz5yiqjur9pp36a5kzgsorc
// static void closeGraphs(graph_t * rowg, graph_t * colg) 
public static Object closeGraphs() {
throw new UnsupportedOperationException();
}


// 1fiuczib7vwtmlqewjacltqhp
// static void checkChain(graph_t * g) 
public static Object checkChain() {
throw new UnsupportedOperationException();
}


// bq6xxdkp2v07d42xxx3kxzj5t
// static void checkEdge (graph_t* g, node_t* t, node_t* h, int sz) 
public static Object checkEdge() {
throw new UnsupportedOperationException();
}


// 3rqqn52nokfakserlj599xuyj
// void makeGraphs(htmltbl_t * tbl, graph_t * rowg, graph_t * colg) 
public static Object makeGraphs() {
throw new UnsupportedOperationException();
}


// 3spryfuvy3j9tqwtupa7xk09x
// void setSizes(htmltbl_t * tbl, graph_t * rowg, graph_t * colg) 
public static Object setSizes() {
throw new UnsupportedOperationException();
}


// 94wxagrehnsqu87e1y32y9j6f
...
// 7mf9slzi6j1xx8znqkck81ojd
// static void pos_html_img(htmlimg_t * cp, boxf pos) 
public static Object pos_html_img() {
throw new UnsupportedOperationException();
}


// 6dcraeyvk2uoj97sgfptvvusa
// static void pos_html_txt(htmltxt_t * ftxt, char c) 
public static Object pos_html_txt() {
throw new UnsupportedOperationException();
}


// d1yiur9m8nrpdphq90db17c2b
// static void pos_html_cell(htmlcell_t * cp, boxf pos, int sides) 
public static Object pos_html_cell() {
throw new UnsupportedOperationException();
}


// cz4ff6cy2i6ac1xcem3fkbf3j
// static void pos_html_tbl(htmltbl_t * tbl, boxf pos, int sides) 
public static Object pos_html_tbl() {
throw new UnsupportedOperationException();
}


// 8bzx77f6v164lb4wq4sis3x8q
// static int size_html_tbl(graph_t * g, htmltbl_t * tbl, htmlcell_t * parent, 	      htmlenv_t * env) 
public static Object size_html_tbl() {
throw new UnsupportedOperationException();
}


// 85bmuan0ad9bebfbm25w2in94
...
// eu0n8w5rlasw0veo8k5b77529
// static char *getPenColor(void *obj) 
public static Object getPenColor() {
throw new UnsupportedOperationException();
}


// 2xbp6e9kxg9ck5qfummgfh7k7
// int make_html_label(void *obj, textlabel_t * lp) 
public static Object make_html_label() {
throw new UnsupportedOperationException();
}
