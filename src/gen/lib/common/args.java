...
// 80np7jt0bavil3uot068wtxrl
// static int neato_extra_args(GVC_t *gvc, int argc, char** argv) 
public static Object neato_extra_args() {
throw new UnsupportedOperationException();
}


// 8p7j205ggerm803oa23gkc2g8
// static int memtest_extra_args(GVC_t *gvc, int argc, char** argv) 
public static Object memtest_extra_args() {
throw new UnsupportedOperationException();
}


// 2t6gdyyy8i0c5d4b3gsqd0rpa
// static int config_extra_args(GVC_t *gvc, int argc, char** argv) 
public static Object config_extra_args() {
throw new UnsupportedOperationException();
}


// f1dd7gkq4wmnxg8hs236lk99y
// static int setDouble (double* v, char* arg) 
public static Object setDouble() {
throw new UnsupportedOperationException();
}


// 4gmf2emr89qdx3aqmaplne0k
...
// 6150ojro4hufw87jc6pvq95dd
// static int setFDPAttr (char* arg) 
public static Object setFDPAttr() {
throw new UnsupportedOperationException();
}


// 3vun3scvr1a4wzvyc881vq03y
// static int fdp_extra_args (GVC_t *gvc, int argc, char** argv) 
public static Object fdp_extra_args() {
throw new UnsupportedOperationException();
}


// 5xe1appewv62gtmkzdjzib7mr
// int gvParseArgs(GVC_t *gvc, int argc, char** argv) 
@TranslatedBy("plantuml")
public static int gvParseArgs(GVC_t gvc, int argc, StarStarChar argv) {
    int rv;
    System.err.println("Some parts of gvParseArgs not translated (probably not used)");
