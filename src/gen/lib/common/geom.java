...
// an3osr8wbab08w759hwbbqhm9
// box mkbox(point p, point q) 
public static Object mkbox() {
throw new UnsupportedOperationException();
}


// 2c7s1wgyibdpn3cqrdci4mqwj
// boxf mkboxf(pointf p, pointf q) 
public static Object mkboxf() {
throw new UnsupportedOperationException();
}


// 29pnbvw6n2yoezie6xudgnrrc
// int lineToBox(pointf p, pointf q, boxf b) 
public static Object lineToBox() {
throw new UnsupportedOperationException();
}


// 1r7uvomrrc3o0z8d9ompm1ig4
// void rect2poly(pointf *p) 
public static Object rect2poly() {
throw new UnsupportedOperationException();
}


// 4y2ey3b9wjt69c8c51nzhc11u
// static pointf rotatepf(pointf p, int cwrot) 
public static Object rotatepf() {
throw new UnsupportedOperationException();
}


// 9shn573zbjfpesmmwj3g26ahi
// static point rotatep(point p, int cwrot) 
public static Object rotatep() {
throw new UnsupportedOperationException();
}


// 66bs8dyk14129mi4jhjnm40yf
// point cwrotatep(point p, int cwrot) 
public static Object cwrotatep() {
throw new UnsupportedOperationException();
}


// 5q8h2tm3jifiasn423wrm0y60
// pointf cwrotatepf(pointf p, int cwrot) 
public static Object cwrotatepf() {
throw new UnsupportedOperationException();
}


// 8v4jp36jzoo7itgk1f2139cvz
// point ccwrotatep(point p, int ccwrot) 
public static Object ccwrotatep() {
throw new UnsupportedOperationException();
}


// 6np74e9pfmv8uek8irqru2tma
// pointf ccwrotatepf(pointf p, int ccwrot) 
public static Object ccwrotatepf() {
throw new UnsupportedOperationException();
}


// 5vf3yrj3pdre7b1b7c8sq4vnr
// inline box flip_rec_box(box b, point p) 
public static Object flip_rec_box() {
throw new UnsupportedOperationException();
}


// 10berg5l071upv3r6ei5ri6h6
// boxf flip_rec_boxf(boxf b, pointf p) 
public static Object flip_rec_boxf() {
throw new UnsupportedOperationException();
}


// 90k9l4o3khu3dw0fzkrcd97nk
// double ptToLine2 (pointf a, pointf b, pointf p) 
public static Object ptToLine2() {
throw new UnsupportedOperationException();
}


// 7a3ftw4ubky8oz0e6sd4diag1
// int line_intersect (pointf a, pointf b, pointf c, pointf d, pointf* p) 
public static Object line_intersect() {
throw new UnsupportedOperationException();
}
