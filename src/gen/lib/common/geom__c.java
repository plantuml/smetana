...
public static Object ptToLine2(Object... arg) {
UNSUPPORTED("hk0hnp01vfbwcoh9uy5du16e"); // double ptToLine2 (pointf a, pointf b, pointf p)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("35o9po6rjxscxrk7s2ujqcmvc"); //   double dx = b.x-a.x;
UNSUPPORTED("14jy0ksgvpqbsgjd1auzdyoov"); //   double dy = b.y-a.y;
UNSUPPORTED("9602bk531a1t7uwfpstpll6wf"); //   double a2 = (p.y-a.y)*dx - (p.x-a.x)*dy;
UNSUPPORTED("f1cnavn1amzkvy1obsl9o56wx"); //   a2 *= a2;   /* square - ensures that it is positive */
UNSUPPORTED("3dh40axq98jyrx52w8x48r0ht"); //   if (a2 < 0.0000000001) return 0.;  /* avoid 0/0 problems */
UNSUPPORTED("b58shaheciihlq4ofqd9fgz36"); //   return a2 / (dx*dx + dy*dy);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
