...
try {
	...
	case AGEDGE:
	    isEdge = 1;
	    g_str = agnameof(agroot(agraphof((M_agtail((ST_Agedge_s)(obj.castTo(ST_Agedge_s.class)))))));
	    g_len = strlen(g_str);
	    t_str = agnameof(M_agtail((ST_Agedge_s)(obj.castTo(ST_Agedge_s.class))));
	    t_len = strlen(t_str);
	    ...
	    if (agisdirected(agroot(agraphof(M_agtail((ST_Agedge_s)(obj.castTo(ST_Agedge_s.class)))))))
		e_str = new CString("->");
	    else
		e_str = new CString("--");
