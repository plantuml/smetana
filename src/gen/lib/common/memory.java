...
public class memory {
// 6hfkgng9qf75cucpojc4r8x6w
// void *zmalloc(size_t nbytes) 
@TranslatedBy("plantuml")
public static StarVoid zmalloc(size_t nbytes) {
    StarVoid rv;
    if (nbytes == null)
	return null;
    rv = gmalloc(nbytes);
...
// dn6c3bthm7yuhtrxx3o2je19z
// void *zrealloc(void *ptr, size_t size, size_t elt, size_t osize) 
public static Object zrealloc() {
throw new UnsupportedOperationException();
}


// 4mfikqpmxyxrke46i5xakatmc
// void *gmalloc(size_t nbytes) 
@TranslatedBy("plantuml")
public static StarVoid gmalloc(size_t nbytes) {
    StarVoid rv;
    if (nbytes == null)
	return null;
    rv = malloc(nbytes);
...
// 1ed55yig6d18nhtbyqlf37jik
// void *grealloc(void *ptr, size_t size) 
public static Object grealloc() {
throw new UnsupportedOperationException();
}
