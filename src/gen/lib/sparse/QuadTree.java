...
// 4alu721dbslf4sirssa9dnt0k
// static node_data node_data_new(int dim, double weight, double *coord, int id)
public static Object node_data_new() {
throw new UnsupportedOperationException();
}


// 49clall6tjxndea4x5jgk76en
// void node_data_delete(void *d)
public static Object node_data_delete() {
throw new UnsupportedOperationException();
}


// 9zra372ynihx0nz7mm4scvmsy
// double node_data_get_weight(void *d)
public static Object node_data_get_weight() {
throw new UnsupportedOperationException();
}


// jstk5azj5adx3m3qr7qj6q6b
// double* node_data_get_coord(void *d)
public static Object node_data_get_coord() {
throw new UnsupportedOperationException();
}


// bk9upsavve8624mmeapmlihno
// int node_data_get_id(void *d)
public static Object node_data_get_id() {
throw new UnsupportedOperationException();
}


// b2132rfqhkfaapmvwkkahcclf
// void check_or_realloc_arrays(int dim, int *nsuper, int *nsupermax, double **center, double **supernode_wgts, double **distances)
public static Object check_or_realloc_arrays() {
throw new UnsupportedOperationException();
}


// 3lhbi5sqgg860avi85bdsp2hy
...
public static Object QuadTree_get_supernodes_internal() {
throw new UnsupportedOperationException();
}


// cx5wf3atxh3ext0lnok95qokv
// void QuadTree_get_supernodes(QuadTree qt, double bh, double *point, int nodeid, int *nsuper,  			     int *nsupermax, double **center, double **supernode_wgts, double **distances, double *counts, int *flag)
public static Object QuadTree_get_supernodes() {
throw new UnsupportedOperationException();
}


// an0186xagcsd5k7nhr0ho1n6w
// static double *get_or_assign_node_force(double *force, int i, SingleLinkedList l, int dim)
public static Object get_or_assign_node_force() {
throw new UnsupportedOperationException();
}


// sqlz4jss8u6sfibbddeouxh7
// static double *get_or_alloc_force_qt(QuadTree qt, int dim)
public static Object get_or_alloc_force_qt() {
throw new UnsupportedOperationException();
}


// 9ka25wbhzssfjaxivf1tspqy2
