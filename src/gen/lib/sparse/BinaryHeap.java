...
// 8n7rlpnmn5fmzein3xsoqfn3i
// BinaryHeap BinaryHeap_new(int (*cmp)(void*item1, void*item2))
public static Object BinaryHeap_new() {
throw new UnsupportedOperationException();
}


// atnbaai1klutkbbchchl3xiz
// void BinaryHeap_delete(BinaryHeap h, void (*del)(void* item))
public static Object BinaryHeap_delete() {
throw new UnsupportedOperationException();
}


// 1sj8l4ea3qr8ncm33d0p07ftg
// static BinaryHeap BinaryHeap_realloc(BinaryHeap h)
public static Object BinaryHeap_realloc() {
throw new UnsupportedOperationException();
}


// 6dk1cqhtm0ks9qsdljrkmbvrh
...
// 3juue52a3ucxt5m0enxxmla4f
// static int siftUp(BinaryHeap h, int nodePos)
public static Object siftUp() {
throw new UnsupportedOperationException();
}


// 901jxg01enb6tjaunumd8wjpu
// static int siftDown(BinaryHeap h, int nodePos)
public static Object siftDown() {
throw new UnsupportedOperationException();
}


// dlan46639vo05boxvtedk971q
// int BinaryHeap_insert(BinaryHeap h, void *item)
public static Object BinaryHeap_insert() {
throw new UnsupportedOperationException();
}


// 5i2nu59nknkrowzu203x8n0ci
// void* BinaryHeap_get_min(BinaryHeap h)
public static Object BinaryHeap_get_min() {
throw new UnsupportedOperationException();
}


// 3om0ew8zqo673xkxshthv1gnb
// void* BinaryHeap_extract_min(BinaryHeap h)
public static Object BinaryHeap_extract_min() {
throw new UnsupportedOperationException();
}


// 5qdscve9v865ej08u0zs48080
// void* BinaryHeap_extract_item(BinaryHeap h, int id)
public static Object BinaryHeap_extract_item() {
throw new UnsupportedOperationException();
}


// ex099irapvjbs12q1yjhvk8xh
// int BinaryHeap_reset(BinaryHeap h, int id, void *item)
public static Object BinaryHeap_reset() {
throw new UnsupportedOperationException();
}


// efatax0zl3tz87cytiwettw2v
// void* BinaryHeap_get_item(BinaryHeap h, int id)
public static Object BinaryHeap_get_item() {
throw new UnsupportedOperationException();
}


// 157313uipu1zey5ep7o0te4pw
// void BinaryHeap_sanity_check(BinaryHeap h)
public static Object BinaryHeap_sanity_check() {
throw new UnsupportedOperationException();
}


// 2s417i50irlj62kz6pf9g3itd
// void BinaryHeap_print(BinaryHeap h, void (*pnt)(void*))
public static Object BinaryHeap_print() {
throw new UnsupportedOperationException();
}
