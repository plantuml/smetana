...
// cvazlvqlyvg8xslrg0wv0bvj9
// static char* err = 


// 36kuc33peq8amftyl3yl646xi
// int* get_triangles (double *x, int n, int* tris) 
public static Object get_triangles() {
throw new UnsupportedOperationException();
}


// 9pvoqigogqhwikqforngcvrye
// v_data *delaunay_triangulation(double *x, double *y, int n) 
public static Object delaunay_triangulation() {
throw new UnsupportedOperationException();
}


// 1fnl7h07l4lyxt6gc8cjxm2f0
// int *delaunay_tri(double *x, double *y, int n, int* nedges) 
public static Object delaunay_tri() {
throw new UnsupportedOperationException();
}


// 3sv5s0ufa72ehbzztcwo7u260
// surface_t*  mkSurface (double *x, double *y, int n, int* segs, int nsegs) 
public static Object mkSurface() {
throw new UnsupportedOperationException();
}


// cys6o6cq9n5uh0vwigeq7ste0
// void  freeSurface (surface_t* s) 
public static Object freeSurface() {
throw new UnsupportedOperationException();
}


// 7blxdarbvjy4uj6e4uif6nsah
// static void remove_edge(v_data * graph, int source, int dest) 
public static Object remove_edge() {
throw new UnsupportedOperationException();
}


// cblwki5qnow25kidxhs3zgk1p
// v_data *UG_graph(double *x, double *y, int n, int accurate_computation) 
public static Object UG_graph() {
throw new UnsupportedOperationException();
}


// 59w6ke65e3xy8bgs6r80h21my
// void freeGraph (v_data * graph) 
public static Object freeGraph() {
throw new UnsupportedOperationException();
}


// e1deqqs4yqf0n6wmx9ydm775t
// void freeGraphData(vtx_data * graph) 
public static Object freeGraphData() {
throw new UnsupportedOperationException();
}
