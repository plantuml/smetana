...
// tgs7z2wvptnut1ux1fo838l9
// static int maxcnt = 0


// 28iotarlit0xzvg1n2r9br9hi
// static Point *tp1 = (void *)0


// cowv0fp2lpednx3vz5owd8qlg
// static Point *tp2 = (void *)0


// 5vjhba5y4ik6zghz84j42qoqu
// static Point *tp3 = (void *)0


// 7k8j6t4p6go0y99z0bgk4lfm7
// void polyFree() 
public static Object polyFree() {
throw new UnsupportedOperationException();
}


// cthk6eskscp4qavpd3godlwgr
// void breakPoly(Poly * pp) 
public static Object breakPoly() {
throw new UnsupportedOperationException();
}


// cr565k5cujsojeks738yv4z7y
...
// eqkddshyevyub53hpegrt4g4j
// static void inflatePts(Point * verts, int cnt, float xmargin, float ymargin) 
public static Object inflatePts() {
throw new UnsupportedOperationException();
}


// 4fqvm5n1zgutknadi4c1f814v
...
// 5a96dwfxte4pdbngna2ee5xxk
// static Point makeScaledTransPoint(int x, int y, float dx, float dy) 
public static Object makeScaledTransPoint() {
throw new UnsupportedOperationException();
}


// 858vdd64pt0txfw2dhcxvcwyo
// static Point makeScaledPoint(double x, double y) 
public static Object makeScaledPoint() {
throw new UnsupportedOperationException();
}


// dvihdb9lynuql3o1ktcr0zppb
// static Point *genRound(Agnode_t * n, int *sidep, float xm, float ym) 
public static Object genRound() {
throw new UnsupportedOperationException();
}


// 29gfde1l3i2glfyg6e7thg1yb
// int makeAddPoly(Poly * pp, Agnode_t * n, float xmargin, float ymargin) 
public static Object makeAddPoly() {
throw new UnsupportedOperationException();
}


// dsa034zpkj6i7e4wqph5xi1jl
// int makePoly(Poly * pp, Agnode_t * n, float xmargin, float ymargin) 
public static Object makePoly() {
throw new UnsupportedOperationException();
}


// dt0ydg3qa40l0la0ypasai8c7
// static int pintersect(Point originp, Point cornerp, Point originq, Point cornerq) 
public static Object pintersect() {
throw new UnsupportedOperationException();
}


// 1p63ofxgmqvgo76dbrwrrh90j
// static int edgesIntersect(Point * P, Point * Q, int n, int m) 
public static Object edgesIntersect() {
throw new UnsupportedOperationException();
}


// 832bntguz9akkivwa4ab4ipo0
// static int inPoly(Point vertex[], int n, Point q) 
public static Object inPoly() {
throw new UnsupportedOperationException();
}


// aofbaasf3ppcvxklccex3duqt
// static int inBox(Point p, Point origin, Point corner) 
public static Object inBox() {
throw new UnsupportedOperationException();
}


// abduv0fi7plbghihxfrcwawve
// static void transCopy(Point * inp, int cnt, Point off, Point * outp) 
public static Object transCopy() {
throw new UnsupportedOperationException();
}


// deiluvkv8yives847k882ch7d
// int polyOverlap(Point p, Poly * pp, Point q, Poly * qp) 
public static Object polyOverlap() {
throw new UnsupportedOperationException();
}
