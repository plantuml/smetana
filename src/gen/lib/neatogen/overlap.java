...
// 1aptjccqugxg2dgdh52tpqq1n
// void remove_overlap(int dim, SparseMatrix A, int m, double *x, double *label_sizes, int ntry, double initial_scaling, int do_shrinking, int *flag) 
public static Object remove_overlap() {
