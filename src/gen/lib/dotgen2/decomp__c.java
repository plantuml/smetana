...
//3 bljeouxuwu26w8g2txqa5e1s3
// static void  end_component(void) 
public static Object end_component(Object... arg) {
UNSUPPORTED("59dl3yc4jbcy2pb7j1njhlybi"); // static void 
UNSUPPORTED("5997h8w1r7ll9qpingcg9tgbz"); // end_component(void)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("b17di9c7wgtqm51bvsyxz6e2f"); //     int i;
UNSUPPORTED("9pttx2kqw32zei4ml35bho5bo"); //     i = GD_comp(G).size++;
UNSUPPORTED("87a6lvuph3um135tbiu9324is"); //     GD_comp(G).list = ALLOC(GD_comp(G).size, GD_comp(G).list, Agnode_t *);
UNSUPPORTED("cpva0xklx78uhaucuti8zcao9"); //     GD_comp(G).list[i] = GD_nlist(G);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
...
//3 65x0nbduw3su2kef2af7rl7te
// static void search_component(graph_t * g, node_t * n) 
public static Object search_component(Object... arg) {
UNSUPPORTED("e2z2o5ybnr5tgpkt8ty7hwan1"); // static void
UNSUPPORTED("b8msy1sk8wpglbsj3eiwzgies"); // search_component(graph_t * g, node_t * n)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("1ftbpouhgk4e43ry1n5cak3sa"); //     int c, i;
UNSUPPORTED("8dwrsa1k1oscjj68z2y1r3q7s"); //     elist vec[4];
UNSUPPORTED("dxz8gujppjqsa63merjuwp9ak"); //     node_t *other;
UNSUPPORTED("5gypxs09iuryx5a2eho9lgdcp"); //     edge_t *e;
UNSUPPORTED("6j2e1of99avs4m15xpwxr35bl"); //     Agedge_t* tempE;
UNSUPPORTED("b3dzgjrauzfjtohmk9h3wwxvm"); //     static int count=0;
UNSUPPORTED("6lehty6ll91vszflmxw6iz419"); //     add_to_component(n);
UNSUPPORTED("upusa46fiaq80hf8aapcn1mt"); //     vec[0] = ND_out(n);
UNSUPPORTED("a8a09l8wnb52ywdr4532za1c5"); //     vec[1] = ND_in(n);
UNSUPPORTED("7w5zoybysxgz1sotx6umvv7py"); //     vec[2] = ND_flat_out(n);
UNSUPPORTED("2f7o20xruyqa2247hckze21ii"); //     vec[3] = ND_flat_in(n);
UNSUPPORTED("b0yqrmxeiirvknqatgmw8y69m"); //     for (e = agfstout(g, n); e; e = agnxtout(g, e)) 
UNSUPPORTED("6ld19omy1z68vprfzbhrjqr2z"); //     {
UNSUPPORTED("21smxvlsfj2oyibyw2y5toioi"); // 	Agedge_t* tempE=e;
UNSUPPORTED("8tzx04lxekjitkx9hpvchz8sh"); // 	if ((other = aghead(e)) == n)
UNSUPPORTED("ojvxxrwmdnuzzam5mbfdilzl"); // 	    other = agtail(e);
UNSUPPORTED("e8gd4uhfxekar52skfc8hgob4"); // 	if (ND_mark(other) != Cmark)
UNSUPPORTED("ck2k5zc4kjd04gmr350jqrlhw"); //         	search_component(g, other);
UNSUPPORTED("1574y9m74wvl3ahgkksri0bt7"); // 	e=tempE;
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
UNSUPPORTED("ao48671oyabzjbzmqlirho59y"); //     for (e = agfstin(g, n); e; e = agnxtin(g, e)) 
UNSUPPORTED("6ld19omy1z68vprfzbhrjqr2z"); //     {
UNSUPPORTED("e27tvhuhud3qr3h1i5rdim9sk"); // 	count++;
UNSUPPORTED("ii5dapxupfavjg3nspjfa2gk"); // 	if(count ==53)
UNSUPPORTED("dugn37zxn924oz5pjo3sd7kcz"); // 	    printf("dgfdg");
UNSUPPORTED("8tzx04lxekjitkx9hpvchz8sh"); // 	if ((other = aghead(e)) == n)
UNSUPPORTED("ojvxxrwmdnuzzam5mbfdilzl"); // 	    other = agtail(e);
UNSUPPORTED("e8gd4uhfxekar52skfc8hgob4"); // 	if (ND_mark(other) != Cmark)
UNSUPPORTED("ck2k5zc4kjd04gmr350jqrlhw"); //         	search_component(g, other);
UNSUPPORTED("3yveiq0kiggxlchj7yg8754va"); // 	tempE=e;
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
UNSUPPORTED("ege6bbu86lc19hgbsoi39ohq2"); //     //implementflat in and flat out versions
UNSUPPORTED("800sev7kgzj7616szhvsqyl2b"); // /*    for (c = 0; c <= 3; c++) {
UNSUPPORTED("4kg4gxngpcixbzu6en5mgnsss"); // 	if (vec[c].list)
UNSUPPORTED("ejni75yxz9qyqogki2xzf7bgq"); // 	    for (i = 0; (e = vec[c].list[i]); i++) {
UNSUPPORTED("1i1ehlkq8j855jp0hnpzy73e8"); // 		if ((other = aghead(e)) == n)
UNSUPPORTED("51wu2swe6c4iy1qw4hqpzz2ga"); // 		    other = agtail(e);
UNSUPPORTED("dzwgsx3nri2z6nd69iuyqkfh9"); // 		if (ND_mark(other) != Cmark)
UNSUPPORTED("auz6hq0modc27v12xcghyjjof"); // 		    if(other == UF_find(other))
UNSUPPORTED("blmwk2w84y7bpixidbqgo97ko"); // 			search_component(g, other);
...
//3 5zd5kjlhqnccbgqxm8fk2eexx
// void decompose(graph_t * g, int pass) 
public static Object decompose(Object... arg) {
UNSUPPORTED("bulxyckvwrobzw8c590kvi6m4"); // void decompose(graph_t * g, int pass)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("8uujemixuhlf040icq3zsh7j8"); //     graph_t *subg;
UNSUPPORTED("1tx9s4tyjhcrdlfwgxad29j0a"); //     node_t *n, *v;
UNSUPPORTED("qi47axa9j2qnoeymsifkb37n"); //     G = g;
UNSUPPORTED("58m45ezrkho2k95mfwjvci6bn"); //     if (++Cmark == 0)
UNSUPPORTED("d29p3zy079iu9jegovu1a71qo"); // 	Cmark = 1;
UNSUPPORTED("a061pd7vk6j0wk644ppz1pdxx"); //     GD_n_nodes(g) = GD_comp(g).size = 0;
UNSUPPORTED("44thr6ep72jsj3fksjiwdx3yr"); //     for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
UNSUPPORTED("2ru7hagw6x1ki17lcupv15xkd"); // 	v = n;
UNSUPPORTED("bqr9r9otefcojc23jwx56vgwa"); // 	if (ND_mark(v) != Cmark) {
UNSUPPORTED("13n2wnpr6kb57ydkljhck8xe7"); // 	    begin_component();
UNSUPPORTED("5il61wd9x4omvfxniho75u2hf"); // 	    search_component(g, v);
UNSUPPORTED("1cmoebt7js2he2xpn6y607udz"); // 	    end_component();
