...
// 2xwmpggwpggfyyfj0vuw3pmfg
// static Agraph_t *Ag_dictop_G
@TranslatedBy("plantuml")
public static Agraph_t Ag_dictop_G;
// 7dkudp41c9byhicatk2sxtxqk
// void *agdictobjmem(Dict_t * dict, void * p, size_t size, Dtdisc_t * disc) 
@TranslatedBy("plantuml")
public static StarVoid agdictobjmem(Dict_t dict, StarVoid p, size_t size, Dtdisc_t disc) {
    Agraph_t g;
    g = Ag_dictop_G;
    if (g!=null) {
	if (p!=null)
...
// 5xdfwxth4q1dm3180qzuf51sn
// void agdictobjfree(Dict_t * dict, void * p, Dtdisc_t * disc) 
@TranslatedBy("plantuml")
public static void agdictobjfree(Dict_t dict, StarVoid p, Dtdisc_t disc) {
throw new UnsupportedOperationException();
}

// 48ox0bg1qmasrer8np51uwsyk
// Dict_t *agdtopen(Agraph_t * g, Dtdisc_t * disc, Dtmethod_t * method) 
@TranslatedBy("plantuml")
public static Dict_t agdtopen(Agraph_t g, Dtdisc_t disc, Dtmethod_t method) {
    Dtmemory_f memf;
    Dict_t d;
    memf = disc.memoryf;
    disc.memoryf = new Dtmemory_f(){
...
// 6pbz2fsmebq8iy7if4way3ct2
// long agdtdelete(Agraph_t * g, Dict_t * dict, void *obj) 
public static Object agdtdelete() {
throw new UnsupportedOperationException();
}


// 8a6i39x23joa467bqbo4b25ng
// int agobjfinalize(void * obj) 
public static Object agobjfinalize() {
throw new UnsupportedOperationException();
}


// 4x6nykawwls34vi6jc9gk1y29
// int agdtclose(Agraph_t * g, Dict_t * dict) 
public static Object agdtclose() {
throw new UnsupportedOperationException();
}


// cym72wvu6zffc0vzoa93zha8
// void agdtdisc(Agraph_t * g, Dict_t * dict, Dtdisc_t * disc) 
public static Object agdtdisc() {
throw new UnsupportedOperationException();
}
