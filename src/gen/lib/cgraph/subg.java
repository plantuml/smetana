...
// ejkno5fnb6016cp7oaafixzgf
// static Agraph_t *agfindsubg_by_id(Agraph_t * g, unsigned long id) 
public static Object agfindsubg_by_id() {
throw new UnsupportedOperationException();
}


// co2qcbb9dwwr9nal299ly5q1c
// static Agraph_t *localsubg(Agraph_t * g, unsigned long id) 
public static Object localsubg() {
throw new UnsupportedOperationException();
}


// 4ftcvakw588e1m0j44fmdt7p5
// Agraph_t *agidsubg(Agraph_t * g, unsigned long id, int cflag) 
public static Object agidsubg() {
throw new UnsupportedOperationException();
}


// eohbl3j62jgrnmlhwgwslp6zm
// Agraph_t *agsubg(Agraph_t * g, char *name, int cflag) 
public static Object agsubg() {
throw new UnsupportedOperationException();
}


// 51eksrs0lhkgohunejlpwyc4k
// Agraph_t *agfstsubg(Agraph_t * g) 
public static Object agfstsubg() {
throw new UnsupportedOperationException();
}


// 85c1qisrein0tzm2regoe61t
// Agraph_t *agnxtsubg(Agraph_t * subg) 
public static Object agnxtsubg() {
throw new UnsupportedOperationException();
}


// 7kbp6j03hd7u6nnlivi0vt3ja
// Agraph_t *agparent(Agraph_t * g) 
@TranslatedBy("plantuml")
public static Agraph_t agparent(Agraph_t g) {
	return g.parent;
}

// 37trxrsv69a3pl08f5awwj3tq
// long agdelsubg(Agraph_t * g, Agraph_t * subg) 
public static Object agdelsubg() {
throw new UnsupportedOperationException();
}
