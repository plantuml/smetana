...
// 2qjm4okqgeuarw1i5krezrxiq
// Agiodisc_t AgIoDisc = 
@TranslatedBy("plantuml")
public static Agiodisc_t AgIoDisc = null;
// b6znej4isyhxv8vcdyjnnhlpu
// static int memiofread(void *chan, char *buf, int bufsize) 
public static Object memiofread() {
throw new UnsupportedOperationException();
}


// a56p4nhhkzxgzqx4hqbsff5hf
// static Agiodisc_t memIoDisc = 


// 7hpggznawe61je0f77vzdulun
// Agraph_t *agmemread(const char *cp) 
public static Object agmemread() {
throw new UnsupportedOperationException();
}
