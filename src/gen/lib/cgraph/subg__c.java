...
public static Object agfindsubg_by_id(Object... arg) {
UNSUPPORTED("5dpdc4chvuxsuscdh95fq2irj"); // static Agraph_t *agfindsubg_by_id(Agraph_t * g, unsigned long id)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("25d5ztj3k1mhj0hgtslm7zzbh"); //     Agraph_t template;
UNSUPPORTED("a1agydx38yee8i897g0u4x7z7"); //     agdtdisc(g, g->g_dict, &Ag_subgraph_id_disc);
UNSUPPORTED("57c8kcqx9ighhpk17rqixhelk"); //     AGID(&template) = id;
UNSUPPORTED("1g4e2rk7nhevifx9tjnscc1rj"); //     return (Agraph_t *) (*(((Dt_t*)(g->g_dict))->searchf))((g->g_dict),(void*)(&template),0000004);
...
public static Object localsubg(Object... arg) {
UNSUPPORTED("1za7zk3vhi2ri65eo3bz3huye"); // static Agraph_t *localsubg(Agraph_t * g, unsigned long id)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
...
UNSUPPORTED("23h62quwaqhzozodqbuxdprgr"); // 	return subg;
UNSUPPORTED("56tguv8qxc42d75z451xy9h7l"); //     subg = agalloc(g, sizeof(Agraph_t));
UNSUPPORTED("93s6xhmn0kapz3dfulpgqh4cp"); //     subg->clos = g->clos;
UNSUPPORTED("dgq1i2aeueapv0ze90jsw2oja"); //     subg->desc = g->desc;
UNSUPPORTED("7rm2fex4sgkj7e6enjv65h9pa"); //     subg->desc.maingraph = (0);
UNSUPPORTED("4y7pqj35zj2iinimxtn8tenmg"); //     subg->parent = g;
UNSUPPORTED("eh3jhnqwc8nvfjtg04lw2bws4"); //     subg->root = g->root;
UNSUPPORTED("1hzhfphd5hld0szonysbjrx1f"); //     AGID(subg) = id;
UNSUPPORTED("2atta69rbbe5oi9jqu2lpa5v7"); //     return agopen1(subg);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
...
public static Object agsubg(Object... arg) {
UNSUPPORTED("370zmetmf3t5rozxgomcn0t7v"); // Agraph_t *agsubg(Agraph_t * g, char *name, int cflag)
UNSUPPORTED("erg9i1970wdri39osu8hx2a6e"); // {
UNSUPPORTED("5v0qr6wzw47z083l6jupv94gw"); //     unsigned long id;
UNSUPPORTED("c3tourf5k7groqyh71yjd5xec"); //     Agraph_t *subg;
UNSUPPORTED("1zmivm9qg7ksortm2kqosokq3"); //     if (name && agmapnametoid(g, AGRAPH, name, &id, (0))) {
UNSUPPORTED("1d5c7k13au2bslljybbpl46jm"); // 	/* might already exist */
UNSUPPORTED("2v288xyqbvu2kg0vq4hkj37kx"); // 	if ((subg = agfindsubg_by_id(g, id)))
UNSUPPORTED("9jkwxv4odp6ynqo782c2w21g"); // 	    return subg;
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
UNSUPPORTED("c1d0fc0wxqzowlz7l4om8121r"); //     if (cflag && agmapnametoid(g, AGRAPH, name, &id, (!(0)))) {	/* reserve id */
UNSUPPORTED("ecrqdk8b7debftn6d8bbmh0s4"); // 	subg = localsubg(g, id);
UNSUPPORTED("2cikheyedjm72j72o6hh7d2hj"); // 	agregister(g, AGRAPH, subg);
UNSUPPORTED("23h62quwaqhzozodqbuxdprgr"); // 	return subg;
UNSUPPORTED("dvgyxsnyeqqnyzq696k3vskib"); //     }
UNSUPPORTED("aiomrs3c8lzrfmupfz6vc4puh"); //     return ((Agraph_t*)0);
UNSUPPORTED("c24nfmv9i7o5eoqaymbibp7m7"); // }
