...
// 8bj6ivnd4go7wt4pvzqgk8mlr
// static unsigned long HTML_BIT
@TranslatedBy("plantuml")
private static @Unsigned int HTML_BIT;
// dqn77l82bfu071bv703e77jmg
// static unsigned long CNT_BITS
@TranslatedBy("plantuml")
static private @Unsigned int CNT_BITS;
// boyxdmkhstn4i64pqf6sv1mi7
// static Dtdisc_t Refstrdisc = 
@TranslatedBy("plantuml")
private static Dtdisc_t Refstrdisc = new Dtdisc_t(
	new OFFSET(refstr_t.class, "s"),
	size_t.MINUS_ONE, 
	null, 
	null, 
	new Dtfree_f() {
		public void function(Dict_t arg1, StarVoid arg2, Dtdisc_t arg3) {
			agdictobjfree(arg1, (Agsubnode_t) arg2, arg3);
		}
	}, 
	null, 
	null, 
	...
	null);
// 2e0tdcdyjc9zq54xt1nzgwvn3
// static Dict_t *Refdict_default
@TranslatedBy("plantuml")
private static Dict_t Refdict_default[] = new Dict_t[1];
// f1nwss2xoaub1hyord232ugoj
...
// 9aajykl8nuymg60zukycquawa
// int agstrclose(Agraph_t * g) 
public static Object agstrclose() {
throw new UnsupportedOperationException();
}


// 9ts4wqhw2xafdv3tlcilneewq
// static refstr_t *refsymbind(Dict_t * strdict, char *s) 
@TranslatedBy("plantuml")
public static refstr_t refsymbind(Dict_t strdict, StarChar s) {
    refstr_t key = new refstr_t();
    refstr_t r;
    key.s = s;
    r = (refstr_t) castTo(strdict.searchf.function((strdict), key,0000004), refstr_t.class);
    return r;
}

// 1scntgo71z7c2v15zapiyw59w
// static char *refstrbind(Dict_t * strdict, char *s) 
@TranslatedBy("plantuml")
public static StarChar refstrbind(Dict_t strdict, StarChar s) {
    refstr_t r;
...
// bb8aqjshw3ecae2lsmhigd0mc
// char *agstrbind(Agraph_t * g, char *s) 
@TranslatedBy("plantuml")
public static StarChar agstrbind(Agraph_t g, StarChar s) {
    return refstrbind(refdict(g), s);
}

// 86oznromwhn9qeym0k7pih73q
...
// 1ovgpnv6r8ru6iz51ic91zzal
// char *agstrdup_html(Agraph_t * g, char *s) 
public static Object agstrdup_html() {
throw new UnsupportedOperationException();
}


// enhn1ajfo86a19dgm4b8lduz7
// int agstrfree(Agraph_t * g, char *s) 
@TranslatedBy("plantuml")
public static int agstrfree(Agraph_t g, StarChar s) {
throw new UnsupportedOperationException();
}

// 3em4wzjnpajd5d3igb90l3rml
// int aghtmlstr(char *s) 
public static Object aghtmlstr() {
throw new UnsupportedOperationException();
}


// ap2ebebypq6vmwle0hicv6tmj
// void agmarkhtmlstr(char *s) 
public static Object agmarkhtmlstr() {
throw new UnsupportedOperationException();
}
