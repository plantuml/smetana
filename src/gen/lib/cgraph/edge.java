...
// cee3kc2m61ml4f8le5ueoyrjb
// static Agtag_t Tag
@TranslatedBy("plantuml") 
static final Agtag_t Tag = new Agtag_t();
// 9vamtktowqtk4955i546z9obw
// Agedge_t *agfstout(Agraph_t * g, Agnode_t * n) 
@TranslatedBy("plantuml")
public static Agedge_t agfstout(Agraph_t g, Agnode_t n) {
throw new UnsupportedOperationException();
}

// 4f40s3djqewpt451rakag08p6
// Agedge_t *agnxtout(Agraph_t * g, Agedge_t * e) 
@TranslatedBy("plantuml")
public static Agedge_t agnxtout(Agraph_t g, Agedge_t e) {
throw new UnsupportedOperationException();
}

// c60qt3ycq0xweabgtqt16xe93
// Agedge_t *agfstin(Agraph_t * g, Agnode_t * n) 
public static Object agfstin() {
throw new UnsupportedOperationException();
}


// 11w98qciujj283t9kdv5yl1hv
// Agedge_t *agnxtin(Agraph_t * g, Agedge_t * e) 
public static Object agnxtin() {
throw new UnsupportedOperationException();
}


// 6nwyo5bklramr0d093aa1h25o
// Agedge_t *agfstedge(Agraph_t * g, Agnode_t * n) 
public static Object agfstedge() {
throw new UnsupportedOperationException();
}


// 4f4f4ga2n53rsrca2ywnlntd8
// Agedge_t *agnxtedge(Agraph_t * g, Agedge_t * e, Agnode_t * n) 
public static Object agnxtedge() {
throw new UnsupportedOperationException();
}


// c175o6j61jqmfnl4o1g1h1mie
...
// 8e3b1b51m1a9fi0syxcbvz8fe
// static Agedge_t *agfindedge_by_id(Agraph_t * g, Agnode_t * t, Agnode_t * h, 				  unsigned long id) 
public static Object agfindedge_by_id() {
throw new UnsupportedOperationException();
}


// b32ssm6ex1pdz1b3nt4fwlhul
// Agsubnode_t *agsubrep(Agraph_t * g, Agnode_t * n) 
@TranslatedBy("plantuml") 
public static Agsubnode_t agsubrep(Agraph_t g, Agnode_t n) {
    Agsubnode_t sn;
    final Agsubnode_t template = new Agsubnode_t();
	if (g == n.root) sn = n.mainsub;
	else {
			template.node = n;
			sn = (Agsubnode_t) ((Dict_t)g.n_id).searchf.function((g.n_id),template,0000004);
	}
    return sn;
}

// 6u0niow33w9gva780waluva4n
...
// d15ux1i30s7lpkapj419g86w
// static void installedge(Agraph_t * g, Agedge_t * e) 
public static Object installedge() {
throw new UnsupportedOperationException();
}


// 2vtt6zb0n3oru23okvw4pxasg
// static void subedge(Agraph_t * g, Agedge_t * e) 
@TranslatedBy("plantuml")
public static void subedge(Agraph_t g, Agedge_t e) {
throw new UnsupportedOperationException();
}

// 4zdbfzg73zudamzz65cjb433v
// static Agedge_t *newedge(Agraph_t * g, Agnode_t * t, Agnode_t * h, 			 unsigned long id) 
@TranslatedBy("plantuml")
public static Agedge_t newedge(Agraph_t g, Agnode_t t, Agnode_t h, @Unsigned Int id) {
throw new UnsupportedOperationException();
}

// 1ufxhg5xnmll1pe5339477823
// static int ok_to_make_edge(Agraph_t * g, Agnode_t * t, Agnode_t * h) 
@TranslatedBy("plantuml")
public static boolean ok_to_make_edge(Agraph_t g, Agnode_t t, Agnode_t h) {
throw new UnsupportedOperationException();
}

// divq36nbmzm5rwd8q5qmxnl0x
// Agedge_t *agidedge(Agraph_t * g, Agnode_t * t, Agnode_t * h, 		   unsigned long id, int cflag) 
public static Object agidedge() {
throw new UnsupportedOperationException();
}


// 37sh35g56f52b5ck6j27irv6o
...
// 4x6s5nefpf2d3x3g0yl4tqmom
// void agdeledgeimage(Agraph_t * g, Agedge_t * e, void *ignored) 
public static Object agdeledgeimage() {
throw new UnsupportedOperationException();
}


// 1466qn9hfhez2rs2paj85218e
...
// 3z3xlgox8vbhojrzfukg7fz95
// Agedge_t *agsubedge(Agraph_t * g, Agedge_t * e, int cflag) 
public static Object agsubedge() {
throw new UnsupportedOperationException();
}


// 3c4bra9j93gk92jg27q62pcvb
// int agedgeidcmpf(Dict_t * d, void *arg_e0, void *arg_e1, Dtdisc_t * disc) 
@TranslatedBy("plantuml")
public static int agedgeidcmpf(Dict_t d, StarVoid arg_e0, StarVoid arg_e1, Dtdisc_t disc) {
throw new UnsupportedOperationException();
}

// 92o21hrcbsr4ffydtwb7d71rc
// int agedgeseqcmpf(Dict_t * d, void *arg_e0, void *arg_e1, Dtdisc_t * disc) 
@TranslatedBy("plantuml")
public static int agedgeseqcmpf(Dict_t d, StarVoid arg_e0, StarVoid arg_e1, Dtdisc_t disc) {
throw new UnsupportedOperationException();
}

// d058zqckpiqls71p4vkuxe87o
// Dtdisc_t Ag_mainedge_seq_disc = 
@TranslatedBy("plantuml")
@HasQuestion("link offset ignored ?")
public static Dtdisc_t Ag_mainedge_seq_disc = new Dtdisc_t(
	null,
	null, 
	null, 
	null, 
	...
	new Dtcompar_f() {
		public int function(Dict_t arg1, StarVoid arg2, StarVoid arg3, Dtdisc_t arg4) {
			return agedgeseqcmpf(arg1, arg2, arg3, arg4);
		}
	}, 
	null, 
	new Dtmemory_f() {
	...
	null);
// 7n5e8w5zjp9b4oeecyvyl96il
// Dtdisc_t Ag_subedge_seq_disc = 
@TranslatedBy("plantuml")
@HasQuestion("link offset ignored ?")
public static Dtdisc_t Ag_subedge_seq_disc = new Dtdisc_t(
	null,
	null, 
	new OFFSET(null, "-1"), 
	null, 
	...
	null);
// 7grv8f2wvpg0db2pn1g7r5abv
// Dtdisc_t Ag_mainedge_id_disc = 
@TranslatedBy("plantuml")
@HasQuestion("link offset ignored ?")
public static Dtdisc_t Ag_mainedge_id_disc = new Dtdisc_t(
	null,
	null, 
	null, 
	null, 
	...
	new Dtcompar_f() {
		public int function(Dict_t arg1, StarVoid arg2, StarVoid arg3, Dtdisc_t arg4) {
			return agedgeidcmpf(arg1, arg2, arg3, arg4);
		}
	}, 
	null, 
	new Dtmemory_f() {
	...
	null);
// 9u0ic8u2hrwlmlqalv37s053f
// Dtdisc_t Ag_subedge_id_disc = 
@TranslatedBy("plantuml")
@HasQuestion("link offset ignored ?")
public static Dtdisc_t Ag_subedge_id_disc = new Dtdisc_t(
	null,
	null, 
	new OFFSET(null, "-1"), 
	null, 
	...
	null);
// ds0u5d48kwhur8q1smv8hpz02
// Agnode_t *agtail(Agedge_t * e) 
public static Object agtail() {
throw new UnsupportedOperationException();
}


// 2o5szjdijdkc7ayarzxn8gfcs
// Agnode_t *aghead(Agedge_t * e) 
public static Object aghead() {
throw new UnsupportedOperationException();
}


// 4ze53t4lapnt9cgcugo49d0ak
// Agedge_t *agopp(Agedge_t * e) 
public static Object agopp() {
throw new UnsupportedOperationException();
}
