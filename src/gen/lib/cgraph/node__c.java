...
try {
    Agsubnode_s sn;
    dummy.getStruct("base").getStruct("tag").setInt("id", id);
    template.setPtr("node", dummy.amp());
    sn = (Agsubnode_s) (g.getPtr("n_id").call("searchf", g.getPtr("n_id"), template.amp(),0000004));
