...
// 79n6elfqk1vw36hmv7bxlrb0v
// static int idcmpf(Dict_t * d, void *arg_p0, void *arg_p1, Dtdisc_t * disc) 
public static Object idcmpf() {
throw new UnsupportedOperationException();
}


// aadw62b6y0d22xf4720pzdiyz
// static int namecmpf(Dict_t * d, void *arg_p0, void *arg_p1, 		    Dtdisc_t * disc) 
public static Object namecmpf() {
throw new UnsupportedOperationException();
}


// cvijg1ekkl36sildxxf28vhug
// static Dtdisc_t LookupByName = 


// dkzjlpsv4zk993r3iyo7msr8n
// static Dtdisc_t LookupById = 


// 49c2o6licqwz253dv60t15m5m
// int aginternalmaplookup(Agraph_t * g, int objtype, char *str, 			unsigned long *result) 
@TranslatedBy("plantuml")
public static boolean aginternalmaplookup(Agraph_t g, int objtype, StarChar str, @Unsigned StarLong result) {
throw new UnsupportedOperationException();
}

// 76qiatu7a59bua2qwoqw1kw8p
// void aginternalmapinsert(Agraph_t * g, int objtype, char *str, 			 unsigned long id) 
@TranslatedBy("plantuml")
public static void aginternalmapinsert(Agraph_t g, int objtype, StarChar str, @Unsigned int id) {
throw new UnsupportedOperationException();
}

// 26obp035owivyv90ywa7brb6
// static IMapEntry_t *find_isym(Agraph_t * g, int objtype, unsigned long id) 
public static Object find_isym() {
throw new UnsupportedOperationException();
}


// foe6bvtujfevsc0f3m8aqln8
// char *aginternalmapprint(Agraph_t * g, int objtype, unsigned long id) 
public static Object aginternalmapprint() {
throw new UnsupportedOperationException();
}


// 67wtfi4mojooc6rs7bxqxu6nu
// int aginternalmapdelete(Agraph_t * g, int objtype, unsigned long id) 
public static Object aginternalmapdelete() {
throw new UnsupportedOperationException();
}


// 2wanqmzppni4zd3mlb6pkou1k
// void aginternalmapclearlocalnames(Agraph_t * g) 
public static Object aginternalmapclearlocalnames() {
throw new UnsupportedOperationException();
}


// exx9lnei1gnd60cuddc52z7i9
// static void closeit(Dict_t ** d) 
public static Object closeit() {
throw new UnsupportedOperationException();
}


// 5dw1m5wgietdxy22txx0l20ph
// void aginternalmapclose(Agraph_t * g) 
public static Object aginternalmapclose() {
throw new UnsupportedOperationException();
}
