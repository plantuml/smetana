...
// 9nwtfv1q3fekn9n90sqk5t06l
// static void set_data(Agobj_t * obj, Agrec_t * data, int mtflock) 
@TranslatedBy("plantuml")
public static void set_data(Agobj_t obj, Agrec_t data, boolean mtflock) {
    Agedge_t e;
    obj.data = data;
    obj.tag.mtflock = mtflock;
    if ((((((Agobj_t)(obj)).tag).objtype) == 3) || (((((Agobj_t)(obj)).tag).objtype) == 2)) {
	e = ((Agobj_t)((Agedge_t)obj.castTo(Agedge_t.class)).castTo(Agobj_t.class)).tag.objtype==3?null:null;
	(((Agobj_t)(e.castTo(Agobj_t.class))).data) = data;
	e.base.tag.mtflock = mtflock;
	throw new UnsupportedOperationException("null:null to be corrected");
    }
}

// 7p2ne3oknmyclvsw4lh3axtd8
...
// 7wkmd0z867cfhifu5sx3f9qk0
// static void objdelrec(Agraph_t * g, Agobj_t * obj, void *arg_rec) 
public static Object objdelrec() {
throw new UnsupportedOperationException();
}


// 9lrcdtq3amx34ixpjad1kj9w1
// static void listdelrec(Agobj_t * obj, Agrec_t * rec) 
public static Object listdelrec() {
throw new UnsupportedOperationException();
}


// arw4scd9vnn94qkgn1g4to9ce
// int agdelrec(void *arg_obj, char *name) 
public static Object agdelrec() {
throw new UnsupportedOperationException();
}


// 61hbvi8qf9sf7fp8zpov061px
// static void simple_delrec(Agraph_t * g, Agobj_t * obj, void *rec_name) 
public static Object simple_delrec() {
throw new UnsupportedOperationException();
}


// bnxg1ul1ves1mm7vlzs087rgf
// void aginit(Agraph_t * g, int kind, char *rec_name, int arg_rec_size, int mtf) 
public static Object aginit() {
throw new UnsupportedOperationException();
}


// pywchcp3ploq85by79w87hnp
// void agclean(Agraph_t * g, int kind, char *rec_name) 
public static Object agclean() {
throw new UnsupportedOperationException();
}


// 1s9p443oxpnfk2w28k6bgn1y0
// void agrecclose(Agobj_t * obj) 
public static Object agrecclose() {
throw new UnsupportedOperationException();
}
