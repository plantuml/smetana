...
// akq0jgwdspf75ypeatgcnfn8w
// static void *memopen(Agdisc_t* disc) 
@TranslatedBy("plantuml")
public static StarVoid memopen(Agdisc_t disc) {
	return null;
}

// 9mtjrx0vjzwuecjwpxylr9tag
// static void *memalloc(void *heap, size_t request) 
@TranslatedBy("plantuml")
public static StarVoid memalloc(StarVoid heap, size_t request) {
    StarVoid rv = malloc(request);
    Memory.memset(rv, 0, request);
    return rv;
}
// 18v2hhjculhnb3b7fc4tx3yjw
// static void *memresize(void *heap, void *ptr, size_t oldsize, 		       size_t request) 
@TranslatedBy("plantuml")
public static StarVoid memresize(StarVoid heap, StarVoid ptr, size_t oldsize, size_t request) {
throw new UnsupportedOperationException();
}

// c320bstcg5nctel3onh2pserl
// static void memfree(void *heap, void *ptr) 
@TranslatedBy("plantuml")
public static void memfree(StarVoid heap, StarVoid ptr) {
    free(ptr);
}

// 1cni5q244gsprpvtjsq7gs17m
// Agmemdisc_t AgMemDisc =     
@TranslatedBy("plantuml")
	public static Agmemdisc_t AgMemDisc = new Agmemdisc_t(
	new Agmemdisc_s.open() {
		public StarVoid function(Agdisc_t arg1) {
			return memopen(arg1);
		}
	}
	,
	new Agmemdisc_s.alloc() {
		public StarVoid function(StarVoid state, size_t req) {
			return memalloc(state, req);
		}
	}
	,
	new Agmemdisc_s.resize() {
		public StarVoid function(StarVoid state, StarVoid ptr, size_t old, size_t req) {
			return memresize(state, ptr, old, req);
		}
	}
	,
	new Agmemdisc_s.free() {
		public void function(StarVoid state, StarVoid ptr) {
			memfree(state, ptr);
		}
	}
	,
...
// 7newv1hmzvt4vtttc9cxdxfpn
// void *agalloc(Agraph_t * g, size_t size) 
@TranslatedBy("plantuml")
public static StarVoid agalloc(Agraph_t g, size_t size) {
    StarVoid mem;
    mem = g.clos.disc.mem.alloc.function(g.clos.state.mem, size);
    if (mem == null)
	 agerr(agerrlevel_t.AGERR,"memory allocation failure");
    return mem;
}

// 55lm0cse6lsgqblx6puxpjs3j
// void *agrealloc(Agraph_t * g, void *ptr, size_t oldsize, size_t size) 
public static Object agrealloc() {
throw new UnsupportedOperationException();
}


// 5cy6dl95ayyuzq0m35179g1a1
// void agfree(Agraph_t * g, void *ptr) 
@TranslatedBy("plantuml")
public static void agfree(Agraph_t g, StarVoid ptr) {
throw new UnsupportedOperationException();
}
