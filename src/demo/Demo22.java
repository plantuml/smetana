...
public class Demo22 {
	...
	private static void work(Agraph_s g) {
		...
		agsafeset(e1, new CString("label"), Macro.createHackInitDimensionFromLabel(14, 17), new CString(""));

		Agedge_s e2 = agedge(g, b, a, null, true);
		agsafeset(e2, new CString("minlen"), new CString("0"), new CString(""));
		...
		agsafeset(e2, new CString("label"), Macro.createHackInitDimensionFromLabel(14, 17), new CString(""));
