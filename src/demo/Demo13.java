...
public class Demo13 {
	...
	private static void work(Agraph_s g) {
		Agnode_s n = createNode(g, "n", "0.27", "0.27");
		Agnode_s m = createNode(g, "m", "0.33", "0.33");
		Agnode_s p = createNode(g, "p", "0.65", "0.48");

		Agedge_s e1 = agedge(g, n, m, null, true);
		Agedge_s e2 = agedge(g, m, p, null, true);
		...
		agsafeset(e2, new CString("arrowtail"), new CString("none"), new CString(""));
		agsafeset(e2, new CString("arrowhead"), new CString("none"), new CString(""));

		//agsafeset(e1, new CString("label"), Macro.createHackInitDimensionFromLabel(30, 18), new CString(""));
		agsafeset(e2, new CString("label"), Macro.createHackInitDimensionFromLabel(30, 18), new CString(""));
