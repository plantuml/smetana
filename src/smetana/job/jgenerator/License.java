...
public class License {
	...
	public static List<String> getJavaHeader() {
		...
		h.add(" * ");
		h.add(" * This file is part of Smetana.");
		h.add(" * Smetana is a partial translation of Graphviz/Dot sources from C to Java.");
		h.add(" *");
		h.add(" * (C) Copyright 2009-2017, Arnaud Roques");
		h.add(" *");
		h.add(" * This translation is distributed under the same Licence as the original C program:");
		h.add(" * ");
		h.add(" *************************************************************************");
	...
	public static List<String> getJavaHeader2() {
		final List<String> h = new ArrayList<String>();
		h.add("/* ========================================================================");
		h.add(" * PlantUML : a free UML diagram generator");
		h.add(" * ========================================================================");
