...
public class Demo41 {
	...
	private static void work(ST_Agraph_s g) {
		...
		ST_Agedge_s e1 = createEdge(g, cl2, cl5, 200, 20);
		agsafeset(e1, new CString("headlabel"), Macro.createHackInitDimensionFromLabel(100, 50), new CString(""));
		...
		// Agnode_s cl1 = createNode(cluster01, "cl1");
		...
		graphic.drawTo(new File("out41.png"));

	}

	private static ST_Agedge_s createEdge(ST_Agraph_s g, ST_Agnode_s a0, ST_Agnode_s a1, int labelWidth, int labelHeight) {
		ST_Agedge_s e1 = agedge(g, a0, a1, null, true);
		agsafeset(e1, new CString("label"), Macro.createHackInitDimensionFromLabel(labelWidth, labelHeight),
				new CString(""));
