...
//		Agnode_s cl2 = createNode(g, "cl2");
//		Agnode_s cl5 = createNode(g, "cl5");
//		Agedge_s e1 = createEdge(g, cl2, cl5, 1);
		...
		ST_Agedge_s e1 = createEdge(g, cl1, cl2, 0);
		ST_Agedge_s e2 = createEdge(g, cl3, cl2, 0);
		ST_Agedge_s e3 = createEdge(g, cl3, cl2, 0);
		...
		graphic.addEdge(e2);
		graphic.addEdge(e3);
		graphic.drawTo(new File("out32.png"));
