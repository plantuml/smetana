#line 1 "graphviz-2.38.0\\lib\\ortho\\fPQ.c" 1
/* $Id$Revision: */
...
#line 19 "graphviz-2.38.0\\lib\\ortho\\fPQ.c" 2
#line 1 "graphviz-2.38.0\\lib\\ortho\\fPQ.c" 1
...
#line 22 "graphviz-2.38.0\\lib\\ortho\\fPQ.c" 2
...
{
  if (!pq) {
    pq = (snode**)zmalloc((sz+1)*sizeof(snode*));
    pq[0] = &guard;
    PQsize = sz;
  }
  PQcnt = 0;
