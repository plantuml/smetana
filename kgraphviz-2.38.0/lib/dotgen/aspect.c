#line 1 "graphviz-2.38.0\\lib\\dotgen\\aspect.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\dotgen\\aspect.c" 2
...
static void computeNodeGroups(graph_t * g)
{
    ...
    nodeGroups = (nodeGroup_t*)gmalloc((agnnodes(g))*sizeof(nodeGroup_t));

    nNodeGroups = 0;

    /* initialize node ids. Id of a node is used as an index to the group. */
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id) = -1;
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->UF_size) == 0) {	/* no same ranking constraint */
	    nodeGroups[nNodeGroups].nodes = (node_t **)zmalloc(sizeof(node_t *));
	    nodeGroups[nNodeGroups].nodes[0] = n;
	    nodeGroups[nNodeGroups].nNodes = 1;
	    nodeGroups[nNodeGroups].width = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width);
	    nodeGroups[nNodeGroups].height = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height);

	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id) = nNodeGroups;
	    nNodeGroups++;
	} else			/* group same ranked nodes */
	{
	    node_t *l = UF_find(n);
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->id) > -1)	/* leader is already grouped */
	    {
		int index = (((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->id);
		nodeGroups[index].nodes[nodeGroups[index].nNodes++] = n;
		nodeGroups[index].width += (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width);
		nodeGroups[index].height =
		    (nodeGroups[index].height <
		     (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)) ? (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) : nodeGroups[index].
		    height;

		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id) = index;
	    } else		/* create a new group */
	    {
		nodeGroups[nNodeGroups].nodes =
		    (node_t **)zmalloc(((((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->UF_size))*sizeof(node_t *));

		if (l == n)	/* node n is the leader */
		{
		    nodeGroups[nNodeGroups].nodes[0] = l;
		    nodeGroups[nNodeGroups].nNodes = 1;
		    nodeGroups[nNodeGroups].width = (((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->width);
		    nodeGroups[nNodeGroups].height = (((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->height);
		} else {
		    nodeGroups[nNodeGroups].nodes[0] = l;
		    nodeGroups[nNodeGroups].nodes[1] = n;
		    nodeGroups[nNodeGroups].nNodes = 2;
		    nodeGroups[nNodeGroups].width =
			(((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->width) + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width);
		    nodeGroups[nNodeGroups].height =
			((((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->height) <
			 (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)) ? (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) : (((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->height);
		}

		(((Agnodeinfo_t*)(((Agobj_t*)(l))->data))->id) = nNodeGroups;
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id) = nNodeGroups;
		nNodeGroups++;
	    }
	}
...
int countDummyNodes(graph_t * g)
{
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
		...
		count += abs((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->rank) - (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->rank)) - 1;
	}
    }
    return count;
}
...
static void computeLayerWidths(graph_t * g)
{
     ...
     */
    layerWidthInfo = (layerWidthInfo_t*)zmalloc((nNodeGroups)*sizeof(layerWidthInfo_t));

    for (i = 0; i < nNodeGroups; i++) {
	layerWidthInfo[i].nodeGroupsInLayer =
	    (nodeGroup_t **)zmalloc((nNodeGroups)*sizeof(nodeGroup_t *));

	layerWidthInfo[i].removed = (int*)zmalloc((nNodeGroups)*sizeof(int));
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    ...
	    /* FIX: This loop maybe unnecessary, but removing it and using 
             ...
             */
	    for (k = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->rank) + 1; k < (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->rank); k++) {
	...
	if ((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank) + 1 > nLayers)	/* update the number of layers */
	    nLayers = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank) + 1;

	layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].width +=
	    nodeGroups[i].width * 72 + (layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].width >
					 0) * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep);
	if (layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].height < nodeGroups[i].height * 72)
	    layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].height = nodeGroups[i].height * 72;
	layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].
	    nodeGroupsInLayer[layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].
			      nNodeGroupsInLayer] = &nodeGroups[i];
	layerWidthInfo[(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->rank)].nNodeGroupsInLayer++;
    }
...
static void reduceMaxWidth2(graph_t * g)
{
	...
	if ((w +
	     ...
	     72 + (w > 0) * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep) <= targetWidth)
	    || !fst) {
	    w += (layerWidthInfo[maxLayerIndex].nodeGroupsInLayer[i])->
		width * 72 + (w > 0) * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep);
	    if (!fst) {
		fstNdGrp =
		...
		for (q = 0; q < ng->nNodes; q++) {
			...
			virtual_edge(fstNdGrp->nodes[p], ng->nodes[q],
				     NULL);
		    (((Agedgeinfo_t*)(((Agobj_t*)(newVEdge))->data))->edge_type) = 1;
		...
		(ng->width * 72 + (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep));
	}
    }
}
...
static void applyPacking2(graph_t * g)
{
    ...
    sortedLayerIndex = (int*)zmalloc((agnnodes(g))*sizeof(int));
...
void initEdgeTypes(graph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	for (lc = 0; lc < (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size; lc++) {
	    e = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list[lc];
	    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->edge_type) = 0;
	}
    }
}
...
static double computeCombiAR(graph_t * g)
{
    ...
    computeLayerWidths(g);
    maxH = (nLayers - 1) * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->ranksep);

    for (i = 0; i < nLayers; i++) {
	if (maxW <
	    layerWidthInfo[i].width +
	    layerWidthInfo[i].nDummyNodes * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep)) {
	    maxW =
		layerWidthInfo[i].width +
		layerWidthInfo[i].nDummyNodes * (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep);
	    maxLayerIndex = i;
...
static void zapLayers(graph_t * g)
{
	...
	if (layerWidthInfo[i].nNodeGroupsInLayer == 0) {
		...
		for (q = 0; q < ng->nNodes; q++) {
		    ...
		    (((Agnodeinfo_t*)(((Agobj_t*)(nd))->data))->rank) -= count;
		}
	    }
	}
    }
...
void rank3(graph_t * g, aspect_t * asp)
{
    ...
    double lastAR = 1.7976931348623157e+308;
	...
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rank) = 0;
	}
...
void init_UF_size(graph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n))
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->UF_size) = 0;
}
