#line 1 "graphviz-2.38.0\\lib\\dotgen\\dotinit.c" 1
/* $Id$ $Revision$ */
...
#line 18 "graphviz-2.38.0\\lib\\dotgen\\dotinit.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\dotgen\\dotinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\dotgen\\aspect.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 20 "graphviz-2.38.0\\lib\\dotgen\\dotinit.c" 2
...
dot_cleanup_node(node_t * n)
{
    ...
    do {if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->flat_out).list) free((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->flat_out).list);} while (0);
    do {if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->flat_in).list) free((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->flat_in).list);} while (0);
    do {if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->other).list) free((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->other).list);} while (0);
...
static void free_virtual_edge_list(node_t * n)
{
    ...
    for (i = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size - 1; i >= 0; i--) {
	e = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list[i];
	delete_fast_edge(e);
	free(e->base.data);
	free(e);
    }
    for (i = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->out).size - 1; i >= 0; i--) {
	e = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->out).list[i];
	delete_fast_edge(e);
	free(e->base.data);
	free(e);
    }
...
static void free_virtual_node_list(node_t * vn)
{
    ...
    while (vn) {
	next_vn = (((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->next);
	free_virtual_edge_list(vn);
	if ((((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->node_type) == 1) {
	    do {if ((((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->out).list) free((((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->out).list);} while (0);
	    do {if ((((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->in).list) free((((Agnodeinfo_t*)(((Agobj_t*)(vn))->data))->in).list);} while (0);
	    free(vn->base.data);
	    free(vn);
	}
	vn = next_vn;
...
dot_cleanup_graph(graph_t * g)
{
    ...
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)) free ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust));
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankleader)) free ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankleader));

    do {if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->comp).list) free((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->comp).list);} while (0);
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)) {
	for (i = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->minrank); i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->maxrank); i++)
	    free((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[i].av);
	if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->minrank) == -1)
	    free((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)-1);
	else
	    free((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank));
    }
    if (g != agroot(g)) 
...
void dot_cleanup(graph_t * g)
{
    ...
    free_virtual_node_list((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nlist));
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    gv_cleanup_edge(e);
	}
...
{
    Agnode_t* v = NULL;
    int j, rk = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rank);

    for (j = 0; j < (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].n; j++) {
	v = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].v[j];
	if (v == n) {
	    for (j++; j < (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].n; j++) {
		(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].v[j-1] = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].v[j];
	    }
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rank)[rk].n--;
	    break;
	}
    }
    assert (v == n);  /* if found */
...
{
    Agsym_t* rk = agattr(g,1,"rank","");
    Agsym_t* order = agattr(g,1,"order","");
    Agnode_t* n;
    char buf[BUFSIZ];

    for (n = agfstnode(g); n; n = agnxtnode(g,n)) {
	if (maxphase >= 1) {
	    sprintf(buf, "%d", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rank));
	    agxset(n,rk,buf);
	}
	if (maxphase >= 2) {
	    sprintf(buf, "%d", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->order));
	    agxset(n,order,buf);
	}
    }
}
...
{
    agbindrec(sg, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->drawing) = (layout_t*)zmalloc(sizeof(layout_t));
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->drawing)->quantum = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->quantum; 
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->drawing)->dpi = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->dpi;
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->gvc) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->gvc);
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->charset) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->charset);
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->rankdir) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir);
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->nodesep) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep);
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->ranksep) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->ranksep);
    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->fontnames) = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->fontnames);
}
...
{
    node_t* np;
    double* ps = (double*)zmalloc((2*agnnodes(g))*sizeof(double));

    for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos) = ps;
	ps[0] = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->coord).x)/(double)72);
	ps[1] = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->coord).y)/(double)72);
	ps += 2;
    }
}
...
resetCoord (Agraph_t* g)
{
    ...
    double* sp = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos);
    double* ps = sp;

    for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos) = 0;
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->coord).x = ((ps[0])*(double)72);
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->coord).y = ((ps[1])*(double)72);
	ps += 2;
    }
    free (sp);
}
...
{
    return (((Agraphinfo_t*)(((Agobj_t*)(agroot(p)))->data))->dotroot);
}
