#line 1 "graphviz-2.38.0\\lib\\dotgen\\acyclic.c" 1
/* $Id$ $Revision$ */
...
#line 21 "graphviz-2.38.0\\lib\\dotgen\\acyclic.c" 2
...
void reverse_edge(edge_t * e)
{
    ...
    delete_fast_edge(e);
    if ((f = find_fast_edge(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node))))
	merge_oneway(e, f);
    else
	virtual_edge(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node), e);
}
