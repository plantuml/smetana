#line 1 "graphviz-2.38.0\\lib\\dotgen\\sameport.c" 1
/* $Id$ $Revision$ */
...
#line 21 "graphviz-2.38.0\\lib\\dotgen\\sameport.c" 2
...
/* merge edge ports in G */
{
    ...
    E_samehead = agattr(g, 2, "samehead",(char*)0);
    E_sametail = agattr(g, 2, "sametail",(char*)0);
    if (!(E_samehead || E_sametail))
	return;
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	n_samehead = n_sametail = 0;
	for (e = agfstedge(g, n); e; e = agnxtedge(g, e, n)) {
	    if (((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node) == ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node)) continue;  /* Don't support same* for loops */
	    if (((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node) == n && E_samehead &&
	        (id = agxget(e, E_samehead))[0])
		n_samehead = sameedge(samehead, n_samehead, n, e, id);
	    else if (((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node) == n && E_sametail &&
	...
	for (i = 0; i < n_samehead; i++) {
	    ...
	    do {if (samehead[i].l.list) free(samehead[i].l.list);} while (0);
	...
	for (i = 0; i < n_sametail; i++) {
	    ...
	    do {if (sametail[i].l.list) free(sametail[i].l.list);} while (0);
	    /* I sure hope I don't need to free the char* id */
	}
    }
}
...
/* register E in the SAME structure of N under ID. Uses static int N_SAME */
{
    ...
    for (i = 0; i < n_same; i++)
	if ((*(same[i].id)==*(id)&&!strcmp(same[i].id,id))) {
	    do {same[i].l.list = (same[i].l.list? (edge_t**)grealloc(same[i].l.list,(same[i].l.size + 2)*sizeof(edge_t*)):(edge_t**)gmalloc((same[i].l.size + 2)*sizeof(edge_t*))); same[i].l.list[same[i].l.size++] = e; same[i].l.list[same[i].l.size] = NULL;} while(0);
	    goto set_arrow;
	}
    if (++n_same > 5) {
	n_same--;
    ...
    do {same[i].l.size = 0; same[i].l.list = (edge_t**)zmalloc((1 + 1)*sizeof(edge_t*)); } while (0);
    do {same[i].l.list[same[i].l.size++] = e; same[i].l.list[same[i].l.size] = NULL;} while(0);
    same[i].id = id;
    same[i].n_arr = 0;
    same[i].arr_len = 0;
  set_arrow:
    arrow_flags(e, &sflag, &eflag);
    if ((flag = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node) == n ? eflag : sflag))
	same[i].arr_len =
...
*/
{
    ...
    for (i = 0; i < l->size; i++) {
	e = l->list[i];
	if (((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node) == u)
	    v = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
	else
	    v = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	x1 = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->coord).x - (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).x;
	y1 = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->coord).y - (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).y;
	r = hypot(x1, y1);
	x += x1 / r;
	y += y1 / r;
    }
    ...
    x1 = (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).x;
    y1 = (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).y;	/* center of node */
    r = (((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->lw) + (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->rw))>((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->ht) + (((Agraphinfo_t*)(((Agobj_t*)(agraphof(u)))->data))->ranksep))?((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->lw) + (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->rw)):((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->ht) + (((Agraphinfo_t*)(((Agobj_t*)(agraphof(u)))->data))->ranksep)));	/* far away */
    x2 = x * r + (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).x;
    y2 = y * r + (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).y;
	...
	shape_clip(u, curve);
	x1 = curve[0].x - (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).x;
	y1 = curve[0].y - (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->coord).y;
    }

    /* compute PORT on the boundary */
    prt.p.x = ((x1>=0)?(int)(x1 + .5):(int)(x1 - .5));
    prt.p.y = ((y1>=0)?(int)(y1 + .5):(int)(y1 - .5));
    prt.bp = 0;
    prt.order =
	(256 * ((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->lw) + prt.p.x)) / ((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->lw) + (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->rw));
    prt.constrained = 0;
    prt.defined = (!(0));
    prt.clip = 0;
    prt.dyna = 0;
	...
	for (; e; e = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->to_virt)) {	/* assign to all virt edges of e */
	    for (f = e; f;
		 f = (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->edge_type) == 1 &&
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 2?(f):((f)-1))->node)))->data))->node_type) == 1 &&
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 2?(f):((f)-1))->node)))->data))->out).size == 1 ?
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 2?(f):((f)-1))->node)))->data))->out).list[0] : NULL) {
		if (((((((Agobj_t*)(f))->tag).objtype) == 2? (f): ((f)-1))->node) == u)
		    (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->head_port) = prt;
		if (((((((Agobj_t*)(f))->tag).objtype) == 3? (f): ((f)+1))->node) == u)
		    (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->tail_port) = prt;
	    }
	    for (f = e; f;
		 f = (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->edge_type) == 1 &&
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 3?(f):((f)+1))->node)))->data))->node_type) == 1 &&
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 3?(f):((f)+1))->node)))->data))->in).size == 1 ?
		 (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(f))->tag).objtype) == 3?(f):((f)+1))->node)))->data))->in).list[0] : NULL) {
		if (((((((Agobj_t*)(f))->tag).objtype) == 2? (f): ((f)-1))->node) == u)
		    (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->head_port) = prt;
		if (((((((Agobj_t*)(f))->tag).objtype) == 3? (f): ((f)+1))->node) == u)
		    (((Agedgeinfo_t*)(((Agobj_t*)(f))->data))->tail_port) = prt;
    ...
    (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->has_port) = (!(0));	/* kinda pointless, because mincross is already done */
}
