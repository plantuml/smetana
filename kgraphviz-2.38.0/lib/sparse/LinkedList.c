#line 1 "graphviz-2.38.0\\lib\\sparse\\LinkedList.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sparse\\LinkedList.c" 2
...
#line 17 "graphviz-2.38.0\\lib\\sparse\\LinkedList.c" 2
...
SingleLinkedList SingleLinkedList_new(void *data){
  ...
  head = (struct SingleLinkedList_struct*)gmalloc(sizeof(struct SingleLinkedList_struct));
  head->data = data;
  head->next = NULL;
  return head;
}
...
DoubleLinkedList DoubleLinkedList_new(void *data){
  ...
  head = (struct DoubleLinkedList_struct*)gmalloc(sizeof(struct DoubleLinkedList_struct));
  head->data = data;
  head->next = NULL;
  head->prev = NULL;
  return head;
