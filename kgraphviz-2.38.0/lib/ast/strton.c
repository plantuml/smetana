#line 1 "graphviz-2.38.0\\lib\\ast\\strton.c" 1
/* $Id$ $Revision$ */
...
#line 58 "graphviz-2.38.0\\lib\\ast\\strton.c" 2
...
long strton(const char *a, char **e, char *basep, int m)
{
	...
	((_Sftable.sf_cvinit) ? 1 : ((_Sftable.sf_cvinit) = (*(_Sftable.sf_cvinitf))()) );
	cv = base <= 36 ? (_Sftable.sf_cv36) : (_Sftable.sf_cv64);
	if ((base & ~(base - 1)) == base) {
	    if (base < 8)
		shift = base < 4 ? 1 : 2;
	    else if (base < 32)
