#line 1 "graphviz-2.38.0\\lib\\osage\\osageinit.c" 1
...
#line 1 "graphviz-2.38.0\\lib\\osage\\osage.h" 1
/* vim:set shiftwidth=4 ts=8: */
...
#line 16 "graphviz-2.38.0\\lib\\osage\\osage.h" 2
...
#line 21 "graphviz-2.38.0\\lib\\osage\\osageinit.c" 2
...
#line 22 "graphviz-2.38.0\\lib\\osage\\osageinit.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\osage\\osageinit.c" 2
...
static void cluster_init_graph(graph_t * g)
{
    ...
    setEdgeType (g, (1 << 1));
    Ndim = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->ndim)=2;	/* The algorithm only makes sense in 2D */
...
layout (Agraph_t* g, int depth)
{
    ...
    double margin;
    void** children;
    Agsym_t* cattr = (void *)0;
    Agsym_t* vattr = (void *)0;
    ...
    nv = agnnodes(g);
    total = (nv - nvs) + (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster);

    if ((total == 0) && ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label) == (void *)0)) {
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y = 0;
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.x = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y = 18;
	return;
    }
    
    pmode = getPackInfo(g, l_array, 4, &pinfo);
    if (pmode < l_graph) pinfo.mode = l_graph;

        /* add user sort values if necessary */
    if ((pinfo.mode == l_array) && (pinfo.flags & (1 << 1))) {
	cattr = agattr(root, 0, "sortv", 0);
	vattr = agattr(root, 1, "sortv", 0);
	if (cattr || vattr)
	    pinfo.vals = (unsigned char*)zmalloc((total)*sizeof(unsigned char));
	else
	    agerr (AGWARN, "Graph %s has array packing with user values but no \"sortv\" attributes are defined.",
		agnameof(g));
    }

    gs = (boxf*)zmalloc((total)*sizeof(boxf));
    children = (void**)zmalloc((total)*sizeof(void*));
    j = 0;
    for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
	subg = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i];
	gs[j] = (((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb);
	if (pinfo.vals && cattr) {
    ...
    if (nv-nvs > 0) {
	for (n = agfstnode (g); n; n = agnxtnode (g,n)) {
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)) continue;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = g;
	    bb.LL.y = bb.LL.x = 0;
	    bb.UR.x = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw)+(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw));
	    bb.UR.y = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht));
	    gs[j] = bb;
	    if (pinfo.vals && vattr) {
    ...
    rootbb.LL = pointfof(((int)(~(unsigned)0 >> 1)), ((int)(~(unsigned)0 >> 1)));
    rootbb.UR = pointfof(-((int)(~(unsigned)0 >> 1)), -((int)(~(unsigned)0 >> 1)));

    /* reposition children relative to GD_bb(g) */
    for (j = 0; j < total; j++) {
	((p).x = (pts[j]).x,(p).y = (pts[j]).y);
	bb = gs[j];
	bb.LL.x += p.x;
	bb.UR.x += p.x;
	bb.LL.y += p.y;
	bb.UR.y += p.y;
	((rootbb).LL.x = (((rootbb).LL.x)<((bb).LL.x)?((rootbb).LL.x):((bb).LL.x)), (rootbb).LL.y = (((rootbb).LL.y)<((bb).LL.y)?((rootbb).LL.y):((bb).LL.y)), (rootbb).UR.x = (((rootbb).UR.x)>((bb).UR.x)?((rootbb).UR.x):((bb).UR.x)), (rootbb).UR.y = (((rootbb).UR.y)>((bb).UR.y)?((rootbb).UR.y):((bb).UR.y)));
	if (j < (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster)) {
	    ...
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord) = mid_pointf (bb.LL, bb.UR);
	    if (Verbose > 1) {
		indent (depth);
		fprintf (stderr, "%s : %f %f\n", agnameof(n), (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y);
	    }
	}
    }
    ...
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)) {
        ...
        p = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->dimen;
	if (total == 0) {
            rootbb.LL.x = 0;
            rootbb.LL.y = 0;
            rootbb.UR.x = p.x;
    ...
    rootbb.LL.x -= margin;
    rootbb.UR.x += margin;
    rootbb.LL.y -= (margin + (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->border)[0].y);
    rootbb.UR.y += (margin + (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->border)[2].y);
	...
	if (j < (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster)) {
	    subg = (Agraph_t*)children[j];
	    bb = (((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb);
	    ...
	    n = (Agnode_t*)children[j];
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord) = sub_pointf ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord), rootbb.LL);
	    if (Verbose > 1) {
		indent (depth);
		fprintf (stderr, "%s : %f %f\n", agnameof(n), (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y);
	    }
    ...
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb) = rootbb;
...
{
    boxf sbb, bb = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb);
    Agnode_t* n;
    Agraph_t* subg;
    int i;
    ...
    if (depth) {
        for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
            if (((Agraph_t*)(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)) != g)
                continue;
            (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x += bb.LL.x;
            (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y += bb.LL.y;
	    if (Verbose > 1) {
		indent (depth);
		fprintf (stderr, "%s : %f %f\n", agnameof(n), (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y);
	    }
    ...
    for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
        subg = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i];
        if (depth) {
            sbb = (((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb);
            sbb.LL.x += bb.LL.x;
            sbb.LL.y += bb.LL.y;
            sbb.UR.x += bb.LL.x;
            sbb.UR.y += bb.LL.y;
		...
		fprintf (stderr, "%s : %f %f %f %f\n", agnameof(subg), sbb.LL.x, sbb.LL.y, sbb.UR.x, sbb.UR.y);
            ...
            (((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb) = sbb;
        }
...
void osage_layout(Agraph_t *g)
{
	...
	Agnode_t* n;
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x)/(double)72);
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)/(double)72);
	}
	spline_edges0(g, (!(0)));
    }
    else {
	int et = ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->flags) & (7 << 1));
	if (et != (0 << 1)) spline_edges1(g, et);
    }
...
static void cleanup_graphs (Agraph_t *g)
{
    ...
    for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
        subg = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i];
	free_label((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->label));
        cleanup_graphs (subg);
    }
    free ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust));
}
