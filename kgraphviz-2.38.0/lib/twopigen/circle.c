#line 1 "graphviz-2.38.0\\lib\\twopigen\\circle.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\twopigen\\circle.c" 2
#line 1 "graphviz-2.38.0\\lib\\twopigen\\circle.c" 1
#line 1 "graphviz-2.38.0\\lib\\twopigen\\circle.c" 1
...
static void setNStepsToLeaf(Agraph_t * g, Agnode_t * n, Agnode_t * prev)
{
    ...
    int nsteps = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf) + 1;

    for (ep = agfstedge(g, n); ep; ep = agnxtedge(g, ep, n)) {
	if ((next = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node)) == n)
	    next = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);

	if (prev == next)
	    continue;

	if (nsteps < (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->nStepsToLeaf)) {	/* handles loops and multiedges */
	    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->nStepsToLeaf) = nsteps;
...
static int isLeaf(Agraph_t * g, Agnode_t * n)
{
    ...
    for (ep = agfstedge(g, n); ep; ep = agnxtedge(g, ep, n)) {
	if ((np = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node)) == n)
...
static void initLayout(Agraph_t * g)
{
	...
	/* STSIZE(n) = 0; */
	/* NCHILD(n) = 0; */
	(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter) = INF;
	(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->theta) = 10.00;	/* marks theta as unset, since 0 <= theta <= 2PI */
	if (isLeaf(g, n))
	    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf) = 0;
	else
	    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf) = INF;
    }
}
...
static Agnode_t *findCenterNode(Agraph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf) == 0)
	    setNStepsToLeaf(g, n, 0);
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf) > maxNStepsToLeaf) {
	    maxNStepsToLeaf = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToLeaf);
	    center = n;
	}
    }
    return center;
...
{
    item_t* ip = (item_t*)zmalloc(sizeof(item_t));
    ip->p = p;
...
static void setNStepsToCenter(Agraph_t * g, Agnode_t * n)
{
    Agnode_t *next;
    Agedge_t *ep;
    Agsym_t* wt = (agattr(g,2,"weight",NULL));
    queue qd;
    queue* q = &qd;
	...
	int nsteps = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter) + 1;
	for (ep = agfstedge(g, n); ep; ep = agnxtedge(g, ep, n)) {
	    if (wt && (*(agxget(ep,wt))==*("0")&&!strcmp(agxget(ep,wt),"0"))) continue;
	    if ((next = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node)) == n)
		next = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);
	    if (nsteps < (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->nStepsToCenter)) {
		(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->nStepsToCenter) = nsteps;
		(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->parent) = n;
		(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nChildren)++;
		push (q, next);
	    }
	}
    }
...
static int setParentNodes(Agraph_t * sg, Agnode_t * center)
{
    Agnode_t *n;
    int maxn = 0;
    int unset = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(center))->data))->alg)))->nStepsToCenter);

    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(center))->data))->alg)))->nStepsToCenter) = 0;
    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(center))->data))->alg)))->parent) = 0;
    setNStepsToCenter(sg, center);

    /* find the maximum number of steps from the center */
    for (n = agfstnode(sg); n; n = agnxtnode(sg, n)) {
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter) == unset) {
	    return -1;
	}
	else if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter) > maxn) {
	    maxn = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter);
	}
    }
    return maxn;
}
...
static void setSubtreeSize(Agraph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nChildren) > 0)
	    continue;
	(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->subtreeSize)++;
	parent = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->parent);
	while (parent) {
	    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->subtreeSize)++;
	    parent = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->parent);
	}
    }
}
...
static void setChildSubtreeSpans(Agraph_t * g, Agnode_t * n)
{
    ...
    ratio = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->span) / (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->subtreeSize);
    for (ep = agfstedge(g, n); ep; ep = agnxtedge(g, ep, n)) {
	if ((next = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node)) == n)
	    next = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->parent) != n)
	    continue;		/* handles loops */

	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->span) != 0.0)
	    continue;		/* multiedges */
	((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->span) = ratio * (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->subtreeSize));

	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->nChildren) > 0) {
...
{
    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(center))->data))->alg)))->span) = 2 * 3.14159265358979323846;
...
static void setChildPositions(Agraph_t * sg, Agnode_t * n)
{
    ...
    if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->parent) == 0)	/* center */
	theta = 0;
    else
	theta = (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->theta) - (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->span) / 2;
	...
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->parent) != n)
	    continue;		/* handles loops */
	if ((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->theta) != 10.00)
	    continue;		/* handles multiedges */

	(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->theta) = theta + (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->span) / 2.0;
	theta += (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(next))->data))->alg)))->span);
...
{
    (((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(center))->data))->alg)))->theta) = 0;
...
getRankseps (Agraph_t* g, int maxrank)
{
    ...
    char c;
    int i, rk = 1;
    double* ranks = (double*)zmalloc((maxrank+1)*sizeof(double));
    double xf = 0, delx, d;

    if ((p = late_string(g, (agattr(g->root,0,"ranksep",NULL)), NULL))) {
...
static void setAbsolutePos(Agraph_t * g, int maxrank)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	hyp = ranksep[(((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->nStepsToCenter)];
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = hyp * cos((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->theta));
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = hyp * sin((((rdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->theta));
    }
    free (ranksep);
}
