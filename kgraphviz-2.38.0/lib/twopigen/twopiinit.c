#line 1 "graphviz-2.38.0\\lib\\twopigen\\twopiinit.c" 1
/* $Id$ $Revision$ */
...
#line 1 "graphviz-2.38.0\\lib\\twopigen\\circle.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\twopigen\\circle.h" 2
...
#line 22 "graphviz-2.38.0\\lib\\twopigen\\twopiinit.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\twopigen\\twopiinit.c" 2
...
#line 24 "graphviz-2.38.0\\lib\\twopigen\\twopiinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\neatoprocs.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 25 "graphviz-2.38.0\\lib\\twopigen\\twopiinit.c" 2
...
static void twopi_init_node_edge(graph_t * g)
{
    ...
    alg = (rdata*)zmalloc((n_nodes)*sizeof(rdata));
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->neato_nlist) = (node_t **)zmalloc((n_nodes + 1)*sizeof(node_t *));
...
void twopi_layout(Agraph_t * g)
{
	...
	if (ncc == 1) {
	    ...
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = (void *)0;
	    adjustNodes(g);
	    spline_edges(g);
	} else {
	    pack_info pinfo;
