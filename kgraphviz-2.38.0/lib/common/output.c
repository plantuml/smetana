#line 1 "graphviz-2.38.0\\lib\\common\\output.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\common\\output.c" 2
#line 1 "graphviz-2.38.0\\lib\\cgraph\\agxbuf.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\common\\output.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\output.c" 1
#line 1 "graphviz-2.38.0\\lib\\common\\output.c" 1
...
{
    printdouble(f, " ", ((p.x)/(double)72));
    printdouble(f, " ", (((Y_invert ? (Y_off - (p.y)) : (p.y)))/(double)72));
}
...
{
    if (Y_invert) {
	Y_off = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y + (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y;
	YF_off = ((Y_off)/(double)72);
    }
}
...
{
    char *name;
    if (((((Agnodeinfo_t*)(((Agobj_t*)(node))->data))->clustnode)))
...
//    setup_graph(job, g);
    setYInvert(g);
    pt = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR;
    printdouble(f, "graph ", job->zoom);
    printdouble(f, " ", ((pt.x)/(double)72));
    printdouble(f, " ", ((pt.y)/(double)72));
    agputc('\n', f);
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clustnode)))
	    continue;
	printstring(f, "node ", agcanonStr(agnameof(n)));
	printpoint(f, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord));
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->label)->html)   /* if html, get original text */
	    lbl = agcanonStr (agxget(n, N_label));
	else
	    lbl = canon(agraphof(n),(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->label)->text);
        printdouble(f, " ", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width));
        printdouble(f, " ", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height));
        printstring(f, " ", lbl);
	printstring(f, " ", late_nnstring(n, N_style, "solid"));
	printstring(f, " ", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape)->name);
	printstring(f, " ", late_nnstring(n, N_color, "black"));
	fillcolor = late_nnstring(n, N_fillcolor, "");
        if (fillcolor[0] == '\0')
	    fillcolor = late_nnstring(n, N_color, "lightgrey");
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
		...
		writenodeandport(f, ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node), tport);
		writenodeandport(f, ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), hport);
		...
		printstring(f, " ", canon(agraphof(((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node)),(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->text));
		printpoint(f, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->pos);
	    }
	    printstring(f, " ", late_nnstring(e, E_style, "solid"));
	    printstring(f, " ", late_nnstring(e, E_color, "black"));
	    agputc('\n', f);
	}
    }
    agputs("stop\n", f);
...
static void set_record_rects(node_t * n, field_t * f, agxbuf * xb)
{
	...
	sprintf(buf, "%.5g,%.5g,%.5g,%.5g ",
		f->b.LL.x + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x,
		(Y_invert ? (Y_off - (f->b.LL.y + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)) : (f->b.LL.y + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)),
		f->b.UR.x + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x,
		(Y_invert ? (Y_off - (f->b.UR.y + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)) : (f->b.UR.y + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)));
	agxbput(xb, buf);
    }
...
static void rec_attach_bb(graph_t * g, Agsym_t* bbsym, Agsym_t* lpsym, Agsym_t* lwsym, Agsym_t* lhsym)
{
    ...
    sprintf(buf, "%.5g,%.5g,%.5g,%.5g", (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x, (Y_invert ? (Y_off - ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y)) : ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y)),
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.x, (Y_invert ? (Y_off - ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y)) : ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y)));
    agxset(g, bbsym, buf);
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label) && (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->text[0]) {
	pt = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->pos;
	sprintf(buf, "%.5g,%.5g", pt.x, (Y_invert ? (Y_off - (pt.y)) : (pt.y)));
	agxset(g, lpsym, buf);
	pt = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->dimen;
	sprintf(buf, "%.2f", ((pt.x)/(double)72));
	agxset (g, lwsym, buf);
	sprintf(buf, "%.2f", ((pt.y)/(double)72));
	agxset (g, lhsym, buf);
    }
    for (c = 1; c <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); c++)
	rec_attach_bb((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[c], bbsym, lpsym, lwsym, lhsym);
}
...
void attach_attrs_and_arrows(graph_t* g, int* sp, int* ep)
{
    ...
    edge_t *e;
    pointf ptf;
    int dim3 = ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->odim) >= 3);
    Agsym_t* bbsym;
    Agsym_t* lpsym;
    Agsym_t* lwsym;
    Agsym_t* lhsym;
    ...
    safe_dcl(g, 1, "pos", "");
    safe_dcl(g, 1, "rects", "");
    N_width = safe_dcl(g, 1, "width", "");
    N_height = safe_dcl(g, 1, "height", "");
    safe_dcl(g, 2, "pos", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 4))
	safe_dcl(g, 1, "xlp", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 0))
	safe_dcl(g, 2, "lp", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 5))
	safe_dcl(g, 2, "xlp", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 1))
	safe_dcl(g, 2, "head_lp", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 2))
	safe_dcl(g, 2, "tail_lp", "");
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->has_labels) & (1 << 3)) {
	lpsym = safe_dcl(g, 0, "lp", "");
	lwsym = safe_dcl(g, 0, "lwidth", "");
	lhsym = safe_dcl(g, 0, "lheight", "");
    }
    bbsym = safe_dcl(g, 0, "bb", "");
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if (dim3) {
	    int k;

	    sprintf(buf, "%.5g,%.5g,%.5g", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x, (Y_invert ? (Y_off - ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)) : ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)), 72*((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[2]));
	    agxbput (&xb, buf);
	    for (k = 3; k < (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->odim); k++) {
		sprintf(buf, ",%.5g", 72*((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[k]));
		agxbput (&xb, buf);
	    }
	    agset(n, "pos", (((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)'\0'))),(char*)((&xb)->ptr = (&xb)->buf)));
	} else {
	    sprintf(buf, "%.5g,%.5g", (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).x, (Y_invert ? (Y_off - ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)) : ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord).y)));
	    agset(n, "pos", buf);
	}
	sprintf(buf, "%.5g", (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht))/(double)72));
	agxset(n, N_height, buf);
	sprintf(buf, "%.5g", (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw) + (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw))/(double)72));
	agxset(n, N_width, buf);
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel) && (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)->set) {
	    ptf = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)->pos;
	    sprintf(buf, "%.5g,%.5g", ptf.x, (Y_invert ? (Y_off - (ptf.y)) : (ptf.y)));
	    agset(n, "xlp", buf);
	}
	if (strcmp((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape)->name, "record") == 0) {
	    set_record_rects(n, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape_info), &xb);
	    agxbpop(&xb);	/* get rid of last space */
	    agset(n, "rects", (((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)'\0'))),(char*)((&xb)->ptr = (&xb)->buf)));
	} else {
	    polygon_t *poly;
	    int i;
		...
		for (i = 0; i < sides; i++) {
		    ...
		    if (poly->sides >= 3)
			sprintf(buf, "%.5g %.5g",
				((poly->vertices[i].x)/(double)72),
				(Y_invert ? (YF_off - (((poly->vertices[i].y)/(double)72))) : (((poly->vertices[i].y)/(double)72))));
		    else
			sprintf(buf, "%.5g %.5g",
				(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width) / 2.0 * cos(i / (double) sides * 3.14159265358979323846 * 2.0),
				(Y_invert ? (YF_off - ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) / 2.0 * sin(i /(double) sides * 3.14159265358979323846 * 2.0))) : ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) / 2.0 * sin(i /(double) sides * 3.14159265358979323846 * 2.0))));
		    agxbput(&xb, buf);
		}
		agxset(n, N_vertices, (((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)'\0'))),(char*)((&xb)->ptr = (&xb)->buf)));
	    }
	}
	if (State >= 1) {
	    for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
		...
		for (i = 0; i < (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->size; i++) {
		    if (i > 0)
			((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)';')));
		    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].sflag) {
			s_arrows = 1;
			sprintf(buf, "s,%.5g,%.5g ",
				(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].sp.x,
				(Y_invert ? (Y_off - ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].sp.y)) : ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].sp.y)));
			agxbput(&xb, buf);
		    }
		    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].eflag) {
			e_arrows = 1;
			sprintf(buf, "e,%.5g,%.5g ",
				(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].ep.x,
				(Y_invert ? (Y_off - ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].ep.y)) : ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].ep.y)));
			agxbput(&xb, buf);
		    }
		...
		agset(e, "pos", (((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)'\0'))),(char*)((&xb)->ptr = (&xb)->buf)));
		if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)) {
		    ptf = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->pos;
		    sprintf(buf, "%.5g,%.5g", ptf.x, (Y_invert ? (Y_off - (ptf.y)) : (ptf.y)));
		    agset(e, "lp", buf);
		}
		if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel)->set) {
		    ptf = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel)->pos;
		    sprintf(buf, "%.5g,%.5g", ptf.x, (Y_invert ? (Y_off - (ptf.y)) : (ptf.y)));
		    agset(e, "xlp", buf);
		}
		if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label)) {
		    ptf = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label)->pos;
		    sprintf(buf, "%.5g,%.5g", ptf.x, (Y_invert ? (Y_off - (ptf.y)) : (ptf.y)));
		    agset(e, "head_lp", buf);
		}
		if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label)) {
		    ptf = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label)->pos;
		    sprintf(buf, "%.5g,%.5g", ptf.x, (Y_invert ? (Y_off - (ptf.y)) : (ptf.y)));
		    agset(e, "tail_lp", buf);
		}
	    }
