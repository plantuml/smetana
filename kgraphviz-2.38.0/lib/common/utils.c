...
double get_inputscale (graph_t* g)
{
    ...
    d = late_double(g, (agattr(g,0,"inputscale",(void *)0)), -1, 0);
    if (d == 0) return 72; 
    else return d;
}
...
node_t *UF_union(node_t * u, node_t * v)
{
    if (u == v)
	return u;
    if ((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_parent) == (void *)0) {
	(((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_parent) = u;
	(((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size) = 1;
    } else
	u = UF_find(u);
    if ((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_parent) == (void *)0) {
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_parent) = v;
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_size) = 1;
    } else
	v = UF_find(v);
    if ((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->id) > (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->id)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_parent) = v;
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_size) += (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size);
    } else {
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_parent) = u;
	(((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size) += (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_size);
	v = u;
    }
    return v;
}
...
{
    assert((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size) == 1);
    (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_parent) = u;
    (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->UF_size) -= (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size);
}
...
{
    (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_size) = 1;
    (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->UF_parent) = (void *)0;
    (((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->ranktype) = 0;
}
...
pointf coord(node_t * n)
{
    ...
    r.x = 72 * (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0];
    r.y = 72 * (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1];
    return r;
}
...
static char** mkDirlist (const char* list, int* maxdirlen)
{
	...
	dirs = (dirs? (char**)grealloc(dirs,(cnt+2)*sizeof(char*)):(char**)gmalloc((cnt+2)*sizeof(char*)));
	dirs[cnt++] = dir;
	maxlen = ((maxlen)>(strlen(dir))?(maxlen):(strlen(dir)));
    }
    dirs[cnt] = (void *)0;
    *maxdirlen = maxlen;
    return dirs;
...
pointf dotneato_closest(splines * spl, pointf pt)
{
    ...
    low = 0.0;
    high = 1.0;
    dlow2 = ((((((c[0]).x -(pt).x)) * (((c[0]).x -(pt).x))) + ((((c[0]).y -(pt).y)) * (((c[0]).y -(pt).y)))));
    dhigh2 = ((((((c[3]).x -(pt).x)) * (((c[3]).x -(pt).x))) + ((((c[3]).y -(pt).y)) * (((c[3]).y -(pt).y)))));
    do {
	t = (low + high) / 2.0;
...
/* this caching seems to prevent p.x from getting set from bz.list[0].x
	...
	for (i = 0; i < spl->size; i++) {
	    bz = spl->list[i];
	    if ((((bz.list[bz.size - 1].y) <= (y)) && ((y) <= (bz.list[0].y))))
		break;
	}
...
polyBB (polygon_t* poly)
{
    ...
    int peris = ((poly->peripheries)>(1)?(poly->peripheries):(1));
    pointf* verts = poly->vertices + (peris-1)*sides;
    boxf bb;

    bb.LL = bb.UR = verts[0];
    for (i = 1; i < sides; i++) {
	bb.LL.x = ((bb.LL.x)<(verts[i].x)?(bb.LL.x):(verts[i].x));
	bb.LL.y = ((bb.LL.y)<(verts[i].y)?(bb.LL.y):(verts[i].y));
	bb.UR.x = ((bb.UR.x)>(verts[i].x)?(bb.UR.x):(verts[i].x));
	bb.UR.y = ((bb.UR.y)>(verts[i].y)?(bb.UR.y):(verts[i].y));
    }
    return bb;
}
...
{
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb) = addLabelBB((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb), lp, ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
}
...
void compute_bb(graph_t * g)
{
    ...
    if ((agnnodes(g) == 0) && ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster) ==0)) {
	bb.LL = pointfof(0, 0);
	bb.UR = pointfof(0, 0);
	return;
    }

    bb.LL = pointfof(((int)(~(unsigned)0 >> 1)), ((int)(~(unsigned)0 >> 1)));
    bb.UR = pointfof(-((int)(~(unsigned)0 >> 1)), -((int)(~(unsigned)0 >> 1)));
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	ptf = coord(n);
	s2.x = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw)+(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw)) / 2.0;
	s2.y = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht)) / 2.0;
	...
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel) && (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)->set) {
	    bb = addLabelBB(bb, (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
	}
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl) == 0)
		continue;
	    for (i = 0; i < (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->size; i++) {
		for (j = 0; j < (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].size; j++) {
		    ptf = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].list[j];
		    ((bb).LL.x = (((bb).LL.x)<((ptf).x)?((bb).LL.x):((ptf).x)), (bb).LL.y = (((bb).LL.y)<((ptf).y)?((bb).LL.y):((ptf).y)), (bb).UR.x = (((bb).UR.x)>((ptf).x)?((bb).UR.x):((ptf).x)), (bb).UR.y = (((bb).UR.y)>((ptf).y)?((bb).UR.y):((ptf).y)));
		}
	    }
	    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->set) {
		bb = addLabelBB(bb, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
	    }
	    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label)->set) {
		bb = addLabelBB(bb, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
	    }
	    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label)->set) {
		bb = addLabelBB(bb, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
	    }
	    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel)->set) {
		bb = addLabelBB(bb, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
	    }
	}
    }

    for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
	((((BF).LL).x = (((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i]))->data))->bb)).LL).x,((BF).LL).y = (((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i]))->data))->bb)).LL).y),(((BF).UR).x = (((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i]))->data))->bb)).UR).x,((BF).UR).y = (((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i]))->data))->bb)).UR).y));
	((bb).LL.x = (((bb).LL.x)<((BF).LL.x)?((bb).LL.x):((BF).LL.x)), (bb).LL.y = (((bb).LL.y)<((BF).LL.y)?((bb).LL.y):((BF).LL.y)), (bb).UR.x = (((bb).UR.x)>((BF).UR.x)?((bb).UR.x):((BF).UR.x)), (bb).UR.y = (((bb).UR.y)>((BF).UR.y)?((bb).UR.y):((BF).UR.y)));
    }
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label) && (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->set) {
	bb = addLabelBB(bb, (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label), ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->rankdir & 0x3) & 1));
    }
			 ...
			 graph_t * clg)
{
    ...
    ((((Agnodeinfo_t*)(((Agobj_t*)(cn))->data))->clustnode) = (!(0)));
	agsubnode(cg,cn,1);
	//aginsert(cg, cn);
	agsubnode(clg,n,1);
	//aginsert(clg, n);
...
static void insertEdge(Dt_t * map, void *t, void *h, edge_t * e)
{
    ...
    dummy.p[0] = t;
    dummy.p[1] = h;
    dummy.t = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
    dummy.h = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
    (*(((Dt_t*)(map))->searchf))((map),(void*)(&dummy),0000001);

    dummy.p[0] = h;
    dummy.p[1] = t;
    dummy.t = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
    dummy.h = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
    (*(((Dt_t*)(map))->searchf))((map),(void*)(&dummy),0000001);
}
...
static item *mapEdge(Dt_t * map, edge_t * e)
{
    ...
    key[0] = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
    key[1] = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
...
checkCompound(edge_t * e, graph_t * clg, agxbuf * xb, Dt_t * map, Dt_t* cmap)
{
    ...
    if (((((Agnodeinfo_t*)(((Agobj_t*)(h))->data))->clustnode))) return;
...
int processClusterEdges(graph_t * g)
{
    ...
    agclose(clg);
    if (rv)
	((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->flags) |= 1);
    dtclose(cmap);
    return rv;
}
...
static node_t *mapN(node_t * n, graph_t * clg)
{
    ...
    for (sym = agnxtattr(g, 1, (void *)0); sym;  (sym = agnxtattr(g, 1, sym))) {
...
static void undoCompound(edge_t * e, graph_t * clg)
{
    ...
    if (!(((((Agnodeinfo_t*)(((Agobj_t*)(t))->data))->clustnode)) || ((((Agnodeinfo_t*)(((Agobj_t*)(h))->data))->clustnode))))
	return;
    ntail = mapN(t, clg);
    nhead = mapN(h, clg);
...
boolean overlap_node(node_t *n, boxf b)
{
    ...
    if (! (((b).UR.x >= ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->bb)).LL.x) && (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->bb)).UR.x >= (b).LL.x) && ((b).UR.y >= ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->bb)).LL.y) && (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->bb)).UR.y >= (b).LL.y)))
        return 0;

/*  FIXME - need to do something better about CLOSEENOUGH */
    p = sub_pointf((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord), mid_pointf(b.UR, b.LL));

    ictxt.s.n = n;
    ictxt.s.bp = (void *)0;

    return (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape)->fns->insidefn(&ictxt, p);
}
...
{
    if ((((b).UR.x >= (arrow_bb(p, u, scale, flag)).LL.x) && ((arrow_bb(p, u, scale, flag)).UR.x >= (b).LL.x) && ((b).UR.y >= (arrow_bb(p, u, scale, flag)).LL.y) && ((arrow_bb(p, u, scale, flag)).UR.y >= (b).LL.y))) {
...
void gv_free_splines(edge_t * e)
{
    ...
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)) {
        for (i = 0; i < (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->size; i++)
            free((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[i].list);
        free((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list);
        free((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl));
    }
    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl) = (void *)0;
}

void gv_cleanup_edge(edge_t * e)
{
    free ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->path).ps);
    gv_free_splines(e);
    free_label((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label));
    free_label((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel));
    free_label((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label));
    free_label((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label));
...
{
    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)) free((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos));
    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape))
        (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape)->fns->freefn(n);
    free_label((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->label));
    free_label((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel));
	/*FIX HERE , shallow cleaning may not be enough here */
...
static void fillMap (Agraph_t* g, Dt_t* map)
{
	...
	cl = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[c];
	s = agnameof(cl);
...
Agnodeinfo_t* ninf(Agnode_t* n) {return (Agnodeinfo_t*)(((Agobj_t*)(n))->data);}
Agraphinfo_t* ginf(Agraph_t* g) {return (Agraphinfo_t*)(((Agobj_t*)(g))->data);}
Agedgeinfo_t* einf(Agedge_t* e) {return (Agedgeinfo_t*)(((Agobj_t*)(e))->data);}
