#line 1 "graphviz-2.38.0\\lib\\common\\pointset.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\common\\pointset.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\common\\pointset.c" 2
...
{
    (*(((Dt_t*)(ps))->searchf))((ps),(void*)(mkPair(pt)),0000001);
}
...
int inPS(PointSet * ps, point pt)
{
    pair p;
    p.id = pt;
    return (((*(((Dt_t*)(ps))->searchf))((ps),(void*)(&p),0000004)) ? 1 : 0);
}
...
{
    int n = dtsize(ps);
    point *pts = (point*)zmalloc((n)*sizeof(point));
    pair *p;
    point *pp = pts;

    for (p = (pair *) dtflatten(ps); p;
	 p = (pair *) (((Dtlink_t*)((Dtlink_t *) p))->right)) {
	*pp++ = p->id;
    }
...
PointMap *newPM(void)
{
    MPairDisc *dp = (MPairDisc*)gmalloc(sizeof(MPairDisc));
...
{
    (*(((Dt_t*)(ps))->searchf))((ps),(void*)(0),0000100);
}
...
int updatePM(PointMap * pm, int x, int y, int v)
{
    ...
    dummy.id.y = y;
    dummy.v = v;
    p = (*(((Dt_t*)(pm))->searchf))((pm),(void*)(&dummy),0000001);
    old = p->v;
    p->v = v;
    return old;
}
