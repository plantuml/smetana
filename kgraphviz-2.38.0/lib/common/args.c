#line 1 "graphviz-2.38.0\\lib\\common\\args.c" 1
/* $Id$ $Revision$ */
...
#line 26 "graphviz-2.38.0\\lib\\common\\args.c" 2
...
#line 27 "graphviz-2.38.0\\lib\\common\\args.c" 2
#line 1 "graphviz-2.38.0\\lib\\gvc\\gvc.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 28 "graphviz-2.38.0\\lib\\common\\args.c" 2
#line 1 "graphviz-2.38.0\\lib\\fdpgen\\fdp.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 29 "graphviz-2.38.0\\lib\\common\\args.c" 2
  ...
  for (i = 1; i < argc; i++) {
	...
	if (isdigit(arg[2]))
	  gvc->common.verbose = atoi(&arg[2]);
        break;
      case 'O' :
          gvc->common.auto_outfile_names = NOT(0);
	  break;
      case 'c' :
          gvc->common.config = NOT(0);
	  break;
      default :
        cnt++;
        if (*p != arg) *p = arg;
