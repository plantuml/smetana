#line 1 "graphviz-2.38.0\\lib\\common\\input.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\common\\input.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\common\\input.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\common\\input.c" 2
...
#line 20 "graphviz-2.38.0\\lib\\common\\input.c" 2
#line 1 "graphviz-2.38.0\\lib\\cgraph\\agxbuf.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 21 "graphviz-2.38.0\\lib\\common\\input.c" 2
...
static void use_library(GVC_t *gvc, const char *name)
{
    static int cnt = 0;
    if (name) {
	Lib = (Lib? (const char **)grealloc(Lib,(cnt + 2)*sizeof(const char *)):(const char **)gmalloc((cnt + 2)*sizeof(const char *)));
	Lib[cnt++] = name;
	Lib[cnt] = NULL;
    }
    gvc->common.lib = Lib;
         ...
         attrsym_t * ((*dclfun) (Agraph_t *, int kind, char *, char *)) )
{
	...
	agxbput (xb, dcl);
    sym = dclfun(NULL, kind, (((((xb)->ptr >= (xb)->eptr) ? agxbmore(xb,1) : 0), (int)(*(xb)->ptr++ = ((unsigned char)'\0'))),(char*)((xb)->ptr = (xb)->buf)), rhs);
    sym->fixed = 1;
}
...
static int findCharset (graph_t * g)
{
    ...
    p = late_nnstring(g,(agattr(g,0,"charset",NULL)),"utf-8");
...
{
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing) && (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->xdots)
	freeXDot ((xdot*)(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->xdots);
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing) && (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->id)
	free ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->id);
    free((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing));
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing) = NULL;
    free_label((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label));
...
void do_graph_label(graph_t * sg)
{
	...
	(((Agraphinfo_t*)(((Agobj_t*)(sg->root))->data))->has_labels) |= (1 << 3);

	(((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->label) = make_label((void*)sg, str, (aghtmlstr(str) ? (1 << 1) : (0 << 1)),
	    late_double(sg, (agattr(sg,0,"fontsize",NULL)),
			14.0, 1.0),
	    late_nnstring(sg, (agattr(sg,0,"fontname",NULL)),
			"Times-Roman"),
	    late_nnstring(sg, (agattr(sg,0,"fontcolor",NULL)),
			"black"));
	...
	(((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->label_pos) = pos_flag;
	 ...
	 */
	dimen = (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->label)->dimen;
	{((dimen).x += 4*4); ((dimen).y += 2*4);};
	if (!((((Agraphinfo_t*)(((Agobj_t*)(agroot(sg)))->data))->rankdir & 0x3) & 1)) {
	    if ((((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->label_pos) & 1)
		pos_ix = 2;
	    else
		pos_ix = 0;
	    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->border)[pos_ix] = dimen;
	} else {
		...
		pos_ix = 3;
	    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->border)[pos_ix].x = dimen.y;
	    (((Agraphinfo_t*)(((Agobj_t*)(sg))->data))->border)[pos_ix].y = dimen.x;
	}
    }
}
