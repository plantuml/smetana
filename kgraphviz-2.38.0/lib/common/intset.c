#line 1 "graphviz-2.38.0\\lib\\common\\intset.c" 1
/* $Id$Revision: */
...
#line 19 "graphviz-2.38.0\\lib\\common\\intset.c" 2
...
#line 20 "graphviz-2.38.0\\lib\\common\\intset.c" 2

static void*
mkIntItem(Dt_t* d,intitem* obj,Dtdisc_t* disc)
{ 
    intitem* np = (intitem*)zmalloc(sizeof(intitem));
    np->id = obj->id;
    return (void*)np;
}
...
addIntSet (Dt_t* is, int v)
{
    ...
    obj.id = v;
    (*(((Dt_t*)(is))->searchf))((is),(void*)(&obj),0000001);
}

int 
inIntSet (Dt_t* is, int v)
{
    return ((*(((Dt_t*)(is))->searchf))((is),(void*)(&v),0001000) != 0);
}
