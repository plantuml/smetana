#line 1 "graphviz-2.38.0\\lib\\common\\postproc.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\common\\postproc.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\common\\postproc.c" 2
...
{
    if (Flip) {
	objp->sz.x = ((ND_height(np))*(double)72);
	objp->sz.y = ((ND_width(np))*(double)72);
    }
    else {
	objp->sz.x = ((ND_width(np))*(double)72);
	objp->sz.y = ((ND_height(np))*(double)72);
    }
