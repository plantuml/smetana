...
static int write_hdr(Agraph_t * g, iochan_t * ofile, int top)
{
    ...
    Attrs_not_written_flag = ((((Agobj_t*)(g))->tag).attrwf);
    strict = "";
    if ((!(top)) && agparent(g))
	kind = "sub";
    else {
	...
	if (agisstrict(g))
	    strict = "strict ";
	Tailport = agattr(g, 2, "tailport", ((char *)0));
	Headport = agattr(g, 2, "headport", ((char *)0));
    }
    name = agnameof(g);
    sep = " ";
    if (!name || name[0] == '%')
				    ...
				    unsigned long val)
{
    ...
    if (((((Agobj_t*)(n))->tag).seq) < val)
	return (0);
    for (e = agfstin(g, n); e; e = agnxtin(g, e))
	if (((((Agobj_t*)(e->node))->tag).seq) < val)
	    return (0);
    return (!(0));
}
				  ...
				  Dict_t * defdict)
{
    ...
    ((((Agobj_t*)((Agobj_t *) obj))->tag).attrwf) = (!(0));
    return 0;
}
...
static int write_nodename(Agnode_t * n, iochan_t * ofile)
{
	...
	sprintf(buf, "_%ld_SUSPECT", ((((Agobj_t*)(n))->tag).id));	/* could be deadly wrong */
...
{
    return (((((Agobj_t*)((Agobj_t *) obj))->tag).attrwf));
}
...
static int write_body(Agraph_t * g, iochan_t * ofile)
{
	...
	if (write_node_test(g, n, ((((Agobj_t*)(n))->tag).seq)))
	    {if ((write_node(n, ofile, dd ? dd->dict.n : 0)) == EOF) return EOF;};
	prev = n;
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    if ((prev != ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node))
		&& write_node_test(g, ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), ((((Agobj_t*)(n))->tag).seq))) {
		{if ((write_node(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), ofile, dd ? dd->dict.n : 0)) == EOF) return EOF;};
		prev = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	    }
...
static void set_attrwf(Agraph_t * g, int toplevel, int value)
{
    ...
    ((((Agobj_t*)(g))->tag).attrwf) = value;
    for (subg = agfstsubg(g); subg; subg = agnxtsubg(subg)) {
	set_attrwf(subg, (0), value);
    }
    if (toplevel) {
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    ((((Agobj_t*)(n))->tag).attrwf) = value;
	    for (e = agfstout(g, n); e; e = agnxtout(g, e))
		((((Agobj_t*)(e))->tag).attrwf) = value;
	}
    }
}
