#line 1 "graphviz-2.38.0\\lib\\cgraph\\obj.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\cgraph\\obj.c" 2

int agdelete(Agraph_t * g, void *obj)
{
    if ((((((Agobj_t*)((Agobj_t *) obj))->tag).objtype) == 0) && (g != agparent(obj))) {
	agerr(AGERR, "agdelete on wrong graph");
	return -1;
    }

    switch (((((Agobj_t*)((Agobj_t *) obj))->tag).objtype)) {
    case 1:
...
int agrename(Agobj_t * obj, char *newname)
{
    ...
    case 0:
	old_id = ((((Agobj_t*)(obj))->tag).id);
	g = agraphof(obj);
	/* can we reserve the id corresponding to newname? */
	if (agmapnametoid(agroot(g), ((((Agobj_t*)(obj))->tag).objtype), newname,
			  &new_id, (0)) == 0)
	    return -1;
	if (new_id == old_id)
	    return 0;
...
void agmethod_delete(Agraph_t * g, void *obj)
{
	...
	agrecord_callback(g, obj, 102, ((Agsym_t*)0));
}
...
void agpushdisc(Agraph_t * g, Agcbdisc_t * cbd, void *state)
{
    ...
    stack_ent = ((Agcbstack_t*)(agalloc(g,sizeof(Agcbstack_t))));
    stack_ent->f = cbd;
...
int agcontains(Agraph_t* g, void* obj)
{
	...
	return 0;
    case 1: 
        return (agidnode(g, ((((Agobj_t*)(obj))->tag).id), 0) != 0);
    default:
...
{
	return ((((Agobj_t*)(arg))->tag).objtype);
}
