#line 1 "graphviz-2.38.0\\lib\\cgraph\\utils.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\cgraph\\utils.c" 2
...
{
    Ag_dictop_G = g;
    return (long) (*(((Dt_t*)(dict))->searchf))((dict),(void*)(obj),0000002);
}
...
void agdtdisc(Agraph_t * g, Dict_t * dict, Dtdisc_t * disc)
{
    if (disc && (dtdisc(dict, ((Dtdisc_t *)0), 0) != disc)) {
	dtdisc(dict, disc, 0);
    }
