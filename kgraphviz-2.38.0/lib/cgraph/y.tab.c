#line 1 "graphviz-2.38.0\\lib\\cgraph\\y.tab.c" 1
...
#line 66 "graphviz-2.38.0\\lib\\cgraph\\y.tab.c" 2
...
yybackup:
  ...
  if (yychar <= 0)
    ...
    {
      yytoken = ((unsigned int) (yychar) <= 268 ? yytranslate[yychar] : 2);
      ;
    }
  ...
  yyn += yytoken;
  if (yyn < 0 || 59 < yyn || yycheck[yyn] != yytoken)
    goto yydefault;
  yyn = yytable[yyn];
  if (yyn <= 0)
    {
...
/* Line 1787 of yacc.c  */
    ...
    {appendnode((yyvsp[(1) - (1)].str),((char*)0),((char*)0));}
    break;

  case 31:
/* Line 1787 of yacc.c  */

    {appendnode((yyvsp[(1) - (3)].str),(yyvsp[(3) - (3)].str),((char*)0));}
    break;
...
/* Line 1787 of yacc.c  */
    ...
    {appendattr((yyvsp[(2) - (2)].str),((char*)0));}
    break;
...
/* Line 1787 of yacc.c  */
  ...
  *++yyvsp = yyval;
  ...
  yystate = yypgoto[yyn - 24] + *yyssp;
  if (0 <= yystate && yystate <= 59 && yycheck[yystate] == *yyssp)
    yystate = yytable[yystate];
  else
    yystate = yydefgoto[yyn - 24];
...
yyerrlab:
  ...
  yytoken = yychar == (-2) ? (-2) : ((unsigned int) (yychar) <= 268 ? yytranslate[yychar] : 2);
...
static void bindattrs(int kind)
{
	...
	for (aptr = S->attrlist.first; aptr; aptr = aptr->next) {
		...
		name = aptr->u.name;
		if ((kind == 2) && ((*name == *Key) && !strcmp((name),(Key)))) continue;
...
static void attrstmt(int tkind, char *macroname)
{
	...
	switch(tkind) {
		case 258: kind = 0; break;
		case 259: kind = 1; break;
		case 260: kind = 2; break;
	}
...
static void mkport(Agedge_t *e, char *name, char *val)
{
	Agsym_t *attr;
	if (val) {
		if ((attr = agattr(S->g,2,name,((char*)0))) == ((Agsym_t*)0))
			attr = agattr(S->g,2,name,"");
		agxset(e,attr,val);
	}
}
...
static void newedge(Agnode_t *t, char *tport, Agnode_t *h, char *hport, char *key)
{
	...
	if (e) {		/* can fail if graph is strict and t==h */
		char    *tp = tport;
		char    *hp = hport;
		if ((((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node) != ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)) && (((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node) == t)) {
