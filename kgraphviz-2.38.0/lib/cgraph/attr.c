...
int agxset(void *obj, Agsym_t * sym, char *value)
{
	...
	if ((lsym = aglocaldictsym(dict, sym->name))) {
	    ...
	    lsym = agnewsym(g, sym->name, value, sym->id, ((((Agobj_t*)(hdr))->tag).objtype));
...
int agcopyattr(void *oldobj, void *newobj)
{
    ...
    g = agraphof(oldobj);
    if (((((Agobj_t*)(oldobj))->tag).objtype) != ((((Agobj_t*)(newobj))->tag).objtype))
	return 1;
    sym = 0;
    while ((sym = agnxtattr(g, ((((Agobj_t*)(oldobj))->tag).objtype), sym))) {
