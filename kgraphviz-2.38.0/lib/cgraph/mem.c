#line 1 "graphviz-2.38.0\\lib\\cgraph\\mem.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\cgraph\\mem.c" 2
...
Agmemdisc_t AgMemDisc =
    { memopen, memalloc, memresize, memfree, 0 };
...
void *agrealloc(Agraph_t * g, void *ptr, size_t oldsize, size_t size)
{
	...
	if (ptr == 0)
	    ...
	    mem =
		((g)->clos->disc.mem)->resize(((g)->clos->state.mem), ptr, oldsize, size);
	if (mem == ((void *)0))
...
{
    if (ptr)
	(((g)->clos->disc.mem)->free) (((g)->clos->state.mem), ptr);
}
