#line 1 "graphviz-2.38.0\\lib\\cgraph\\subg.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\cgraph\\subg.c" 2
...
Agraph_t *agidsubg(Agraph_t * g, unsigned long id, int cflag)
{
    Agraph_t *subg;
    subg = agfindsubg_by_id(g, id);
    if ((subg == ((Agraph_t*)0)) && cflag && agallocid(g, 0, id))
	subg = localsubg(g, id);
    return subg;
}
...
Agraph_t *agsubg(Agraph_t * g, char *name, int cflag)
{
    ...
    if (name && agmapnametoid(g, 0, name, &id, (0))) {
	/* might already exist */
	if ((subg = agfindsubg_by_id(g, id)))
	    return subg;
    }

    if (cflag && agmapnametoid(g, 0, name, &id, (!(0)))) {	/* reserve id */
	subg = localsubg(g, id);
	agregister(g, 0, subg);
	return subg;
    }
...
{
    return (Agraph_t *) (*(((Dt_t*)(g->g_dict))->searchf))((g->g_dict),(void*)(0),0000200);
}
...
{
    return (long) (*(((Dt_t*)(g->g_dict))->searchf))((g->g_dict),(void*)(subg),0000002);
}
