#line 1 "graphviz-2.38.0\\lib\\cgraph\\rec.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\cgraph\\rec.c" 2
...
int agdelrec(void *arg_obj, char *name)
{
	...
	case 3:
	case 2:
	    agapply(agroot(g), obj, objdelrec, rec, (0));
	    break;
	}
...
void agclean(Agraph_t * g, int kind, char *rec_name)
{
    ...
    switch (kind) {
    case 0:
	agapply(g, (Agobj_t *) g, simple_delrec, rec_name, (!(0)));
	break;
    case 1:
    case 2:
    case 3:
