#line 1 "graphviz-2.38.0\\lib\\cgraph\\agerror.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\cgraph\\agerror.c" 2
...
static int agerr_va(agerrlevel_t level, const char *fmt, va_list args)
{
    ...
    agerrno = lvl;
    agmaxerr = ((agmaxerr)>(agerrno)?(agmaxerr):(agerrno));
