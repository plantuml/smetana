#line 1 "graphviz-2.38.0\\lib\\vmalloc\\vmdcheap.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\vmalloc\\vmdcheap.c" 2
...

{
    ...
    if (csize == 0)
	return (*(((Vmalloc_t*)(Vmheap))->meth.allocf))((Vmheap),(nsize));
    else if (nsize == 0)
	return (*(((Vmalloc_t*)(Vmheap))->meth.freef))((Vmheap),(Void_t*)(caddr)) >= 0 ? caddr : ((Void_t *)0);
    else
	return (*(((Vmalloc_t*)(Vmheap))->meth.resizef)) ((Vmheap),(Void_t*)(caddr),(nsize),(0));
}

static Vmdisc_t _Vmdcheap = { heapmem, ((Vmexcept_f)0), 0 };
