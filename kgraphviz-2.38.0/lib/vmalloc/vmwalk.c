#line 1 "graphviz-2.38.0\\lib\\vmalloc\\vmwalk.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\vmalloc\\vmwalk.c" 2
...

{
	...
	for (vm = Vmheap; vm; vm = vm->next) {
	    if (!(vm->data->mode & 0000001) && ((0) ? 0 : ((vm->data)->mode & 0020000) ))
		continue;

	    ((0) ? 0 : ((vm->data)->mode |= 0020000) );
