#line 1 "graphviz-2.38.0\\lib\\vmalloc\\vmregion.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\vmalloc\\vmregion.c" 2
...
{
    return addr ? (((((Block_t*)((char*)(addr) - sizeof(Head_t))))->head.head.seg.seg)->vm) : ((Vmalloc_t *)0);
}
