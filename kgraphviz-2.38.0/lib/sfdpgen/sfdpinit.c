#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 1
/* $Id$ $Revision$ */
...
#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sfdp.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\sfdpgen\\sfdp.h" 2
...
#line 18 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\adjust.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 20 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
...
#line 21 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 1
#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 1
...
#line 24 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\overlap.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 25 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\uniform_stress.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 16 "graphviz-2.38.0\\lib\\sfdpgen\\uniform_stress.h" 2
...
#line 26 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
...
#line 27 "graphviz-2.38.0\\lib\\sfdpgen\\sfdpinit.c" 2
...
static void sfdp_init_graph(Agraph_t * g)
{
    ...
    Ndim = (((Agraphinfo_t*)(((Agobj_t*)(agroot(g)))->data))->ndim) = (((((Agraphinfo_t*)(((Agobj_t*)(agroot(g)))->data))->ndim))<(10)?((((Agraphinfo_t*)(((Agobj_t*)(agroot(g)))->data))->ndim)):(10));
    (((Agraphinfo_t*)(((Agobj_t*)(agroot(g)))->data))->odim) = ((outdim)<(Ndim)?(outdim):(Ndim));
    sfdp_init_node_edge(g);
}

/* getPos:
 */
static double *getPos(Agraph_t * g, spring_electrical_control ctrl)
{
    Agnode_t *n;
    double *pos = (double*)zmalloc((Ndim * agnnodes(g))*sizeof(double));
    int ix, i;

    if ((agattr(g,1,"pos",(void *)0)) == (void *)0)
	return pos;

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	i = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id);
	if (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pinned) > 0)) {
	    for (ix = 0; ix < Ndim; ix++) {
		pos[i * Ndim + ix] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[ix];
	    }
	}
    }
		       ...
		       int hops, pointf pad)
{
    ...
    Agnode_t *n;
    int flag, i;
    int n_edge_label_nodes = 0, *edge_label_nodes = (void *)0;
	...
	multilevel_spring_electrical_embedding(Ndim, A, D, ctrl, (void *)0, sizes, pos, n_edge_label_nodes, edge_label_nodes, &flag);
	break;
	...
	stress_model(Ndim, A, D, &pos, (!(0)), maxit, tol, &flag);
	}
	break;
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	double *npos = pos + (Ndim * (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id));
	for (i = 0; i < Ndim; i++) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[i] = npos[i];
	}
    }
...
tuneControl (graph_t* g, spring_electrical_control ctrl)
{
    ...
    init = setSeed (g, 2, &seed);
    if (init != 2) {
        agerr(AGWARN, "sfdp only supports start=random\n");
    }
    ctrl->random_seed = seed;

    ctrl->K = late_double(g, (agattr(g,0,"K",(void *)0)), -1.0, 0.0);
    ctrl->p = -1.0*late_double(g, (agattr(g,0,"repulsiveforce",(void *)0)), --1.0001234, 0.0);
    ctrl->multilevels = late_int(g, (agattr(g,0,"levels",(void *)0)), ((int)(~(unsigned)0 >> 1)), 0);
    ctrl->smoothing = late_smooth(g, (agattr(g,0,"smoothing",(void *)0)), SMOOTHING_NONE);
    ctrl->tscheme = late_quadtree_scheme(g, (agattr(g,0,"quadtree",(void *)0)), QUAD_TREE_NORMAL);
    /* ctrl->method = late_mode(g, agfindgraphattr(g, "mode"), METHOD_SPRING_ELECTRICAL); */
    ctrl->method = METHOD_SPRING_ELECTRICAL;
    ctrl->beautify_leaves = mapBool (agget(g, "beautify"), 0);
    ctrl->do_shrinking = mapBool (agget(g, "overlap_shrink"), (!(0)));
    ctrl->rotation = late_double(g, (agattr(g,0,"rotation",(void *)0)), 0.0, -1.7976931348623157e+308);
    ctrl->edge_labeling_scheme = late_int(g, (agattr(g,0,"label_scheme",(void *)0)), 0, 0);
...
void sfdp_layout(graph_t * g)
{
	...
	if ((am.mode == AM_PRISM) && doAdjust) {
	    ...
	    sep = sepFactor(g);
	    if (sep.doAdd) {
		pad.x = ((sep.x)/(double)72);
		pad.y = ((sep.y)/(double)72);
	    } else {
		pad.x = ((4)/(double)72);
		pad.y = ((4)/(double)72);
	    }
