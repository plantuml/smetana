#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 1
/* $Id$ $Revision$ */
...
#line 18 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\memory.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 20 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\logic.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 21 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
#line 1 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 1
#line 1 "graphviz-2.38.0\\lib\\common\\arith.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 23 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\types.h" 1
/* lib/common/types.h.  Generated from types.h.in by configure.  */
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 24 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\globals.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 25 "graphviz-2.38.0\\lib\\sfdpgen\\sparse_solve.c" 2
...
double *Operator_uniform_stress_matmul_apply(Operator o, double *x, double *y){
  ...
  SparseMatrix_multiply_vector(A, x, &y, (0));
...
Operator Operator_uniform_stress_matmul(SparseMatrix A, double alpha){
  ...
  o = gmalloc(sizeof(struct Operator_struct));
  o->data = d = gmalloc(sizeof(struct uniform_stress_matmul_data));
  d->alpha = alpha;
  d->A = A;
...
double *Operator_matmul_apply(Operator o, double *x, double *y){
...
Operator Operator_matmul_new(SparseMatrix A){
  ...
  o = (struct Operator_struct*)gmalloc(sizeof(struct Operator_struct));
  o->data = (void*) A;
...
double* Operator_diag_precon_apply(Operator o, double *x, double *y){
  int i, m;
...
Operator Operator_uniform_stress_diag_precon_new(SparseMatrix A, double alpha){
  ...
  o = gmalloc(sizeof(struct Operator_struct));
  o->data = gmalloc(sizeof(double)*(m + 1));
  diag = (double*) o->data;
  ...
  for (i = 0; i < m; i++){
    ...
    for (j = ia[i]; j < ia[i+1]; j++){
      if (i == ja[j] && ((a[j]) >= 0 ? (a[j]) : -(a[j])) > 0) diag[i] = 1./((m-1)*alpha+a[j]);
    }
  }
...
Operator Operator_diag_precon_new(SparseMatrix A){
  ...
  o = (struct Operator_struct*)gmalloc((1)*sizeof(struct Operator_struct));
  o->data = (double*)gmalloc(((A->m + 1))*sizeof(double));
  diag = (double*) o->data;
  ...
  for (i = 0; i < m; i++){
    diag[i] = 1.;
    for (j = ia[i]; j < ia[i+1]; j++){
      if (i == ja[j] && ((a[j]) >= 0 ? (a[j]) : -(a[j])) > 0) diag[i] = 1./a[j];
    }
  }
...
static double conjugate_gradient(Operator A, Operator precon, int n, double *x, double *rhs, double tol, int maxit, int *flag){
  ...
  z = (double*)gmalloc((n)*sizeof(double));
  r = (double*)gmalloc((n)*sizeof(double));
  p = (double*)gmalloc((n)*sizeof(double));
  q = (double*)gmalloc((n)*sizeof(double));
...
double cg(Operator Ax, Operator precond, int n, int dim, double *x0, double *rhs, double tol, int maxit, int *flag){
  double *x, *b, res = 0;
  int k, i;
  x = (double*)gmalloc((n)*sizeof(double));
...
double* jacobi(SparseMatrix A, int dim, double *x0, double *rhs, int maxit, int *flag){
  /* maxit iteration of jacobi */
  double *x, *y, *b, sum, diag, *a;
  int k, i, j, n = A->n, *ia, *ja, iter;
  x = gmalloc(sizeof(double)*n);
  y = gmalloc(sizeof(double)*n);
  b = gmalloc(sizeof(double)*n);
  assert(A->type = MATRIX_TYPE_REAL);
