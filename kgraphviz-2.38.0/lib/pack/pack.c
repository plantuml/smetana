#line 1 "graphviz-2.38.0\\lib\\pack\\pack.c" 1
/* $Id$ $Revision$ */
...
#line 24 "graphviz-2.38.0\\lib\\pack\\pack.c" 2
...
#line 25 "graphviz-2.38.0\\lib\\pack\\pack.c" 2
...
#line 26 "graphviz-2.38.0\\lib\\pack\\pack.c" 2
#line 1 "graphviz-2.38.0\\lib\\pack\\pack.c" 1
...
{
    int x1 = ((p.x>=0)?(int)(p.x + .5):(int)(p.x - .5));
    int y1 = ((p.y>=0)?(int)(p.y + .5):(int)(p.y - .5));
    int x2 = ((q.x>=0)?(int)(q.x + .5):(int)(q.x - .5));
    int y2 = ((q.y>=0)?(int)(q.y + .5):(int)(q.y - .5));
	 ...
	 int ssize, int doS)
{
    ...
    if (!doS || !(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)) {
	h = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	hpt = coord(h);
	((hpt).x += dx, (hpt).y += dy);
	((hpt).x = (((hpt).x) >= 0 ? ((hpt).x)/(ssize) : ((((hpt).x)+1)/(ssize))-1), (hpt).y = (((hpt).y) >= 0 ? ((hpt).y)/((ssize)) : ((((hpt).y)+1)/((ssize)))-1));
	fillLine(pt, hpt, ps);
	return;
    }

    for (j = 0; j < (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->size; j++) {
	bz = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j];
	if (bz.sflag) {
	    pt = bz.sp;
	    hpt = bz.list[0];
	    k = 1;
	...
	((pt).x += dx, (pt).y += dy);
	((pt).x = (((pt).x) >= 0 ? ((pt).x)/(ssize) : ((((pt).x)+1)/(ssize))-1), (pt).y = (((pt).y) >= 0 ? ((pt).y)/((ssize)) : ((((pt).y)+1)/((ssize)))-1));
	((hpt).x += dx, (hpt).y += dy);
	((hpt).x = (((hpt).x) >= 0 ? ((hpt).x)/(ssize) : ((((hpt).x)+1)/(ssize))-1), (hpt).y = (((hpt).y) >= 0 ? ((hpt).y)/((ssize)) : ((((hpt).y)+1)/((ssize)))-1));
	fillLine(pt, hpt, ps);
...
genBox(boxf bb0, ginfo * info, int ssize, int margin, point center, char* s)
{
    ...
    ((((bb).LL).x = ((((bb0).LL).x>=0)?(int)(((bb0).LL).x + .5):(int)(((bb0).LL).x - .5)),((bb).LL).y = ((((bb0).LL).y>=0)?(int)(((bb0).LL).y + .5):(int)(((bb0).LL).y - .5))),(((bb).UR).x = ((((bb0).UR).x>=0)?(int)(((bb0).UR).x + .5):(int)(((bb0).UR).x - .5)),((bb).UR).y = ((((bb0).UR).y>=0)?(int)(((bb0).UR).y + .5):(int)(((bb0).UR).y - .5))));
    ps = newPS();
    ...
    ((LL).x = (((LL).x) >= 0 ? ((LL).x)/(ssize) : ((((LL).x)+1)/(ssize))-1), (LL).y = (((LL).y) >= 0 ? ((LL).y)/((ssize)) : ((((LL).y)+1)/((ssize)))-1));
    ((UR).x = (((UR).x) >= 0 ? ((UR).x)/(ssize) : ((((UR).x)+1)/(ssize))-1), (UR).y = (((UR).y) >= 0 ? ((UR).y)/((ssize)) : ((((UR).y)+1)/((ssize)))-1));
    ...
    info->nc = sizeOf(ps);
    W = ((int)ceil((bb0.UR.x - bb0.LL.x + 2 * margin)/(ssize)));
    H = ((int)ceil((bb0.UR.y - bb0.LL.y + 2 * margin)/(ssize)));
    info->perim = W + H;
	...
	int ssize, pack_info * pinfo, point center)
{
    ...
    ps = newPS();
    dx = center.x - (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x>=0)?(int)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x + .5):(int)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x - .5));
    dy = center.y - (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y>=0)?(int)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y + .5):(int)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y - .5));
	...
	/* backup the alg data */
	alg = (void **)gmalloc((agnnodes(g))*sizeof(void *));
	for (i = 0, n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    alg[i++] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg);
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = 0;
	}

	/* do bbox of top clusters */
	for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
	    subg = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i];
	    ((((bb).LL).x = (((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).x>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).x + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).x - .5)),((bb).LL).y = (((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).y>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).y + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).LL).y - .5))),(((bb).UR).x = (((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).x>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).x + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).x - .5)),((bb).UR).y = (((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).y>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).y + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb)).UR).y - .5))));
	    if ((bb.UR.x > bb.LL.x) && (bb.UR.y > bb.LL.y)) {
		((bb.LL).x += dx, (bb.LL).y += dy);
		((bb.UR).x += dx, (bb.UR).y += dy);
		bb.LL.x -= margin;
		bb.LL.y -= margin;
		bb.UR.x += margin;
		bb.UR.y += margin;
		((bb.LL).x = (((bb.LL).x) >= 0 ? ((bb.LL).x)/(ssize) : ((((bb.LL).x)+1)/(ssize))-1), (bb.LL).y = (((bb.LL).y) >= 0 ? ((bb.LL).y)/((ssize)) : ((((bb.LL).y)+1)/((ssize)))-1));
		((bb.UR).x = (((bb.UR).x) >= 0 ? ((bb.UR).x)/(ssize) : ((((bb.UR).x)+1)/(ssize))-1), (bb.UR).y = (((bb.UR).y) >= 0 ? ((bb.UR).y)/((ssize)) : ((((bb.UR).y)+1)/((ssize)))-1));
		...
		for (n = agfstnode(subg); n; n = agnxtnode(subg, n))
		    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust) = subg;
	    }
	}
	...
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    ptf = coord(n);
	    ((pt).x = (((ptf).x>=0)?(int)((ptf).x + .5):(int)((ptf).x - .5)),(pt).y = (((ptf).y>=0)?(int)((ptf).y + .5):(int)((ptf).y - .5)));
	    ((pt).x += dx, (pt).y += dy);
	    if (!(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust)) {	/* n is not in a top-level cluster */
		s2.x = margin + ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw)+(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw)) / 2;
		s2.y = margin + ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht)) / 2;
		LL = sub_point(pt, s2);
		UR = add_point(pt, s2);
		((LL).x = (((LL).x) >= 0 ? ((LL).x)/(ssize) : ((((LL).x)+1)/(ssize))-1), (LL).y = (((LL).y) >= 0 ? ((LL).y)/((ssize)) : ((((LL).y)+1)/((ssize)))-1));
		((UR).x = (((UR).x) >= 0 ? ((UR).x)/(ssize) : ((((UR).x)+1)/(ssize))-1), (UR).y = (((UR).y) >= 0 ? ((UR).y)/((ssize)) : ((((UR).y)+1)/((ssize)))-1));
		...
		((pt).x = (((pt).x) >= 0 ? ((pt).x)/(ssize) : ((((pt).x)+1)/(ssize))-1), (pt).y = (((pt).y) >= 0 ? ((pt).y)/((ssize)) : ((((pt).y)+1)/((ssize)))-1));
		for (e = agfstout(eg, n); e; e = agnxtout(eg, e)) {
		    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust) == (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->clust))
			continue;
		    fillEdge(e, pt, ps, dx, dy, ssize, doSplines);
		}
	    }
	...
	for (i = 0, n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)= alg[i++];
	}
	free(alg);
    ...
    info->cells = pointsOf(ps);
    info->nc = sizeOf(ps);
    W = ((int)ceil(((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.x - (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x + 2 * margin)/(ssize)));
    H = ((int)ceil(((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y - (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y + 2 * margin)/(ssize)));
    info->perim = W + H;
...
fits(int x, int y, ginfo * info, PointSet * ps, point * place, int step, boxf* bbs)
{
    ...
    ((LL).x = (((bbs[info->index].LL).x>=0)?(int)((bbs[info->index].LL).x + .5):(int)((bbs[info->index].LL).x - .5)),(LL).y = (((bbs[info->index].LL).y>=0)?(int)((bbs[info->index].LL).y + .5):(int)((bbs[info->index].LL).y - .5)));
    place->x = step * x - LL.x;
    place->y = step * y - LL.y;
	   ...
	   int margin, boxf* bbs)
{
    ...
    if (i == 0) {
	W = ((int)ceil((bb.UR.x - bb.LL.x + 2 * margin)/(step)));
	H = ((int)ceil((bb.UR.y - bb.LL.y + 2 * margin)/(step)));
...
arrayRects (int ng, boxf* gs, pack_info* pinfo)
{
    ...
    double* heights;
    double v, wd, ht;
    point* places = (point*)zmalloc((ng)*sizeof(point));
    boxf bb;
    int sz, rowMajor;
    ...
    widths = (double*)zmalloc((nc+1)*sizeof(double));
    heights = (double*)zmalloc((nr+1)*sizeof(double));

    ip = info = (ainfo*)zmalloc((ng)*sizeof(ainfo));
    for (i = 0; i < ng; i++, ip++) {
	bb = gs[i];
    ...
    sinfo = (ainfo**)zmalloc((ng)*sizeof(ainfo*));
    for (i = 0; i < ng; i++) {
	sinfo[i] = info + i;
    }
    ...
    for (i = 0; i < ng; i++, ip++) {
	ip = sinfo[i];
	widths[c] = ((widths[c])>(ip->width)?(widths[c]):(ip->width));
	heights[r] = ((heights[r])>(ip->height)?(heights[r]):(ip->height));
	if (rowMajor){ c++; if (c == nc) { c = 0; r++; } } else { r++; if (r == nr) { r = 0; c++; } };
    }
...
polyRects(int ng, boxf* gs, pack_info * pinfo)
{
    ...
    center.x = center.y = 0;
    info = (ginfo*)zmalloc((ng)*sizeof(ginfo));
    for (i = 0; i < ng; i++) {
	info[i].index = i;
    ...
    /* sort */
    sinfo = (ginfo **)zmalloc((ng)*sizeof(ginfo *));
    for (i = 0; i < ng; i++) {
	sinfo[i] = info + i;
    }
    ...
    ps = newPS();
    places = (point*)zmalloc((ng)*sizeof(point));
    for (i = 0; i < ng; i++)
...
polyGraphs(int ng, Agraph_t ** gs, Agraph_t * root, pack_info * pinfo)
{
	...
	compute_bb(g);
	if (fixed && fixed[i]) {
	    ((((bb).LL).x = (((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).x>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).x + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).x - .5)),((bb).LL).y = (((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).y>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).y + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).y - .5))),(((bb).UR).x = (((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).x>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).x + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).x - .5)),((bb).UR).y = (((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).y>=0)?(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).y + .5):(int)((((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).y - .5))));
	    if (fixed_cnt) {
		fixed_bb.LL.x = ((bb.LL.x)<(fixed_bb.LL.x)?(bb.LL.x):(fixed_bb.LL.x));
		fixed_bb.LL.y = ((bb.LL.y)<(fixed_bb.LL.y)?(bb.LL.y):(fixed_bb.LL.y));
		fixed_bb.UR.x = ((bb.UR.x)>(fixed_bb.UR.x)?(bb.UR.x):(fixed_bb.UR.x));
		fixed_bb.UR.y = ((bb.UR.y)>(fixed_bb.UR.y)?(bb.UR.y):(fixed_bb.UR.y));
	    } else
		fixed_bb = bb;
	    fixed_cnt++;
	}
	if (Verbose > 2) {
		...
		(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.x, (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).LL.y,
		(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.x, (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb).UR.y);
	}
    }

    /* calculate grid size */
    bbs = (boxf*)gmalloc((ng)*sizeof(boxf));
    for (i = 0; i < ng; i++)
	bbs[i] = (((Agraphinfo_t*)(((Agobj_t*)(gs[i]))->data))->bb);
	...
	if (pinfo->mode == l_graph)
	    genBox((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb), info + i, stepSize, pinfo->margin, center, agnameof(g));
		 ...
		 pack_info * pinfo)
{
	...
	g = gs[i];
	compute_bb(g);
	bbs[i] = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb);
    }

    if (pinfo->mode == l_array) {
	if (pinfo->flags & (1 << 1)) {
	    pinfo->vals = (packval_t*)zmalloc((ng)*sizeof(packval_t));
	    for (i = 0; i < ng; i++) {
		s = agget (gs[i], "sortv");
...
static void shiftEdge(Agedge_t * e, int dx, int dy)
{
	...
	(((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->pos).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label)->pos).y += dy);
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel))
	(((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel)->pos).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel)->pos).y += dy);
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label))
	(((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label)->pos).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label)->pos).y += dy);
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label))
	(((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label)->pos).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label)->pos).y += dy);
	...
	bz = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j];
	for (k = 0; k < bz.size; k++)
	    ((bz.list[k]).x += dx, (bz.list[k]).y += dy);
	if (bz.sflag)
	    (((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j].sp).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j].sp).y += dy);
	if (bz.eflag)
	    (((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j].ep).x += dx, ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl)->list[j].ep).y += dy);
    }
}
...
static void shiftGraph(Agraph_t * g, int dx, int dy)
{
    ...
    bb = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb);
    bb.LL.x += dx;
    bb.UR.x += dx;
    bb.LL.y += dy;
    bb.UR.y += dy;
	...
	(((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->pos).x += dx, ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->pos).y += dy);
	    ...
	    int doSplines)
{
	...
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] += fx;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] += fy;
	    (((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord)).x += dx, ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->coord)).y += dy);
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)) {
		(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)->pos).x += dx, ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->xlabel)->pos).y += dy);
            }
	    if (doSplines) {
		for (e = agfstout(eg, n); e; e = agnxtout(eg, e))
		    shiftEdge(e, dx, dy);
...
packSubgraphs(int ng, Agraph_t ** gs, Agraph_t * root, pack_info * info)
{
	...
	compute_bb(root);
	bb = (((Agraphinfo_t*)(((Agobj_t*)(root))->data))->bb);
	for (i = 0; i < ng; i++) {
	    g = gs[i];
	    for (j = 1; j <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); j++) {
		((bb).LL.x = (((bb).LL.x)<(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).LL.x)?((bb).LL.x):(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).LL.x)), (bb).LL.y = (((bb).LL.y)<(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).LL.y)?((bb).LL.y):(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).LL.y)), (bb).UR.x = (((bb).UR.x)>(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).UR.x)?((bb).UR.x):(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).UR.x)), (bb).UR.y = (((bb).UR.y)>(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).UR.y)?((bb).UR.y):(((((Agraphinfo_t*)(((Agobj_t*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[j]))->data))->bb)).UR.y)));
	    }
	}
	(((Agraphinfo_t*)(((Agobj_t*)(root))->data))->bb) = bb;
    }
    return ret;
}
...
pack_graph(int ng, Agraph_t** gs, Agraph_t* root, boolean* fixed)
{
    ...
    getPackInfo(root, l_graph, 8, &info);
    info.doSplines = 1;
    info.fixed = fixed;
