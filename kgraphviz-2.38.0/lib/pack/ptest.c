#line 1 "graphviz-2.38.0\\lib\\pack\\ptest.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\pack\\ptest.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\pack\\ptest.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\pack\\ptest.c" 2
...
static point *user_spline(attrsym_t * symptr, edge_t * e, int *np)
{
    ...
    *np = n;
    if (n > 1) {
	ps = (0? (point*)grealloc(0,(n)*sizeof(point)):(point*)gmalloc((n)*sizeof(point)));
	pp = ps;
	while (n) {
...
static void initPos(Agraph_t * g)
{
    ...
    point *sp;
    int pn;
    attrsym_t *N_pos = (agattr(g,1,"pos",(void *)0));
    attrsym_t *E_pos = (agattr(g,2,"pos",(void *)0));
	...
	pvec = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos);
	...
	ND_coord_i(n).x = (((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72 - .5)));
	ND_coord_i(n).y = (((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72 - .5)));
    }
...
static void ptest_nodesize(node_t * n, boolean flip)
{
    ...
    w = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw)+(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw)) = (((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72 - .5)));
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw) = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw) = w / 2;
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht) = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht)) = (((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72 - .5)));
}
...
static void ptest_initNode(node_t * n)
{
	...
	late_double(n, N_height, 0.5, 0.01);
    if (N_label == (void *)0)
	str = "\\N";
    else
	str = agxget(n, N_label->index);
    str = strdup_and_subst(str, "\\N", n->name);
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->label) = make_label(str,
			     late_double(n, N_fontsize, 14.0,
					 1.0), late_nnstring(n,
								      N_fontname,
								      "Times-Roman"),
			     late_nnstring(n, N_fontcolor, "black"),
			     n->graph);
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape) = bind_shape(late_nnstring(n, N_shape, "ellipse"));
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->shape)->initfn(n);	/* ### need to quantize ? */
    ptest_nodesize(n, n->((((Agraphinfo_t*)(((Agobj_t*)(graph))->data))->rankdir & 0x3) & 1));
...
main(int argc, char *argv[])
{
	...
	gs = (Agraph_t **)gmalloc((nFiles)*sizeof(Agraph_t *));
	cnt = 0;
	...
	if (single) {
		...
		for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
		    ...
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0];
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1];
		    ND_coord_i(np).x = ND_coord_i(n).x;
		    ND_coord_i(np).y = ND_coord_i(n).y;
		}
		for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
		    tp = (agnode(root,n->name,0));
		    for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
			hp = (agnode(root,e->head->name,0));
			ep = agedge(root, tp, hp);
			(((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->spl) = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->spl);
		    }
		}
	    }
	    graph_init(root);
