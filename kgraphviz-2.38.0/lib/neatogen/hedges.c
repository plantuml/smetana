...
void ELinitialize()
{
    ...
    if (ELhash == 0)
	ELhash = (Halfedge **)gmalloc((ELhashsize)*sizeof(Halfedge *));
    for (i = 0; i < ELhashsize; i += 1)
	ELhash[i] = (Halfedge *) 0;
    ELleftend = HEcreate((Edge *) 0, 0);
    ELrightend = HEcreate((Edge *) 0, 0);
    ELleftend->ELleft = (Halfedge *) 0;
    ELleftend->ELright = ELrightend;
    ELrightend->ELleft = ELleftend;
    ELrightend->ELright = (Halfedge *) 0;
    ELhash[0] = ELleftend;
...
Halfedge *HEcreate(Edge * e, char pm)
{
    ...
    answer->ELedge = e;
    answer->ELpm = pm;
    answer->PQnext = (Halfedge *) 0;
    answer->vertex = (Site *) 0;
    answer->ELrefcnt = 0;
    return (answer);
}
...
static Halfedge *ELgethash(int b)
{
	...
	return ((Halfedge *) 0);
    he = ELhash[b];
    if (he == (Halfedge *) 0 || he->ELedge != (Edge *) -2)
	return (he);
...
/* Use hash table to get close to desired halfedge */
    ...
    if (he == (Halfedge *) 0) {
	for (i = 1; 1; i += 1) {
	    if ((he = ELgethash(bucket - i)) != (Halfedge *) 0)
		break;
	    if ((he = ELgethash(bucket + i)) != (Halfedge *) 0)
		break;
	};
