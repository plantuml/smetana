...
void neato_init_node(node_t * n)
{
    ...
    common_init_node(n);
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos) = (double*)zmalloc(((((Agraphinfo_t*)(((Agobj_t*)(agraphof(n)))->data))->ndim))*sizeof(double));
    gv_nodesize(n, ((((Agraphinfo_t*)(((Agobj_t*)(agraphof(n)))->data))->rankdir & 0x3) & 1));
}

static void neato_init_edge(edge_t * e)
{
    agbindrec(e, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));	//node custom data
    common_init_edge(e);
    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->factor) = late_double(e, E_weight, 1.0, 1.0);
}
...
int user_pos(attrsym_t * posptr, attrsym_t * pinptr, node_t * np, int nG)
{
    ...
    if (posptr == (void *)0)
	return 0;
    pvec = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos);
    p = agxget(np, posptr);
    if (p[0]) {
	c = '\0';
	if ((Ndim >= 3) && 
		...
		(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned) = 3;
	    return (!(0));
	}
...
static void neato_init_node_edge(graph_t * g)
{
    ...
    N_pos = (agattr(g,1,"pos",(void *)0));
    N_pin = (agattr(g,1,"pin",(void *)0));
...
static int user_spline(attrsym_t * E_pos, edge_t * e)
{
	...
	ps = (0? (pointf*)grealloc(0,(n)*sizeof(pointf)):(pointf*)gmalloc((n)*sizeof(pointf)));
	pp = ps;
	while (n) {
	...
	set_label(e, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->label), "lp");
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel))
	set_label(e, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->xlabel), "xlp");
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label))
	set_label(e, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->head_label), "head_lp");
    if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label))
	set_label(e, (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->tail_label), "tail_lp");
...
static int chkBB(Agraph_t * g, attrsym_t * G_bb, boxf* bbp)
{
    ...
    s = agxget(g, G_bb);
    if (sscanf(s, "%lf,%lf,%lf,%lf", &bb.LL.x, &bb.LL.y, &bb.UR.x, &bb.UR.y) == 4) {
	if (bb.LL.y > bb.UR.y) {
...
dfs(Agraph_t * subg, Agraph_t * parentg, attrsym_t * G_lp, attrsym_t * G_bb)
{
	...
	(((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->bb) = bb;
...
nop_init_graphs(Agraph_t * g, attrsym_t * G_lp, attrsym_t * G_bb)
{
    ...
    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label) && G_lp) {
	s = agxget(g, G_lp);
	if (sscanf(s, "%lf,%lf", &x, &y) == 2) {
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->pos = pointfof(x, y);
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->set = (!(0));
	}
    }
...
int init_nop(Agraph_t * g, int adjust)
{
    ...
    attrsym_t *G_lp = (agattr(g,0,"lp",(void *)0));
    attrsym_t *G_bb = (agattr(g,0,"bb",(void *)0));
	...
	if (!((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned) > 0) && strncmp(agnameof(np), "cluster", 7)) {
	    agerr(AGERR, "node %s in graph %s has no position\n",
		  agnameof(np), agnameof(g));
	    return -1;
	}
	if ((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->xlabel))
	    set_label(np, (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->xlabel), "xlp");
    }
    nop_init_graphs(g, G_lp, G_bb);
    posEdges = nop_init_edges(g);

    if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->xdots) {
	haveBackground = 1;
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)->ratio_kind = R_NONE; /* Turn off any aspect change if background present */
    }
    else
	haveBackground = 0;
    ...
    if (didAdjust) {
	if ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)) (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->label)->set = 0;
/* FIX: 
 ...
 */
    ...
    if (haveBackground)
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb) = xdotBB (g);
...
static void neato_init_graph (Agraph_t * g)
{
    ...
    setEdgeType (g, (1 << 1));
    outdim = late_int(g, (agattr(g,0,"dimen",(void *)0)), 2, 2);
    (((Agraphinfo_t*)(((Agobj_t*)(agroot(g)))->data))->ndim) = late_int(g, (agattr(g,0,"dim",(void *)0)), outdim, 2);
    Ndim = (((Agraphinfo_t*)(((Agobj_t*)(g->root))->data))->ndim) = (((((Agraphinfo_t*)(((Agobj_t*)(g->root))->data))->ndim))<(10)?((((Agraphinfo_t*)(((Agobj_t*)(g->root))->data))->ndim)):(10));
    (((Agraphinfo_t*)(((Agobj_t*)(g->root))->data))->odim) = ((outdim)<(Ndim)?(outdim):(Ndim));
...
static int neatoModel(graph_t * g)
{
	...
	return 0;
    if ((c == 'c') && (*(p)==*("circuit")&&!strcmp(p,"circuit")))
	return 1;
    if (c == 's') {
	if ((*(p)==*("subset")&&!strcmp(p,"subset")))
	    return 2;
	else if ((*(p)==*("shortpath")&&!strcmp(p,"shortpath")))
	    return 0;
    }
    if ((c == 'm') && (*(p)==*("mds")&&!strcmp(p,"mds"))) {
	if (agattr(g, 2, "len", 0))
	    return 3;
	else {
	    agerr(AGWARN,
...
static int neatoMode(graph_t * g)
{
    ...
    str = agget(g, "mode");
    if (str && *str) {
	if ((*(str)==*("KK")&&!strcmp(str,"KK")))
	    mode = 0;
	else if ((*(str)==*("major")&&!strcmp(str,"major")))
	    mode = 1;
...
{
    int i = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(ep))->tag).objtype) == 3?(ep):((ep)+1))->node)))->data))->id);
    int j = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(ep))->tag).objtype) == 2?(ep):((ep)-1))->node)))->data))->id);
    int tmp;
...
static vtx_data *makeGraphData(graph_t * g, int nv, int *nedges, int mode, int model, node_t*** nodedata)
{
    ...
    graph = (vtx_data*)gmalloc((nv)*sizeof(vtx_data));
    nodes = (node_t**)gmalloc((nv)*sizeof(node_t*));
    edges = (int*)gmalloc((2 * ne + nv)*sizeof(int));	/* reserve space for self loops */
    if (haveLen || haveDir)
	ewgts = (float*)gmalloc((2 * ne + nv)*sizeof(float));
    if (haveWt)
	eweights = (float*)gmalloc((2 * ne + nv)*sizeof(float));
	...
	clearPM(ps);
	assert((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->id) == i);
	nodes[i] = np;
	graph[i].edges = edges++;	/* reserve space for the self loop */
	if (haveLen || haveDir)
	    graph[i].ewgts = ewgts++;
	else
	    graph[i].ewgts = (void *)0;
	if (haveWt)
	    graph[i].eweights = eweights++;
	else
	    graph[i].eweights = (void *)0;
	...
	for (ep = agfstedge(g, np); ep; ep = agnxtedge(g, ep, np)) {
		...
		if (haveWt)
		    graph[i].eweights[idx] += (((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->factor);
		if (haveLen) {
		    int curlen = graph[i].ewgts[idx];
		    graph[i].ewgts[idx] = (((((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->dist))>(curlen)?((((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->dist)):(curlen));
		}
	    } else {
		node_t *vp = (((((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node)) == np) ? ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node) : ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node));
		ne++;
		j++;

		*edges++ = (((Agnodeinfo_t*)(((Agobj_t*)(vp))->data))->id);
		if (haveWt)
		    *eweights++ = (((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->factor);
		if (haveLen)
		    *ewgts++ = (((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->dist);
		else if (haveDir)
		    *ewgts++ = 1.0;
    ...
    if (ne != agnedges(g)) {
	edges = ((int*)grealloc(graph[0].edges,(2 * ne + nv)*sizeof(int)));
	if (haveLen)
	    ewgts = ((float*)grealloc(graph[0].ewgts,(2 * ne + nv)*sizeof(float)));
	if (haveWt)
	    eweights = ((float*)grealloc(graph[0].eweights,(2 * ne + nv)*sizeof(float)));
...
static void initRegular(graph_t * G, int nG)
{
    ...
    a = 0.0;
    da = (2 * 3.14159265358979323846) / nG;
    for (np = agfstnode(G); np; np = agnxtnode(G, np)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = nG * 1.0 * cos(a);
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = nG * 1.0 * sin(a);
	(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned) = 1;
	a = a + da;
	if (Ndim > 2)
	    jitter3d(np, nG);
...
setSeed (graph_t * G, int dflt, long* seedp)
{
	...
	if (!strncmp(p, "self", (sizeof("self")-1))) {
	    init = 0;
	    p += (sizeof("self")-1);
	} else if (!strncmp(p, "regular", (sizeof("regular")-1))) {
	    init = 1;
	    p += (sizeof("regular")-1);
	} else if (!strncmp(p, "random", (sizeof("random")-1))) {
	    init = 2;
	    p += (sizeof("random")-1);
	}
	else init = dflt;
	...
	if (!isdigit(*(unsigned char *)p) || sscanf(p, "%ld", &seed) < 1) {
	    ...
	    seed = (unsigned) getpid() ^ (unsigned) time((void *)0);
...
{
    int exp = late_int(G, (agattr(G,0,"stresswt",(void *)0)), 2, 0);
    if ((exp == 0) || (exp > 2)) {
...
majorization(graph_t *mg, graph_t * g, int nv, int mode, int model, int dim, int steps, adjust_data* am)
{
    ...
    int init = checkStart(g, nv, (mode == 2 ? 0 : 2));
    int opts = checkExp (g);
	
    if (init == 0)
	opts |= 0x4;

    coords = (double **)gmalloc((dim)*sizeof(double *));
    coords[0] = (double*)gmalloc((nv * dim)*sizeof(double));
    for (i = 1; i < Ndim; i++) {
	coords[i] = coords[0] + i * nv;
    }
    if (Verbose) {
	fprintf(stderr, "model %d smart_init %d stresswt %d iterations %d tol %f\n",
		model, (init == 0), opts & 0x3, MaxIter, Epsilon);
...
//     fprintf(stderr, "%i\n", count_nodes(g));
	...
	int idx = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->id);
	int i;
	for (i = 0; i < Ndim; i++) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[i] = coords[i][idx];
	}
    }
    freeGraphData(gp);
    free(coords[0]);
...
static void subset_model(Agraph_t * G, int nG)
{
    ...
    gp = makeGraphData(G, nG, &ne, 0, 2, (void *)0);
    Dij = compute_apsp_artifical_weights(gp, nG);
    for (i = 0; i < nG; i++) {
	for (j = 0; j < nG; j++) {
	    (((Agraphinfo_t*)(((Agobj_t*)(G))->data))->dist)[i][j] = Dij[i][j];
	}
    }
    free(Dij[0]);
    free(Dij);
...
static void mds_model(graph_t * g, int nG)
{
	...
	for (e = agfstout(g, v); e; e = agnxtout(g, e)) {
	    i = ((((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->tag).seq);
	    j = ((((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->tag).seq);
	    if (i == j)
		continue;
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->dist)[i][j] = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->dist)[j][i] = (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->dist);
	}
    }
}
...
static void addZ (Agraph_t* g)
{
    ...
    if ((Ndim >= 3) && N_z) { 
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    sprintf(buf, "%lf", 72 * ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[2]));
	    agxset(n, N_z, buf);
	}
    }
}
...
void neato_layout(Agraph_t * g)
{
	...
	if (Pack >= 0) {
		...
		if (pin) {
		    bp = (boolean*)zmalloc((n_cc)*sizeof(boolean));
		    bp[0] = (!(0));
		} else
		    bp = 0;
		pinfo.margin = Pack;
