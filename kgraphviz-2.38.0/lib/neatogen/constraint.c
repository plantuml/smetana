			      ...
			      intersectfn intersect, distfn dist)
{
    ...
    agbindrec(cg, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));  // graph custom data

    for (p = (nitem *) dtflatten(list); p;
	 p = (nitem *) (((Dtlink_t*)((Dtlink_t *) p))->right)) {
	n = agnode(cg, agnameof(p->np), 1);      /* FIX */
	agbindrec(n, "Agnodeinfo_t", sizeof(Agnodeinfo_t), (!(0))); //node custom data
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = p;
	p->cnode = n;
	do {(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list = (edge_t**)zmalloc((0 + 1)*sizeof(edge_t*)); } while (0);
	do {(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->out).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->out).list = (edge_t**)zmalloc((0 + 1)*sizeof(edge_t*)); } while (0);
	if (lastn) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(lastn))->data))->next) = n;
	    lastn = n;
	} else {
	    lastn = (((Agraphinfo_t*)(((Agobj_t*)(cg))->data))->nlist) = n;
	}
    }
    for (p = (nitem *) dtflatten(list); p;
	 p = (nitem *) (((Dtlink_t*)((Dtlink_t *) p))->right)) {
	for (nxp = (nitem *) (((Dtlink_t*)((Dtlink_t *) p))->right); nxp;
		...
		agbindrec(e, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));   // edge custom data
		assert (delta <= 0xFFFF);
		(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->minlen) = delta;
		(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->weight) = 1;
	    }
	    if (e && (agedge(g,p->np,nxp->np,(void *)0,0))) {
			      ...
			      intersectfn intersect, distfn dist)
{
	...
	if (oldval != p->val) {
	    ...
	    do {(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list = (edge_t**)zmalloc((lcnt + 1)*sizeof(edge_t*)); } while (0);
	    if (prev) {
		if (prev == root)
		    do {(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list = (edge_t**)zmalloc((2 *(cnt - 1) + 1)*sizeof(edge_t*)); } while (0);
		else
		    do {(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list = (edge_t**)zmalloc((cnt - lcnt - 1 + 1)*sizeof(edge_t*)); } while (0);
		e = agedge(cg, prev, n, (void *)0, 1);
		agbindrec(e, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));   // edge custom data
		(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->minlen) = 10;
		(((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->weight) = 1;
		do {(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list = ((((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list? (edge_t**)grealloc((((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list,((((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size + 2)*sizeof(edge_t*)):(edge_t**)gmalloc(((((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size + 2)*sizeof(edge_t*))); (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list[(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size++] = e; (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list[(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size] = (void *)0;} while(0);
		do {(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list? (edge_t**)grealloc((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list,((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size + 2)*sizeof(edge_t*)):(edge_t**)gmalloc(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size + 2)*sizeof(edge_t*))); (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list[(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size++] = e; (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).list[(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->in).size] = (void *)0;} while(0);
	    }
	    lcnt++;
	    prev = n;
	}
    ...
    do {(((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).size = 0; (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->out).list = (edge_t**)zmalloc((0 + 1)*sizeof(edge_t*)); } while (0);
     ...
     */
    vg = agopen("vg", Agstrictdirected, ((Agdisc_t *)0));
    for (p = (nitem *) dtflatten(list); p;
	 p = (nitem *) (((Dtlink_t*)((Dtlink_t *) p))->right)) {
	...
	if (oldval != p->val) {	/* new pos: reset nxt */
	    oldval = p->val;
	    for (nxt = (nitem *) (((Dtlink_t*)((Dtlink_t *) p))->right); nxt;
		 nxt = (nitem *) (((Dtlink_t*)((Dtlink_t *) nxt))->right)) {
		if (nxt->val != oldval)
		    break;
	    }
	    if (!nxt)
	...
	for (nxp = nxt; nxp;
	     nxp = (nitem *) (((Dtlink_t*)((Dtlink_t *) nxp))->right)) {
	    if (intersect(p, nxp))
		agedge(vg, p->vnode, nxp->vnode, (void *)0, 1);
	}
    }
                       ...
                       int ortho)
{
    ...
    rank(cg, 2, ((int)(~(unsigned)0 >> 1)));

    p = nlist;
    for (i = 0; i < nnodes; i++) {
	int newpos, oldpos, delta;
	oldpos = p->pos.x;
	newpos = (((Agnodeinfo_t*)(((Agobj_t*)(p->cnode))->data))->rank);
	delta = newpos - oldpos;
	p->pos.x = newpos;
	p->bb.LL.x += delta;
	p->bb.UR.x += delta;
...
static int overlaps(nitem * p, int cnt)
{
	...
	pj = pi + 1;
	for (j = i + 1; j < cnt; j++) {
	    if (((pi->bb.LL.x <= pj->bb.UR.x) && (pj->bb.LL.x <= pi->bb.UR.x) && (pi->bb.LL.y <= pj->bb.UR.y) && (pj->bb.LL.y <= pi->bb.UR.y)))
		return 1;
	    pj++;
	}
	pi++;
...
{
    int x = ((((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72>=0)?(int)((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72 + .5):(int)((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0])*72 - .5)));
    int y = ((((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72>=0)?(int)((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72 + .5):(int)((10 *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1])*72 - .5)));
    int w2, h2;
    box b;

    if (margin.doAdd) {
	w2 = 10 * ((((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width)/2.0)*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width)/2.0)*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width)/2.0)*72 - .5))) + margin.x);
	h2 = 10 * ((((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)/2.0)*72>=0)?(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)/2.0)*72 + .5):(int)(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)/2.0)*72 - .5))) + margin.y);
    }
    else {
	w2 = ((((margin.x *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72>=0)?(int)((margin.x *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72 + .5):(int)((margin.x *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width))*72 - .5)));
	h2 = ((((margin.y *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72>=0)?(int)((margin.y *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72 + .5):(int)((margin.y *(10/2) *(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height))*72 - .5)));
    }
...
int cAdjust(graph_t * g, int mode)
{
	...
	for (i = 0; i < nnodes; i++) {
	    n = p->np;
	    pt = p->pos;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = ((pt.x)/(double)72) / 10;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = ((pt.y)/(double)72) / 10;
	    p++;
	}
	ret = 1;
    }
...
static double compress(info * nl, int nn)
{
	...
	q = p + 1;
	for (j = i + 1; j < nn; j++) {
	    if (((p->bb.LL.x <= q->bb.UR.x) && (q->bb.LL.x <= p->bb.UR.x) && (p->bb.LL.y <= q->bb.UR.y) && (q->bb.LL.y <= p->bb.UR.y)))
		return 0;
	    if (p->pos.x == q->pos.x)
		pt.x = HUGE_VAL;
	    else {
...
static pointf *mkOverlapSet(info * nl, int nn, int *cntp)
{
    ...
    info *q;
    int sz = nn;
    pointf *S = (pointf*)gmalloc((sz + 1)*sizeof(pointf));
    int i, j;
    int cnt = 0;
	...
	for (j = i + 1; j < nn; j++) {
		...
		if (cnt == sz) {
		    sz += nn;
		    S = ((pointf*)grealloc(S,(sz + 1)*sizeof(pointf)));
		}
		if (p->pos.x == q->pos.x)
		    pt.x = HUGE_VAL;
		else {
    ...
    S = ((pointf*)grealloc(S,(cnt + 1)*sizeof(pointf)));
    *cntp = cnt;
    return S;
}
...
static pointf computeScaleXY(pointf * aarr, int m)
{
    ...
    barr = (pointf*)gmalloc((m + 1)*sizeof(pointf));
    barr[m].x = aarr[m].x;
    barr[m].y = 1;
    for (k = m - 1; k >= 0; k--) {
	barr[k].x = aarr[k].x;
	barr[k].y = ((aarr[k + 1].y)>(barr[k + 1].y)?(aarr[k + 1].y):(barr[k + 1].y));
    }
...
int scAdjust(graph_t * g, int equal)
{
    ...
    info *nlist = (info*)gmalloc((nnodes)*sizeof(info));
    info *p = nlist;
    node_t *n;
    pointf s;
    int i;
    ...
    if (margin.doAdd) {
	/* we use inches below */
	margin.x = ((margin.x)/(double)72);
	margin.y = ((margin.y)/(double)72);
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	double w2, h2;
	if (margin.doAdd) {
	    w2 = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width) / 2.0) + margin.x;
	    h2 = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) / 2.0) + margin.y;
	}
	else {
	    w2 = margin.x * (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width) / 2.0;
	    h2 = margin.y * (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) / 2.0;
	}
	p->pos.x = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0];
	p->pos.y = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1];
    ...
    p = nlist;
    for (i = 0; i < nnodes; i++) {
	(((Agnodeinfo_t*)(((Agobj_t*)(p->np))->data))->pos)[0] = s.x * p->pos.x;
	(((Agnodeinfo_t*)(((Agobj_t*)(p->np))->data))->pos)[1] = s.y * p->pos.y;
	p++;
    }
