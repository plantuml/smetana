...
static int makeInfo(Agraph_t * graph)
{
    ...
    nodeInfo = (Info_t*)gmalloc((nsites)*sizeof(Info_t));
	...
	pmargin.x = ((pmargin.x)/(double)72);
	pmargin.y = ((pmargin.y)/(double)72);
    }
	
    else polyf = makePoly;
    for (i = 0; i < nsites; i++) {
	ip->site.coord.x = (((Agnodeinfo_t*)(((Agobj_t*)(node))->data))->pos)[0];
	ip->site.coord.y = (((Agnodeinfo_t*)(((Agobj_t*)(node))->data))->pos)[1];
...
static void sortSites(void)
{
    ...
    if (sites == 0) {
	sites = (Site **)gmalloc((nsites)*sizeof(Site *));
...
static void updateGraph(Agraph_t * graph)
{
    ...
    ip = nodeInfo;
    for (i = 0; i < nsites; i++) {
	(((Agnodeinfo_t*)(((Agobj_t*)(ip->node))->data))->pos)[0] = ip->site.coord.x;
	(((Agnodeinfo_t*)(((Agobj_t*)(ip->node))->data))->pos)[1] = ip->site.coord.y;
	ip++;
    }
}
...
{
    Agnode_t *n;
    double *sizes = (double*)gmalloc((2 * agnnodes(g))*sizeof(double));
    int i, nedge_nodes;
    int* elabs;

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if (elabels && (!strncmp(agnameof(n),"|edgelabel|",(sizeof("|edgelabel|")-1)))) nedge_nodes++;

	i = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id);
	sizes[i * 2] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width) * .5 + pad.x;
	sizes[i * 2 + 1] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) * .5 + pad.y;
    }

    if (elabels && nedge_nodes) {
	elabs = (int*)gmalloc((nedge_nodes)*sizeof(int));
	nedge_nodes = 0;
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    if ((!strncmp(agnameof(n),"|edgelabel|",(sizeof("|edgelabel|")-1))))
		elabs[nedge_nodes++] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id);
	}
	*elabels = elabs;
...
SparseMatrix makeMatrix(Agraph_t* g, int dim, SparseMatrix *D)
{
    ...
    i = 0;
    for (n = agfstnode(g); n; n = agnxtnode(g, n))
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id) = i++;

    I = (int*)gmalloc((nedges)*sizeof(int));
    J = (int*)gmalloc((nedges)*sizeof(int));
    val = (double*)gmalloc((nedges)*sizeof(double));

    sym = (agattr(g,2,"weight",(void *)0));
    if (D) {
	symD = (agattr(g,2,"len",(void *)0));
	valD = (double*)zmalloc((nedges)*sizeof(double));
    }

    i = 0;
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	row = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id);
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    I[i] = row;
	    J[i] = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->id);
...
angleSet (graph_t* g, double* phi)
{
    ...
    *phi = ((ang)/180.0 * 3.14159265358979323846);
    return 1;
}
...
int normalize(graph_t * g)
{
    ...
    v = agfstnode(g);
    p.x = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[0];
    p.y = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[1];
    for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[0] -= p.x;
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[1] -= p.y;
    }
    if (p.x || p.y) ret = 1;
    else ret = 0;
    ...
    phi -= atan2((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->pos)[1] - (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->pos)[1],
		   (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->pos)[0] - (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->pos)[0]);

    if (phi) {
	orig.x = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->pos)[0];
	orig.y = (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->pos)[1];
	cosv = cos(phi);
	sinv = sin(phi);
	for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	    p.x = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[0] - orig.x;
	    p.y = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[1] - orig.y;
	    (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[0] = p.x * cosv - p.y * sinv + orig.x;
	    (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[1] = p.x * sinv + p.y * cosv + orig.y;
	}
	return 1;
    }
    else return ret;
...
static lookup_t adjustMode[] = {
    {AM_NONE, "", ((sizeof("")-1)/sizeof(char)), "none"},

    

    {AM_VOR, "voronoi", ((sizeof("voronoi")-1)/sizeof(char)), "Voronoi"},
    {AM_NSCALE, "scale", ((sizeof("scale")-1)/sizeof(char)), "scaling"},
    {AM_COMPRESS, "compress", ((sizeof("compress")-1)/sizeof(char)), "compress"},
    {AM_VPSC, "vpsc", ((sizeof("vpsc")-1)/sizeof(char)), "vpsc"},
    {AM_IPSEP, "ipsep", ((sizeof("ipsep")-1)/sizeof(char)), "ipsep"},
    {AM_SCALE, "oscale", ((sizeof("oscale")-1)/sizeof(char)), "old scaling"},
    {AM_SCALEXY, "scalexy", ((sizeof("scalexy")-1)/sizeof(char)), "x and y scaling"},
    {AM_ORTHO, "ortho", ((sizeof("ortho")-1)/sizeof(char)), "orthogonal constraints"},
    {AM_ORTHO_YX, "ortho_yx", ((sizeof("ortho_yx")-1)/sizeof(char)), "orthogonal constraints"},
    {AM_ORTHOXY, "orthoxy", ((sizeof("orthoxy")-1)/sizeof(char)), "xy orthogonal constraints"},
    {AM_ORTHOYX, "orthoyx", ((sizeof("orthoyx")-1)/sizeof(char)), "yx orthogonal constraints"},
    {AM_PORTHO, "portho", ((sizeof("portho")-1)/sizeof(char)), "pseudo-orthogonal constraints"},
    {AM_PORTHO_YX, "portho_yx", ((sizeof("portho_yx")-1)/sizeof(char)), "pseudo-orthogonal constraints"},
    {AM_PORTHOXY, "porthoxy", ((sizeof("porthoxy")-1)/sizeof(char)), "xy pseudo-orthogonal constraints"},
    {AM_PORTHOYX, "porthoyx", ((sizeof("porthoyx")-1)/sizeof(char)), "yx pseudo-orthogonal constraints"},

    {AM_PRISM, "prism", ((sizeof("prism")-1)/sizeof(char)), 0},
...
setPrismValues (Agraph_t* g, char* s, adjust_data* dp)
{
	...
	dp->value = 1000;
    dp->scaling = late_double(g, (agattr(g,0,"overlap_scaling",(void *)0)), -4.0, -1.e10);
}
...
static int simpleScale (graph_t* g) 
{
	...
	if ((i = sscanf(p, "%lf,%lf", &sc.x, &sc.y))) {
	    if (((fabs(sc.x) < 0.000000001))) return 0;
	    if (i == 1) sc.y = sc.x;
	    else if (((fabs(sc.y) < 0.000000001))) return 0;
	    if ((sc.y == 1) && (sc.x == 1)) return 0;
	    if (Verbose)
		fprintf (stderr, "scale = (%.03f,%.03f)\n", sc.x, sc.y);
	    for (n = agfstnode(g); n; n = agnxtnode(g,n)) {
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] *= sc.x;
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] *= sc.y;
	    }
	    return 1;
	}
    }
...
sepFactor(graph_t* g)
{
    ...
    else if ((marg = agget(g, "esep")) && parseFactor(marg, &pmargin, 0.8)) {
    }
    else { /* default */
	pmargin.x = pmargin.y = 4;
	pmargin.doAdd = 1;
    }
    if (Verbose)
...
esepFactor(graph_t* g)
{
    ...
    else if ((marg = agget(g, "sep")) && parseFactor(marg, &pmargin, 1.0/0.8)) {
    }
    else {
	pmargin.x = pmargin.y = 0.8*4;
	pmargin.doAdd = 1;
    }
    if (Verbose)
