#line 1 "graphviz-2.38.0\\lib\\sfio\\sfpurge.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfpurge.c" 2
...

{
	...
	(void) (*f->disc->exceptf) (f, 10, (Void_t *) ((int) 1),
				    f->disc);
    ...
    if ((f->flags & 0000004) && (f->mode & 0000001))
	goto done;
	...
	(void) _sfmode(f, 0000001, 1);
	/* fall through */
    case 0000001:
	if (f->extent >= 0 && f->endb > f->next) {
	    f->here -= f->endb - f->next;
	    (((f)->mode |= 00100000),sfsk(f,(_ast_intmax_t)f->here,0,f->disc));
	}
    ...
    if ((f->flags & 0002000) && f->disc && f->disc->exceptf)
	(void) (*f->disc->exceptf) (f, 10, (Void_t *) ((int) 0),
				    f->disc);
