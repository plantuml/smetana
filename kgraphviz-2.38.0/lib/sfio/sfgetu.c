#line 1 "graphviz-2.38.0\\lib\\sfio\\sfgetu.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfgetu.c" 2
...
unsigned _ast_intmax_t sfgetu(register Sfio_t * f)
