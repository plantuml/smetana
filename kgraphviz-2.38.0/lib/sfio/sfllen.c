#line 1 "graphviz-2.38.0\\lib\\sfio\\sfllen.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfllen.c" 2
...

{
    ...
    return 1 + (v > 0 ? ( ((unsigned _ast_intmax_t)(v) < (1 << 7) ? 1 : (unsigned _ast_intmax_t)(v) < ((1 << 7)*(1 << 7)) ? 2 : (unsigned _ast_intmax_t)(v) < (((1 << 7)*(1 << 7))*(1 << 7)) ? 3 : (unsigned _ast_intmax_t)(v) < ((((1 << 7)*(1 << 7))*(1 << 7))*(1 << 7)) ? 4 : 5) ) : 0);
}
