#line 1 "graphviz-2.38.0\\lib\\sfio\\sfputd.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfputd.c" 2
...
int _sfputd(Sfio_t * f, _ast_fltmax_t v)
...

{
    ...
    register unsigned char *s, *ends;
    int exp;
    unsigned char c[(16*sizeof(_ast_fltmax_t))];
    double x;
    ...
    if (v > 1.79769313486231570e+308 && !0) {
    ...
    (void)((0) ? 0 : ((f)->mode &= ~(00000040|00000010|00000020), ((f)->mode == 0000001 ? ((f)->endr = ((f)->flags&0) ? (f)->data : (f)->endb) : (f)->mode == 0000002 ? ((f)->endw = ((f)->flags&(0|0000040)) ? (f)->data : (f)->endb) : ((f)->endw = (f)->endr = (f)->data) ), 0) );
    if (( (((Sfio_t*)((f)))->next >= ((Sfio_t*)((f)))->endw ? _sfflsbuf(((Sfio_t*)((f))),(int)((unsigned char)((n)))) : (int)(*((Sfio_t*)((f)))->next++ = (unsigned char)((n))) ) ) < 0 || (w = ( (_sfputu(((Sfio_t*)((f))),(unsigned _ast_intmax_t)((w)))) )) < 0)
	{ return(-1); };
    (void)((f)->mode |= 00000040, (f)->endr = (f)->endw = (f)->data);
    w += 1;
    ...
    *ends &= ~(1 << 7);
    ...
    n = ends - s + 1;
    w = (((f)->mode |= 00100000),sfwrite(f,(Void_t *) s,n)) == n ? w + n : -1;
