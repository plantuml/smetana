#line 1 "graphviz-2.38.0\\lib\\sfio\\sfgetd.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfgetd.c" 2
...

{
    ...
    register int p, sign, exp;
    _ast_fltmax_t v;

    { if(!f) return(-1.); };

    if ((sign = ( (((Sfio_t*)(f))->next >= ((Sfio_t*)(f))->endr ? _sffilbuf(((Sfio_t*)(f)),0) : (int)(*((Sfio_t*)(f))->next++) ) )) < 0 || (exp = (int) sfgetu(f)) < 0)
	{ return(-1.); };
