#line 1 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfgetc.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfgetc.c" 2
...
{
    return (((Sfio_t*)(f))->next >= ((Sfio_t*)(f))->endr ? _sffilbuf(((Sfio_t*)(f)),0) : (int)(*((Sfio_t*)(f))->next++) );
}
