#line 1 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfputm.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfputm.c" 2
...
{
    return (_sfputm(((Sfio_t*)(f)),(unsigned _ast_intmax_t)(u),(unsigned _ast_intmax_t)(m)));
}
