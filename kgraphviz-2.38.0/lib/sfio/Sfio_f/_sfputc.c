#line 1 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfputc.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\Sfio_f\\_sfputc.c" 2




int sfputc(register Sfio_t * f, register int c)
...
{
    return (((Sfio_t*)(f))->next >= ((Sfio_t*)(f))->endw ? _sfflsbuf(((Sfio_t*)(f)),(int)((unsigned char)(c))) : (int)(*((Sfio_t*)(f))->next++ = (unsigned char)(c)) );
}
