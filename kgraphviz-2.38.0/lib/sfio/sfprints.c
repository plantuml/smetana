#line 1 "graphviz-2.38.0\\lib\\sfio\\sfprints.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfprints.c" 2
...

{
    ...
    /* make a fake stream */
    if (!f &&
	!(f = sfnew(((Sfio_t *)0), ((char *)0), (size_t) (-1),
		    -1, 0000002 | 0000004)))
	 return ((char *)0);

    sfseek(f, (_ast_intmax_t) 0, 0);
    rv = sfvprintf(f, form, args);
    va_end(args);

    if (rv < 0 || ( (((Sfio_t*)((f)))->next >= ((Sfio_t*)((f)))->endw ? _sfflsbuf(((Sfio_t*)((f))),(int)((unsigned char)(('\0')))) : (int)(*((Sfio_t*)((f)))->next++ = (unsigned char)(('\0'))) ) ) < 0)
	return ((char *)0);
