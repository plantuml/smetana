#line 1 "graphviz-2.38.0\\lib\\sfio\\sfputu.c" 1
/* $Id$ $Revision$ */
...
#line 16 "graphviz-2.38.0\\lib\\sfio\\sfputu.c" 2
...
int _sfputu(register Sfio_t * f, unsigned _ast_intmax_t v)
...

{
    ...
    *s = (unsigned char) (((unsigned long)(v))&((1 << 7)-1));
    while ((v >>= 7))
