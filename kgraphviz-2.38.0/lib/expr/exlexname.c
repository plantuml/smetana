#line 1 "graphviz-2.38.0\\lib\\expr\\exlexname.c" 1
...
#line 22 "graphviz-2.38.0\\lib\\expr\\exlexname.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\expr\\exlexname.c" 2
...
exlexname(int op, int subop)
{
	...
	if (op == '=')
	{
		...
		else sfsprintf(b, 16, "(%d)=", subop);
	}
	else if (op > ' ' && op <= '~')
		sfsprintf(b, 16, "%c", op);
	else sfsprintf(b, 16, "(%d)", op);
	return b;
}
