#line 1 "graphviz-2.38.0\\lib\\expr\\exrewind.c" 1
/* $Id$ $Revision$ */
...
#line 23 "graphviz-2.38.0\\lib\\expr\\exrewind.c" 2
#line 1 "graphviz-2.38.0\\lib\\expr\\exrewind.c" 1
...
exrewind(Expr_t* ex)
{
	...
	if (!ex->input->pushback && !(ex->input->pushback = ((0)?(char*)realloc((char*)(0),sizeof(char)*(sizeof(ex->line))+(3)):(char*)malloc(sizeof(char)*(sizeof(ex->line))+(3)))))
	{
		exnospace();
		return -1;
	}
