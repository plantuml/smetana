#line 1 "graphviz-2.38.0\\lib\\expr\\exerror.c" 1
...
#line 22 "graphviz-2.38.0\\lib\\expr\\exerror.c" 2
...
exerror(const char* format, ...)
{
	...
	if (expr.program->disc->errorf && !expr.program->errors && (sp = sfnew((Sfio_t*)0,(char*)0,-1,-1,0000002|0000004)))
	{
		va_list	ap;
		char*	s;
		char	buf[64];
		...
		va_end(ap);
		if (!(s = (( (((Sfio_t*)((sp)))->next >= ((Sfio_t*)((sp)))->endw ? _sfflsbuf(((Sfio_t*)((sp))),(int)((unsigned char)((0)))) : (int)(*((Sfio_t*)((sp)))->next++ = (unsigned char)((0))) ) ), (char*)((sp)->next = (sp)->data) )))
			s = "out of space";
		(*expr.program->disc->errorf)(expr.program, expr.program->disc, (expr.program->disc->flags & (1<<2)) ? 3 : 2, "%s", s);
		sfclose(sp);
	}
	else if (expr.program->disc->flags & (1<<2))
		exit(1);
}
...
exwarn(const char *format, ...)
{
	...
	if (expr.program->disc->errorf && (sp = sfnew((Sfio_t*)0,(char*)0,-1,-1,0000002|0000004))) {
		va_list ap;
		char *s;
		char buf[64];
		...
		sfvprintf(sp, format, ap);
		va_end(ap);
		s = (( (((Sfio_t*)((sp)))->next >= ((Sfio_t*)((sp)))->endw ? _sfflsbuf(((Sfio_t*)((sp))),(int)((unsigned char)((0)))) : (int)(*((Sfio_t*)((sp)))->next++ = (unsigned char)((0))) ) ), (char*)((sp)->next = (sp)->data) );
