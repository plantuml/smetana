#line 1 "graphviz-2.38.0\\lib\\dotgen2\\groups.c" 1
/* $Id$Revision: */
...
#line 16 "graphviz-2.38.0\\lib\\dotgen2\\groups.c" 2
...
#line 17 "graphviz-2.38.0\\lib\\dotgen2\\groups.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\utils.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 18 "graphviz-2.38.0\\lib\\dotgen2\\groups.c" 2
...
{
    mcGroup* rv = (mcGroup*)zmalloc(sizeof(mcGroup));
    rv->alignType=mcBoth;
    rv->cnt=0;
...
void createGroups(Agraph_t* sg)
{
	...
	if(is_a_cluster(subg)) {
		...
		mcn = (((mcnodeinfo_t*)((v)->base.data))->mcn);
		(*(((Dt_t*)(gr->nodes))->searchf))((gr->nodes),(void*)(mcn),0000001|0020000);
		mcn->group=gr;
...
void nodesToClusters(Agraph_t* g)
{
    ...
    {
	if ((c = (((mcnodeinfo_t*)((v)->base.data))->highCluster)))
...
void graphGroups(Agraph_t* sg)
{
	...
	if(is_a_cluster(subg))
	    for (v = agfstnode(subg); v; v = agnxtnode(subg, v)) 
	    	(((mcnodeinfo_t*)((v)->base.data))->highCluster)=subg;
	else
	    graphGroups (subg);
