#line 1 "graphviz-2.38.0\\lib\\dotgen2\\minc2.c" 1
/* $Id$Revision: */
...
#line 1 "graphviz-2.38.0\\lib\\dotgen2\\dot2.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 18 "graphviz-2.38.0\\lib\\dotgen2\\dot2.h" 2
#line 1 "graphviz-2.38.0\\lib\\dotgen2\\dot2procs.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\dotgen2\\dot2.h" 2
...
#line 16 "graphviz-2.38.0\\lib\\dotgen2\\minc2.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\utils.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\dotgen2\\minc2.c" 2
#line 1 "graphviz-2.38.0\\lib\\dotgen2\\minc.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 18 "graphviz-2.38.0\\lib\\dotgen2\\minc2.c" 2
#line 1 "graphviz-2.38.0\\lib\\dotgen2\\groups.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\dotgen2\\groups.h" 2
...
#line 19 "graphviz-2.38.0\\lib\\dotgen2\\minc2.c" 2
...
static void add_node(Agraph_t * g, Agedge_t * e, int labels)
{
    ...
    head = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
    tail = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
    ...
    tempC1 = (((mcnodeinfo_t*)((head)->base.data))->highCluster);
    tempC2 = (((mcnodeinfo_t*)((tail)->base.data))->highCluster);

    if (tempC1 == tempC2)
	cluster = tempC1;

    rankDiff = (((mcnodeinfo_t*)((head)->base.data))->rank) - (((mcnodeinfo_t*)((tail)->base.data))->rank);
	...
	for (i = (((mcnodeinfo_t*)((tail)->base.data))->rank) + 1; i < (((mcnodeinfo_t*)((head)->base.data))->rank); i++) {
	    ...
	    (((mcnodeinfo_t*)((tmpN)->base.data))->rank) = i;
	    (((mcnodeinfo_t*)((tmpN)->base.data))->type) = type;
	    (((mcnodeinfo_t*)((tmpN)->base.data))->highCluster) = cluster;
	    (((mcnodeinfo_t*)((tmpN)->base.data))->orderr) = (((mcnodeinfo_t*)((tail)->base.data))->orderr);
	    /*create internal edge */
	    tmpE = mkMCEdge (g, tail, tmpN, 0, 1, (((mcedgeinfo_t*)((e)->base.data))->orig));
	    tail = tmpN;
    } else
	for (i = (((mcnodeinfo_t*)((tail)->base.data))->rank) - 1; i > (((mcnodeinfo_t*)((head)->base.data))->rank); i--) {
	    if (labels) {
    ...
    tmpE = mkMCEdge (g, tail, head, 0, 1, (((mcedgeinfo_t*)((e)->base.data))->orig));
    /*mark the long edge for deletion */
    (((mcedgeinfo_t*)((e)->base.data))->deleteFlag) = 1;
}
...
static void addNodes(Agraph_t * g, int hasLabels)
{
	...
	int type = (((mcnodeinfo_t*)((v)->base.data))->type);
	if (type != 1)
	    continue;
	for (e = agfstout(g, v); e; e = agnxtout(g, e)) {
	    if ((((mcedgeinfo_t*)((e)->base.data))->type) == 1)
		continue;
	    eList = ((Agedge_t **)grealloc(eList,(tempEdgeCnt + 1)*sizeof(Agedge_t *)));
	    eList[tempEdgeCnt] = e;
	    tempEdgeCnt++;
	}
    }
	...
	for (e = agfstout(g, v); e; e = agnxtout(g, e)) {
	    if (ee)
		agdelete(g, ee);
	    if ((((mcedgeinfo_t*)((e)->base.data))->deleteFlag) == 1)
		ee = e;
	    else
		ee = NULL;
	}
...
static void double_ranks(Agraph_t * g)
{
    Agnode_t *v;
    for (v = agfstnode(g); v; v = agnxtnode(g, v))
	(((mcnodeinfo_t*)((v)->base.data))->rank) = (((mcnodeinfo_t*)((v)->base.data))->rank) * 2;
}
...
{
    mcNode *rv;
    rv = (mcNode*)zmalloc(sizeof(mcNode));
    rv->group = NULL;
    if ((((mcnodeinfo_t*)((n)->base.data))->orderr) < 0)
	(((mcnodeinfo_t*)((n)->base.data))->orderr) = 0;
    rv->order = (((mcnodeinfo_t*)((n)->base.data))->orderr);
    rv->w = 0;
    rv->node = n;
    (((mcnodeinfo_t*)((n)->base.data))->mcn) = rv;
    (((mcnodeinfo_t*)((n)->base.data))->type) = 1;
    rv->groupOrder = 0;
    rv->groupOrder = -1;
    rv->isLeader = 0;
    rv->leader = NULL;
...
{
    mcEdge *rv;
    rv = (mcEdge*)zmalloc(sizeof(mcEdge));
    rv->e = e;
    rv->lowerN = NULL;
    rv->higherN = NULL;
    rv->penalty = 1;
...
{
    mcLevel *rv;
    rv = (mcLevel*)zmalloc(sizeof(mcLevel));
    rv->nodes = NULL;
    rv->nodecnt = 0;
    rv->rank = rank;
...
static void addEdgeToNode(mcNode * n, mcEdge * e, int lowEdge)
{
    if (lowEdge) {
	n->low_edgs_cnt++;
	n->low_edgs = ((mcEdge **)grealloc(n->low_edgs,(n->low_edgs_cnt)*sizeof(mcEdge *)));
	n->low_edgs[n->low_edgs_cnt - 1] = e;
    } else {
	n->high_edgs_cnt++;
	n->high_edgs = ((mcEdge **)grealloc(n->high_edgs,(n->high_edgs_cnt)*sizeof(mcEdge *)));
...
static void addAdjEdges(Agnode_t * n)
{
    ...
    mcLevel *l;
    g = agraphof(n);
    rank = (((mcnodeinfo_t*)((n)->base.data))->rank);
    mcN = (((mcnodeinfo_t*)((n)->base.data))->mcn);
    l = mcN->level;

    for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	av = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	mcE = initMcEdge(e);
	if ((((mcnodeinfo_t*)((av)->base.data))->rank) <= rank) {
	    addEdgeToNode(mcN, mcE, 1);
	    mcE->lowerN = (((mcnodeinfo_t*)((av)->base.data))->mcn);
	    mcE->higherN = mcN;
	    mcE->lowerPort = (((mcedgeinfo_t*)((e)->base.data))->head_port);
	    mcE->higherPort = (((mcedgeinfo_t*)((e)->base.data))->tail_port);

	} else {
	    addEdgeToNode(mcN, mcE, 0);
	    mcE->higherN = (((mcnodeinfo_t*)((av)->base.data))->mcn);
	    mcE->lowerN = mcN;
	    mcE->lowerPort = (((mcedgeinfo_t*)((e)->base.data))->tail_port);
	    mcE->higherPort = (((mcedgeinfo_t*)((e)->base.data))->head_port);
	}
    }
    for (e = agfstin(g, n); e; e = agnxtin(g, e)) {
	av = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
	mcE = initMcEdge(e);
	if ((((mcnodeinfo_t*)((av)->base.data))->rank) < rank) {
	    addEdgeToNode(mcN, mcE, 1);
	    mcE->lowerN = (((mcnodeinfo_t*)((av)->base.data))->mcn);
...
static mcGraph *newMcGraph(Agraph_t * g)
{
    ...
    for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	if ((((mcnodeinfo_t*)((v)->base.data))->rank) > maxRank)
	    maxRank = (((mcnodeinfo_t*)((v)->base.data))->rank);
    }

    rv = (mcGraph*)zmalloc(sizeof(mcGraph));
	...
	rv->lvl_cnt++;
	rv->lvls = ((mcLevel**)grealloc(rv->lvls,(rv->lvl_cnt)*sizeof(mcLevel*)));
...
{
    int rank = (((mcnodeinfo_t*)((n->node)->base.data))->rank);
    mcLevel *l;
    l = mcG->lvls[rank];
    n->order = l->nodecnt;
    l->nodecnt++;
    l->nodes = ((mcNode**)grealloc(l->nodes,(l->nodecnt)*sizeof(mcNode*)));
    l->nodes[l->nodecnt - 1] = n;
    (((mcnodeinfo_t*)((n->node)->base.data))->orderr) = n->order;
    n->level = l;
}
...
"d3",
"e0" };
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nlist)=(node_t*)malloc(sizeof(node_t)*agnnodes(g));
    ...
    for (v = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nlist); v; v = (((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->next)) 
    {
	if ((inEdgeCnt(v, g) == 0) && ((((mcnodeinfo_t*)((v)->base.data))->inBucket) != 1)) {
	    enqueue(b, v);
	    (((mcnodeinfo_t*)((v)->base.data))->inBucket) = 1;
		...
		for (e = agfstout(g, v0); e; e = agnxtout(g, e)) {
		    head = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
		    if (((((mcnodeinfo_t*)((head)->base.data))->inBucket) != 1)) {
			enqueue(b, head);
			(((mcnodeinfo_t*)((head)->base.data))->inBucket) = 1;
		    }
		}
	    }
...
static mcGraph *createMatrixOut(Agraph_t * g)
{
    ...
    mcG = newMcGraph(g);
    for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	if ((outEdgeCnt(v, g) == 0) && ((((mcnodeinfo_t*)((v)->base.data))->inBucket) != 1)) {
	    enqueue(b, v);
	    (((mcnodeinfo_t*)((v)->base.data))->inBucket) = 1;
		...
		for (e = agfstin(g, v0); e; e = agnxtin(g, e)) {
		    tail = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
		    if (((((mcnodeinfo_t*)((tail)->base.data))->inBucket) != 1)) {
			enqueue(b, tail);
			(((mcnodeinfo_t*)((tail)->base.data))->inBucket) = 1;
		    }
		}
	    }
...
void clusterEdges(mcGraph * mcG)
{
	...
	for (id = 0; id < l->nodecnt; id++) {
		...
		n1 = e->higherN->node;
		n2 = e->lowerN->node;
		if ((((mcnodeinfo_t*)((n1)->base.data))->highCluster) == (((mcnodeinfo_t*)((n2)->base.data))->highCluster))
		    if ((((mcnodeinfo_t*)((n1)->base.data))->highCluster)) {
			e->penalty = 10000;
			e->higherN->order = -1;
			e->lowerN->order = -1;
...
static void readOrders(Agraph_t * g)
{
	...
	bf = agget(v, "order");
	if (bf) {
	    (((mcnodeinfo_t*)((v)->base.data))->order) = atoi(bf);
//              MND_rank(v)=atoi(bf);
...
Agraph_t *dot2_mincross (Agraph_t * srcGraph)
{
    ...
    graphGroups(g);
    if (agattr(srcGraph, 2, "label", (char *) 0)) {
	double_ranks(g);
	addNodes(g, 1);
    } else
	addNodes(g, 0);
...
static int in_cross(mcNode* v, mcNode* w)
{
	...
	for (id2=0;id2 < v->low_edgs_cnt; id2++)
	{
	    ...
	    if ((t > 0)
		|| ((t == 0)
		&& ( (((Agedgeinfo_t*)(((Agobj_t*)(e1->lowerN->node))->data))->tail_port).p.x > (((Agedgeinfo_t*)(((Agobj_t*)(e2->lowerN->node))->data))->tail_port).p.x)))
...
static int out_cross(mcNode* v, mcNode* w)
{
	...
	for (id2=0;id2 < v->high_edgs_cnt; id2++)
	{
	    ...
	    if ((t > 0)
		|| ((t == 0)
		&& ( (((Agedgeinfo_t*)(((Agobj_t*)(e1->higherN->node))->data))->head_port).p.x > (((Agedgeinfo_t*)(((Agobj_t*)(e2->higherN->node))->data))->head_port).p.x)))
