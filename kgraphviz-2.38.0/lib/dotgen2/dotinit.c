#line 1 "graphviz-2.38.0\\lib\\dotgen2\\dotinit.c" 1
/* $Id$Revision: */
...
#line 16 "graphviz-2.38.0\\lib\\dotgen2\\dotinit.c" 2
...
static void attach_attributes(graph_t *g)
{
    ...
    rank = agattr(g,1,"rank","");
    order = agattr(g,1,"order","");
...
static void dot_init_edge(edge_t * e)
{
    ...
    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->weight) = late_double(e, E_weight, 1.0, 0.0);
