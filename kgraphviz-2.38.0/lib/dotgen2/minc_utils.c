#line 1 "graphviz-2.38.0\\lib\\dotgen2\\minc_utils.c" 1
/* $Id$Revision: */
...
#line 16 "graphviz-2.38.0\\lib\\dotgen2\\minc_utils.c" 2
...
#line 17 "graphviz-2.38.0\\lib\\dotgen2\\minc_utils.c" 2
...
mkMCGraph (Agraph_t* g)
{
    ...
    data = (edgepair_t*)zmalloc((agnedges(g))*sizeof(edgepair_t));
    ep = data;

    for (t = agfstnode(g); t; t = agnxtnode(g, t)) {
	newt = mkMCNode (newg, 1, agnameof(t));
	assert(newt);
        (((mcnodeinfo_t*)((newt)->base.data))->orig) = t;
        (((mcnodeinfo_t*)((newt)->base.data))->rank) = (((Agnodeinfo_t*)(((Agobj_t*)(t))->data))->rank);
    }

    for (t = agfstnode(g); t; t = agnxtnode(g, t)) {
        newt = agnode (newg, agnameof(t), 0);
	for (e = agfstout(g, t); e; e = agnxtout(g, e)) {
	    newh = agnode (newg, agnameof(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)), 0);
	    assert(newh);
            newe = mkMCEdge (newg, newt, newh, agnameof (e), 0, e); 
	    assert(newe);
	    ep->key = e;
	    ep->val = newe;
...
Agnode_t *mkMCNode (Agraph_t * g, int type, char *name)
{
    ...
    agbindrec(rv, "mcnodeinfo_t", sizeof(mcnodeinfo_t), (!(0)));
    (((mcnodeinfo_t*)((rv)->base.data))->type) = type;
    return rv;
}
...
Agedge_t* mkMCEdge (Agraph_t* g, Agnode_t* tail, Agnode_t* head, char* name, int type, Agedge_t* orige)
{
    ...
    agbindrec(tmpE, "mcedgeinfo_t", sizeof(mcedgeinfo_t), (!(0)));
    (((mcedgeinfo_t*)((tmpE)->base.data))->type) = type;
    (((mcedgeinfo_t*)((tmpE)->base.data))->orig) = orige;
    return tmpE;
}
