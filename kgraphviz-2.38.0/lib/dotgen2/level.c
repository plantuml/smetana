#line 1 "graphviz-2.38.0\\lib\\dotgen2\\level.c" 1
/* $Id$Revision: */
...
#line 16 "graphviz-2.38.0\\lib\\dotgen2\\level.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\utils.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\dotgen2\\level.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\arith.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 18 "graphviz-2.38.0\\lib\\dotgen2\\level.c" 2
...
static void agautoinit(Agraph_t *g, int graphinfo_size, int nodeinfo_size, int edgeinfo_size) 
{
    ...
    s = (int*)zmalloc((3)*sizeof(int));	/* until we fix something, this is a storage leak */
...
void dot2_levels(graph_t * g)
{
	...
	ssize = -1;
    rank2(Xg, 1, ((int)(~(unsigned)0 >> 1)), ssize);
    readout_levels(g, Xg);
}

static int is_empty(graph_t * g)
{
    return (agfstnode(g) == ((Agnode_t*)0));
}

static int is_a_strong_cluster(graph_t * g)
{
    char *str = agget(g, "compact");
    return mapBool((str), (!(0)));
}
...
static void compile_samerank(graph_t * ug, graph_t * parent_clust)
{
    ...
    if (is_a_cluster(ug)) {
	clust = ug;
	(((Agraphinfo_t*)(((Agobj_t*)(ug))->data))->parent) = parent_clust;
	if (parent_clust)
	...
	for (n = agfstnode(ug); n; n = agnxtnode(ug, n)) {
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust) == ((Agraph_t*)0))
	...
	if ((((Agraphinfo_t*)(((Agobj_t*)(ug))->data))->minrep) == (((Agraphinfo_t*)(((Agobj_t*)(ug))->data))->maxrep)) {
	    (((Agraphinfo_t*)(((Agobj_t*)(ug))->data))->minrep) = (((Agraphinfo_t*)(((Agobj_t*)(ug))->data))->maxrep) = union_all(ug);
	}
    }
}
...
static void compile_nodes(graph_t * g, graph_t * Xg)
{
	...
	if (find(n) == n)
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rep) = agnode(Xg, agnameof(n), (!(0)));
    }
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rep) == ((Agnode_t*)0))
...
static void strong(graph_t * g, node_t * t, node_t * h, edge_t * orig)
{
	...
	(e = (agedge(g,h,t,NULL,0))) ||
	(e = agedge(g, t, h, (char *) 0, (!(0)))))
...
static void weak(graph_t * g, node_t * t, node_t * h, edge_t * orig)
{
    ...
    if (!e) {
	v = agnode(g, 0, (!(0)));
	e = agedge(g, v, t, (char *) 0, (!(0)));
	f = agedge(g, v, h, (char *) 0, (!(0)));
    }
...
static void compile_edges(graph_t * ug, graph_t * Xg)
{
	...
	for (e = agfstout(ug, n); e; e = agnxtout(ug, e)) {
		...
		if ((find(((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node)) == (((Agraphinfo_t*)(((Agobj_t*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->clust)))->data))->maxrep))
		    || (find(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)) ==
			(((Agraphinfo_t*)(((Agobj_t*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->clust)))->data))->minrep))) {
		    node_t *temp = Xt;
		    Xt = Xh;
		    Xh = temp;
		}
...
static void compile_clusters(graph_t * g, graph_t * Xg)
{
	...
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    if (agfstin(g, n) == ((Agedge_t*)0)) {
		rep = (((Agnodeinfo_t*)(((Agobj_t*)(find(n)))->data))->rep);
		if (!top) {
		    sname = synthname(g, agnameof(g), "_top\177");
		    top = agnode(Xg, sname, (!(0)));
		    agedge(Xg, top, rep, (char *) 0, (!(0)));
		    agfree(g, sname);
		}
	    }
	    if (agfstout(g, n) == ((Agedge_t*)0)) {
		rep = (((Agnodeinfo_t*)(((Agobj_t*)(find(n)))->data))->rep);
		if (!bot) {
		    sname = synthname(g, agnameof(g), "_bottom\177");
		    bot = agnode(Xg, sname, (!(0)));
		    agedge(Xg, rep, bot, (char *) 0, (!(0)));
		    agfree(g, sname);
		}
	    }
	}
	if (top && bot) {
	    e = agedge(Xg, top, bot, (char *) 0, (!(0)));
	    merge(e, 0, 1000);
	}
    }
...
static void reverse_edge(graph_t * g, edge_t * e)
{
    ...
    if (!rev)
	rev = agedge(g, ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node), (char *) 0, (!(0)));
...
static void readout_levels(graph_t * g, graph_t * Xg)
{
    node_t *n;
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rank) = (((Agnodeinfo_t*)(((Agobj_t*)((((Agnodeinfo_t*)(((Agobj_t*)(find(n)))->data))->rep)))->data))->rank);
    }
}
...
static void dfscc(graph_t * g, node_t * n, int cc)
{
	...
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->mark) = cc;
...
static void connect_components(graph_t * g)
{
	...
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->mark) == 0)
	    dfscc(g, n, cc++);
    if (cc > 1) {
	node_t *root = agnode(g, "\177root", (!(0)));
	int ncc = 1;
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->mark) == ncc) {
		(void) agedge(g, root, n, (char *) 0, (!(0)));
		ncc++;
	    }
	}
    }
...
static void aaa(graph_t * g)
{
    ...
    weight = agattr(g, 2, "weight", "");
    minlen = agattr(g, 2, "minlen", "");
    label = agattr(g, 2, "label", "");
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    sprintf(buf, "%f", (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->weight));
	    agxset(e, weight, buf);
	    sprintf(buf, "%d", (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->minlen));
	    agxset(e, minlen, buf);
	    sprintf(buf, "%.02f,%d", (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->weight), (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->minlen));
	    agxset(e, label, buf);
	}
    }
}
...
{
    return (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rank);
}
