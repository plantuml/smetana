...
static void dfs_enter_outedge(node_t * v)
{
    ...
    for (e = agfstout(G, v); e; e = agnxtout(G, e)) {
	if ((ED_tree_index(e) >= 0) == 0) {
	    if (!(((Low) <= (ND_lim(aghead(e)))) && ((ND_lim(aghead(e))) <= (Lim)))) {
		slack = ((ND_rank(aghead(e)) - ND_rank(agtail(e))) - ED_minlen(e));
...
static void dfs_enter_inedge(node_t * v)
{
    ...
    for (e = agfstin(G, v); e; e = agnxtin(G, e)) {
	if ((ED_tree_index(e) >= 0) == 0) {
	    if (!(((Low) <= (ND_lim(agtail(e)))) && ((ND_lim(agtail(e))) <= (Lim)))) {
		slack = ((ND_rank(aghead(e)) - ND_rank(agtail(e))) - ED_minlen(e));
		if ((slack < Slack) || (Enter == NULL)) {
		    Enter = e;
		    Slack = slack;
...
static int treesearch(node_t * v)
{
    ...
    for (e = agfstout(G, v); e; e = agnxtout(G, e)) {
	if ((ND_mark(aghead(e)) == 0) && (((ND_rank(aghead(e)) - ND_rank(agtail(e))) - ED_minlen(e)) == 0)) {
	    add_tree_edge(e);
    ...
    for (e = agfstin(G, v); e; e = agnxtin(G, e)) {
	if ((ND_mark(agtail(e)) == 0) && (((ND_rank(aghead(e)) - ND_rank(agtail(e))) - ED_minlen(e)) == 0)) {
	    add_tree_edge(e);
...
static void feasible_tree(void)
{
	...
	for (n = agfstnode(G); n; n = agnxtnode(G, n)) {
		...
		if (((ED_tree_index(f) >= 0) == 0) && incident(f) && ((e == NULL)
							       || (((ND_rank(aghead(f)) - ND_rank(agtail(f))) - ED_minlen(f))
								   <
	...
	if (e) {
	    delta = ((ND_rank(aghead(e)) - ND_rank(agtail(e))) - ED_minlen(e));
	    if (delta) {
...
static node_t *treeupdate(node_t * v, node_t * w, int cutvalue, int dir)
{
    ...
    while (!(((ND_low(v)) <= (ND_lim(w))) && ((ND_lim(w)) <= (ND_lim(v))))) {
	e = ND_par(v);
	if (v == agtail(e))
	    d = dir;
	else
...
static void update(edge_t * e, edge_t * f)
{
    ...
    delta = ((ND_rank(aghead(f)) - ND_rank(agtail(f))) - ED_minlen(f));
...
{
    return NOT(0);		/* could be false for slacknodes */
}
...
static int x_val(edge_t * e, node_t * v, int dir)
{
	...
	other = agtail(e);
    if (!((((ND_low(v)) <= (ND_lim(other))) && ((ND_lim(other)) <= (ND_lim(v)))))) {
	f = 1;
	rv = ED_weight(e);
    } else {
	f = 0;
