#line 1 "graphviz-2.38.0\\lib\\fdpgen\\grid.c" 1
/* $Id$ $Revision$ */
...
#line 28 "graphviz-2.38.0\\lib\\fdpgen\\grid.c" 2
...
#line 29 "graphviz-2.38.0\\lib\\fdpgen\\grid.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\macros.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 30 "graphviz-2.38.0\\lib\\fdpgen\\grid.c" 2
...
static block_t *newBlock(int size)
{
    ...
    newb = (block_t*)gmalloc(sizeof(block_t));
    newb->next = 0;
    newb->mem = (cell*)gmalloc((size)*sizeof(cell));
...
void adjustGrid(Grid * g, int nnodes)
{
	...
	nsize = ((nnodes)>(2 *(g->listSize))?(nnodes):(2 *(g->listSize)));
	if (g->listMem)
	    free(g->listMem);
	g->listMem = (node_list*)gmalloc((nsize)*sizeof(node_list));
	g->listSize = nsize;
    }
}
...
{
    (*(((Dt_t*)(g->data))->searchf))((g->data),(void*)(0),0000100);
    g->listCur = g->listMem;
    g->cellCur = g->cellMem;
...
void addGrid(Grid * g, int i, int j, Agnode_t * n)
{
    ...
    key.p.i = i;
    key.p.j = j;
    cellp = (*(((Dt_t*)(g->data))->searchf))((g->data),(void*)(&key),0000001);
...
cell *findGrid(Grid * g, int i, int j)
{
    ...
    key.p.i = i;
    key.p.j = j;
    return ((cell *) (*(((Dt_t*)(g->data))->searchf))((g->data),(void*)(&key),0000004));
}
