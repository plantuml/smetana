#line 1 "graphviz-2.38.0\\lib\\fdpgen\\comp.c" 1
/* $Id$ $Revision$ */
...
#line 27 "graphviz-2.38.0\\lib\\fdpgen\\comp.c" 2
...
#line 28 "graphviz-2.38.0\\lib\\fdpgen\\comp.c" 2
...
#line 29 "graphviz-2.38.0\\lib\\fdpgen\\comp.c" 2
#line 1 "graphviz-2.38.0\\lib\\fdpgen\\comp.c" 1
...
/* fprintf (stderr, "comps of %s starting at %d \n", g->name, c_cnt); */
    marks = (char*)zmalloc((agnnodes(g))*sizeof(char));	/* freed below */
	...
	(((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg) = (void *) (gdata*)zmalloc(sizeof(gdata));
	(((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg)))->ports) = pp;
	(((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg)))->nports) = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg)))->nports);
	for (; pp->n; pp++) {
	    if ((marks[(((Agnodeinfo_t*)(((Agobj_t*)(pp->n))->data))->id)]))
		continue;
	...
	if ((marks[(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->id)]))
	    continue;
	...
	*pinned = pinflag;
    /* freed in layout */
    comps = cp = (graph_t **)zmalloc((c_cnt + 1)*sizeof(graph_t *));
