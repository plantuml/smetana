...
#line 1 "graphviz-2.38.0\\lib\\fdpgen\\grid.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 21 "graphviz-2.38.0\\lib\\fdpgen\\grid.h" 2
#line 1 "graphviz-2.38.0\\lib\\cdt\\cdt.h" 1
...
#line 22 "graphviz-2.38.0\\lib\\fdpgen\\grid.h" 2
...
#line 44 "graphviz-2.38.0\\lib\\fdpgen\\tlayout.c" 2
...
static int init_params(graph_t * g, xparams * xpms)
{
	...
	(parms.T0) = (parms.Tfact) * (parms.K) * sqrt(nnodes) / 5;
    ...
    xpms->T0 = cool((parms.T0), (parms.pass1));
    xpms->K = (parms.K);
    xpms->C = (parms.C);
...
void fdp_initParams(graph_t * g)
{
    ...
    (parms.maxIters) = late_int(g, agattr(g,0, "maxiter", (void *)0), 600, 0);
    (fdp_parms->K) = (parms.K) = late_double(g, agattr(g,0, "K", (void *)0), 0.3, 0.0);
    if ((fdp_parms->T0) == -1.0) {
	(parms.T0) = late_double(g, agattr(g,0, "T0", (void *)0), -1.0, 0.0);
    } else
	(parms.T0) = (fdp_parms->T0);
    (parms.seed) = 1;
    (parms.smode) = setSeed (g, 2, &(parms.seed));
    if ((parms.smode) == 0) {
	agerr(AGWARN, "fdp does not support start=self - ignoring\n");
	(parms.seed) = 2;
    }

    (parms.pass1) = ((parms.unscaled) * (parms.maxIters)) / 100;
    (parms.K2) = (parms.K) * (parms.K);

    if ((parms.useGrid)) {
	if ((parms.Cell) <= 0.0)
	    (parms.Cell) = 3 * (parms.K);
...
doRep(node_t * p, node_t * q, double xdelta, double ydelta, double dist2)
{
    ...
    if ((!(((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->alg)))->dn) && !(((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->clust)) && (!(((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->alg)))->dn) && !(((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->clust)))
	force *= 10.0;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->alg)))->disp)[0] += xdelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->alg)))->disp)[1] += ydelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->alg)))->disp)[0] -= xdelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->alg)))->disp)[1] -= ydelta * force;
}
...
static void applyRep(Agnode_t * p, Agnode_t * q)
{
    ...
    xdelta = (((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->pos)[0] - (((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->pos)[0];
    ydelta = (((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->pos)[1] - (((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->pos)[1];
...
static void applyAttr(Agnode_t * p, Agnode_t * q, Agedge_t * e)
{
    ...
    dist = sqrt(dist2);
    if ((parms.useNew))
	force = ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->factor) * (dist - (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->dist))) / dist;
    else
	force = ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->factor) * dist) / (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->dist);
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->alg)))->disp)[0] -= xdelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->alg)))->disp)[1] -= ydelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->alg)))->disp)[0] += xdelta * force;
    (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->alg)))->disp)[1] += ydelta * force;
...
static void updatePos(Agraph_t * g, double temp, bport_t * pp)
{
	...
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pinned) & 2)
	    continue;
	dx = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[0];
	dy = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[1];
	len2 = dx * dx + dy * dy;

	/* limit by temperature */
	if (len2 < temp2) {
	    x = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] + dx;
	    y = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] + dy;
	} else {
	    double fact = temp / (sqrt(len2));
	    x = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] + dx * fact;
	    y = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] + dy * fact;
	}

	/* if ports, limit by boundary */
	if (pp) {
	    d = sqrt((x * x) / (parms.Wd2) + (y * y) / (parms.Ht2));
	    if ((!(((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->dn) && !(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust))) {
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = x / d;
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = y / d;
	    } else if (d >= 1.0) {
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = 0.95 * x / d;
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = 0.95 * y / d;
	    } else {
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = x;
		(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = y;
	    }
	} else {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = x;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = y;
...
static void gAdjust(Agraph_t * g, double temp, bport_t * pp, Grid * grid)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	(((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[0] = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[1] = 0;
	addGrid(grid, ((int)floor(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos))[0] / (parms.Cell))), ((int)floor(((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos))[1] / (parms.Cell))),
		n);
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	for (e = agfstout(g, n); e; e = agnxtout(g, e))
	    if (n != ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node))
		applyAttr(n, ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node), e);
    }
...
{
    int nG = agnnodes(g) - (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg)))->nports);
    double size;
    Agnode_t *np;
    ...
    long local_seed;
    double PItimes2 = 3.14159265358979323846 * 2.0;

    for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	if ((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned)) {
	    if (n_pos) {
		bb.LL.x = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0])<(bb.LL.x)?((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0]):(bb.LL.x));
		bb.LL.y = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1])<(bb.LL.y)?((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1]):(bb.LL.y));
		bb.UR.x = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0])>(bb.UR.x)?((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0]):(bb.UR.x));
		bb.UR.y = (((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1])>(bb.UR.y)?((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1]):(bb.UR.y));
	    } else {
		bb.UR.x = bb.LL.x = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0];
		bb.UR.y = bb.LL.y = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1];
	    }
	    n_pos++;
	}
    }

    size = (parms.K) * (sqrt((double) nG) + 1.0);
    (parms.Wd) = (parms.Ht) = 1.2 * (size / 2.0);
    if (n_pos == 1) {
	ctr.x = bb.LL.x;
	ctr.y = bb.LL.y;
    } else if (n_pos > 1) {
	...
	width = 1.2 * (bb.UR.x - bb.LL.x);
	height = 1.2 * (bb.UR.y - bb.LL.y);
	area = 4.0 * (parms.Wd) * (parms.Ht);
...
/* fprintf (stderr, "initPos %s ctr (%g,%g) Wd %g Ht %g\n", g->name, ctr.x, ctr.y, Wd, Ht); */
	while (pp->e) {		/* position ports on ellipse */
	    np = pp->n;
	    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = (parms.Wd) * cos(pp->alpha) + ctr.x;
	    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = (parms.Ht) * sin(pp->alpha) + ctr.y;
	    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned) = 1;
/* fprintf (stderr, "%s pt (%g,%g) %g\n", np->name, ND_pos(np)[0], ND_pos(np)[1], pp->alpha); */
	    pp++;
	}
	for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	    if ((!(((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->dn) && !(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->clust)))
		continue;
	    if ((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned)) {
		(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] -= ctr.x;
		(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] -= ctr.y;
	    } else {
		pointf p = { 0.0, 0.0 };
		int cnt = 0;
		node_t *op;
		...
		for (ep = agfstedge(g, np); ep; ep = agnxtedge(g, ep, np)) {
		    if (((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node) == ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node))
			continue;
		    op = (((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node) == np ? ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node) : ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node));
		    if (!((((Agnodeinfo_t*)(((Agobj_t*)(op))->data))->pinned) > 0))
			continue;
		    if (cnt) {
			p.x = (p.x * cnt + (((Agnodeinfo_t*)(((Agobj_t*)(op))->data))->pos)[0]) / (cnt + 1);
			p.y = (p.y * cnt + (((Agnodeinfo_t*)(((Agobj_t*)(op))->data))->pos)[1]) / (cnt + 1);
		    } else {
			p.x = (((Agnodeinfo_t*)(((Agobj_t*)(op))->data))->pos)[0];
			p.y = (((Agnodeinfo_t*)(((Agobj_t*)(op))->data))->pos)[1];
		    }
		    cnt++;
		}
		if (cnt > 1) {
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = p.x;
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = p.y;
/* fprintf (stderr, "%s 1 (%g,%g)\n", np->name, p.x, p.y); */
		} else if (cnt == 1) {
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = 0.98 * p.x + 0.1 * ctr.x;
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = 0.9 * p.y + 0.1 * ctr.y;
/* fprintf (stderr, "%s %d (%g,%g)\n", np->name, cnt, ND_pos(np)[0], ND_pos(np)[1]); */
		} else {
		    double angle = PItimes2 * drand48();
		    double radius = 0.9 * drand48();
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = radius * (parms.Wd) * cos(angle);
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = radius * (parms.Ht) * sin(angle);
/* fprintf (stderr, "%s 0 (%g,%g)\n", np->name, ND_pos(np)[0], ND_pos(np)[1]); */
	...
	if (n_pos) {		/* If positioned nodes */
		...
		if ((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pinned)) {
		    ...
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] = (parms.Wd) * (2.0 * drand48() - 1.0);
		    (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] = (parms.Ht) * (2.0 * drand48() - 1.0);
		}
	    }
...
void dumpstat(graph_t * g)
{
    ...
    edge_t *ep;
    for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	dx = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->disp)[0];
	dy = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->disp)[1];
	l = dx * dx + dy * dy;
	if (l > max2)
	    max2 = l;
	fprintf(stderr, "%s: (%f,%f) (%f,%f)\n", agnameof(np),
		(((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0], (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1], (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->disp)[0], (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->disp)[1]);
    }
    fprintf(stderr, "max delta = %f\n", sqrt(max2));
    for (np = agfstnode(g); np; np = agnxtnode(g, np)) {
	for (ep = agfstout(g, np); ep; ep = agnxtout(g, ep)) {
	    dx = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[0] - (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(ep))->tag).objtype) == 2?(ep):((ep)-1))->node)))->data))->pos)[0];
	    dy = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->pos)[1] - (((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(ep))->tag).objtype) == 2?(ep):((ep)-1))->node)))->data))->pos)[1];
	    fprintf(stderr, "  %s --  %s  (%f)\n", agnameof(np),
		    agnameof(((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node)), sqrt(dx * dx + dy * dy));
	}
    }
}
...
void fdp_tLayout(graph_t * g, xparams * xpms)
{
    int i;
    int reset;
    bport_t *pp = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg)))->ports);
    double temp;
    Grid *grid;
    pointf ctr;
    Agnode_t *n;
