#line 1 "graphviz-2.38.0\\lib\\fdpgen\\clusteredges.c" 1
/* $Id$ $Revision$ */
...
#line 27 "graphviz-2.38.0\\lib\\fdpgen\\clusteredges.c" 2
...
#line 28 "graphviz-2.38.0\\lib\\fdpgen\\clusteredges.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\neatoprocs.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 29 "graphviz-2.38.0\\lib\\fdpgen\\clusteredges.c" 2
...
#line 30 "graphviz-2.38.0\\lib\\fdpgen\\clusteredges.c" 2
...
static void addObj(objlist * l, Ppoly_t * obj)
{
	...
	if (l->obs) {
	    l->sz *= 2;
	    l->obs = ((Ppoly_t **)grealloc(l->obs,(l->sz)*sizeof(Ppoly_t *)));
	} else {
	    l->obs = (Ppoly_t **)gmalloc((100)*sizeof(Ppoly_t *));
	    l->sz = 100;
	}
    }
    l->obs[l->cnt++] = obj;
...
{
    Ppoly_t *obs = (Ppoly_t*)zmalloc(sizeof(Ppoly_t));
    boxf bb;
    boxf newbb;
    Ppoint_t ctr;
...
addGraphObjs(objlist * l, graph_t * g, void *tex, void *hex, expand_t* pm)
{
	...
	if ((((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clust)) == g) && (n != tex) && (n != hex)
	    && !((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->clustnode))) {
	    addObj(l, makeObstacle(n, pm, 0));
	}
    }
    for (i = 1; i <= (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster); i++) {
	sg = (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i];
	if ((sg != tex) && (sg != hex)) {
	   ...
	   expand_t* pm)
{
	...
	addGraphObjs(l, g, ex, (void *)0, pm);
	ex = g;
	g = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg)))->parent);
    }
    *gp = (graph_t *) ex;
}
...
{
    node_t *h = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);
    node_t *t = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node);
    graph_t *hg = ((((Agnodeinfo_t*)(((Agobj_t*)(h))->data))->clust));
    graph_t *tg = ((((Agnodeinfo_t*)(((Agobj_t*)(t))->data))->clust));
    int hlevel;
    int tlevel;
    void *hex;			/* Objects to be excluded from list */
    void *tex;
    objlist *list = (objlist*)zmalloc(sizeof(objlist));

    /* If either endpoint is a cluster node, we move up one level */
    if (((((Agnodeinfo_t*)(((Agobj_t*)(h))->data))->clustnode))) {
	hex = hg;
	hg = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(hg))->data))->alg)))->parent);
    } else
	hex = h;
    if (((((Agnodeinfo_t*)(((Agobj_t*)(t))->data))->clustnode))) {
	tex = tg;
	tg = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(tg))->data))->alg)))->parent);
    } else
	tex = t;

    hlevel = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(hg))->data))->alg)))->level);
    tlevel = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(tg))->data))->alg)))->level);
    if (hlevel > tlevel) {
    ...
    while (hg != tg) {
	addGraphObjs(list, hg, (void *)0, hex, pm);
	addGraphObjs(list, tg, tex, (void *)0, pm);
	hex = hg;
	hg = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(hg))->data))->alg)))->parent);
	tex = tg;
	tg = (((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(tg))->data))->alg)))->parent);
...
int compoundEdges(graph_t * g, expand_t* pm, int edgetype)
{
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    ...
	    if ((n == head) && (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->count)) {	/* self arc */
		if (!P) {
		    P = (path*)zmalloc(sizeof(path));
		    P->boxes = (boxf*)zmalloc((agnnodes(g) + 20 * 2 * 9)*sizeof(boxf));
		}
		makeSelfArcs(P, e, (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->nodesep));
	    } else if ((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->count)) {
		 ...
		 */
		for (e0 = e; e0; e0 = (((Agedgeinfo_t*)(((Agobj_t*)(e0))->data))->to_virt)) {
		    (((Agedgeinfo_t*)(((Agobj_t*)(e0))->data))->path) =
			getPath(e0, vconfig, 0, objl->obs, objl->cnt);
		    makeSpline(g, e0, objl->obs, objl->cnt, 0);
		}
		resetObjlist(objl);
	    }
	}
