#line 1 "graphviz-2.38.0\\lib\\fdpgen\\fdpinit.c" 1
/* $Id$ $Revision$ */
...
#line 25 "graphviz-2.38.0\\lib\\fdpgen\\fdpinit.c" 2
...
#line 26 "graphviz-2.38.0\\lib\\fdpgen\\fdpinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\cgraph\\agxbuf.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 27 "graphviz-2.38.0\\lib\\fdpgen\\fdpinit.c" 2
...
static void initialPositions(graph_t * g)
{
    ...
    possym = agattr(g,1, "pos", (void *)0);
    if (!possym)
	return;
    pinsym = agattr(g,1, "pin", (void *)0);
...
static void init_edge(edge_t * e, attrsym_t * E_len)
{
    ...
    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->dist) = late_double(e, E_len, fdp_parms->K, 0.0);
...
void fdp_init_node_edge(graph_t * g)
{
    ...
    nn = agnnodes(g);
    /* alg = N_NEW(nn, ndata); */
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->neato_nlist) = (node_t **)zmalloc((nn + 1)*sizeof(node_t *));
...
static void cleanup_subgs(graph_t * g)
{
	...
	if ((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg)) {
	    free((((gdata*)((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg)))->ports));
	    free((((Agraphinfo_t*)(((Agobj_t*)(subg))->data))->alg));
	}
	cleanup_subgs(subg);
    }
