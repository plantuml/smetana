#line 1 "graphviz-2.38.0\\lib\\fdpgen\\xlayout.c" 1
/* $Id$ $Revision$ */
...
#line 28 "graphviz-2.38.0\\lib\\fdpgen\\xlayout.c" 2
...
#line 29 "graphviz-2.38.0\\lib\\fdpgen\\xlayout.c" 2
...
#line 30 "graphviz-2.38.0\\lib\\fdpgen\\xlayout.c" 2
#line 1 "graphviz-2.38.0\\lib\\fdpgen\\xlayout.c" 1
...
{
    double w = (X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width)/2.0 + X_marg.x): (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width)*X_marg.x/2.0);
    double h = (X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)/2.0 + X_marg.y): (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height)*X_marg.y/2.0);
    return sqrt(w * w + h * h);
}
...
static int overlap(node_t * p, node_t * q)
{
    ...
    if (ydelta < 0)
	ydelta = -ydelta;
    ret = ((xdelta <= ((X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->width)/2.0 + X_marg.x): (((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->width)*X_marg.x/2.0) + (X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->width)/2.0 + X_marg.x): (((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->width)*X_marg.x/2.0))) && (ydelta <= ((X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->height)/2.0 + X_marg.y): (((Agnodeinfo_t*)(((Agobj_t*)(p))->data))->height)*X_marg.y/2.0) + (X_marg.doAdd ? ((((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->height)/2.0 + X_marg.y): (((Agnodeinfo_t*)(((Agobj_t*)(q))->data))->height)*X_marg.y/2.0))));
    return ret;
...
/* if (V && ov)  */
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    applyAttr(n,((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node));
	}
    }
    if (overlaps == 0)
	return 0;
    ...
    temp2 = temp * temp;
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pinned) == 3)
	    continue;
	disp[0] = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[0];
	disp[1] = (((dndata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->disp)[1];
	len2 = disp[0] * disp[0] + disp[1] * disp[1];

	if (len2 < temp2) {
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] += disp[0];
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] += disp[1];
	} else {
	    /* to avoid sqrt, consider abs(x) + abs(y) */
	    len = sqrt(len2);
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] += (disp[0] * temp) / len;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] += (disp[1] * temp) / len;
	}
    }
    return overlaps;
}
...
static int x_layout(graph_t * g, xparams * pxpms, int tries)
{
    ...
    X_marg = sepFactor (g);
    if (X_marg.doAdd) {
	X_marg.x = ((X_marg.x)/(double)72); /* sepFactor is in points */
	X_marg.y = ((X_marg.y)/(double)72);
    }
    ov = cntOverlaps(g);
    if (ov == 0)
	return 0;
