#line 1 "graphviz-2.38.0\\lib\\gvpr\\queue.c" 1
/* $Id$ $Revision$ */
...
#line 22 "graphviz-2.38.0\\lib\\gvpr\\queue.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\gvpr\\queue.c" 2
...
static void *makef(Dt_t * d, nsitem * obj, Dtdisc_t * disc)
{
    ...
    p = ((0)?(nsitem*)realloc((char*)(0),sizeof(nsitem)*(1)+(0)):(nsitem*)malloc(sizeof(nsitem)*(1)+(0)));
    p->np = obj->np;
    return p;
}
...
void push(queue * nq, void *n)
{
    ...
    obj.np = n;
    (*(((Dt_t*)(nq))->searchf))((nq),(void*)(&obj),0000001);
}
...
void *pop(queue * nq, int delete)
{
    ...
    obj = (*(((Dt_t*)(nq))->searchf))((nq),(void*)(0),0000200);
    if (obj) {
	n = obj->np;
	if (delete)
	    (*(((Dt_t*)(nq))->searchf))((nq),(void*)(0),0000002);
	return n;
    } else
	return 0;
}
