#line 1 "graphviz-2.38.0\\lib\\patchwork\\patchworkinit.c" 1
/* $Id$Revision: */
...
#line 1 "graphviz-2.38.0\\lib\\patchwork\\patchwork.h" 1
/* $Id$Revision: */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\patchwork\\patchwork.h" 2
...
#line 18 "graphviz-2.38.0\\lib\\patchwork\\patchwork.h" 2
...
#line 16 "graphviz-2.38.0\\lib\\patchwork\\patchworkinit.c" 2
...
#line 17 "graphviz-2.38.0\\lib\\patchwork\\patchworkinit.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\patchwork\\patchworkinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\neatoprocs.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\patchwork\\patchworkinit.c" 2
...
{
    agbindrec(e, "Agedgeinfo_t", sizeof(Agnodeinfo_t), (!(0)));  // edge custom data
    /* common_init_edge(e); */
}
...
static void patchwork_init_node_edge(graph_t * g)
{
    ...
    edge_t *e;
    int i = 0;
    rdata* alg = (rdata*)zmalloc((agnnodes(g))*sizeof(rdata));
...
void patchwork_layout(Agraph_t *g)
{
    ...
    if ((agnnodes(g) == 0) && ((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->n_cluster) == 0)) return;
