...
#line 15 "graphviz-2.38.0\\lib\\mingle\\nearest_neighbor_graph.c" 2
...
#line 16 "graphviz-2.38.0\\lib\\mingle\\nearest_neighbor_graph.c" 2
#line 1 "graphviz-2.38.0\\lib\\mingle\\nearest_neighbor_graph_ann.h" 1
/*************************************************************************
 * Copyright (c) 2011 AT&T Intellectual Property
 * All rights reserved. This program and the accompanying materials
 * are made available under the terms of the Eclipse Public License v1.0
...
#line 17 "graphviz-2.38.0\\lib\\mingle\\nearest_neighbor_graph.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\mingle\\nearest_neighbor_graph.c" 2
...
SparseMatrix nearest_neighbor_graph(int nPts, int num_neigbors, int dim, double *x, double eps){
  ...
  */
  int *irn = (void *)0, *jcn = (void *)0, nz;
  double *val = (void *)0;
  SparseMatrix A;
  int k = num_neigbors;

  /* need to *2 as we do two sweeps of neighbors, so could have repeats */
  irn =  gmalloc(sizeof(int)*nPts*k*2);
  jcn =  gmalloc(sizeof(int)*nPts*k*2);
  val =  gmalloc(sizeof(double)*nPts*k*2);
