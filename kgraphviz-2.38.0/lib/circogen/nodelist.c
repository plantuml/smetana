...
#line 17 "graphviz-2.38.0\\lib\\circogen\\nodelist.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\circogen\\nodelist.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\nodelist.c" 1

static nodelistitem_t *init_nodelistitem(Agnode_t * n)
{
    nodelistitem_t *p = (nodelistitem_t*)zmalloc(sizeof(nodelistitem_t));
    p->curr = n;
    return p;
}
...
{
    nodelist_t *list = (nodelist_t*)zmalloc(sizeof(nodelist_t));
    return list;
}
...
{
    return (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.f.pos);
