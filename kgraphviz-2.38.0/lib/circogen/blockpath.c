#line 1 "graphviz-2.38.0\\lib\\circogen\\blockpath.c" 1
/* $Id$ $Revision$ */
...
#line 1 "graphviz-2.38.0\\lib\\circogen\\blockpath.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 1 "graphviz-2.38.0\\lib\\circogen\\circular.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\circular.h" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\block.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 1 "graphviz-2.38.0\\lib\\circogen\\nodelist.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\nodelist.h" 2
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\block.h" 2
...
#line 18 "graphviz-2.38.0\\lib\\circogen\\circular.h" 2
...
#line 1 "graphviz-2.38.0\\lib\\circogen\\circo.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\circo.h" 2
...
#line 127 "graphviz-2.38.0\\lib\\circogen\\circular.h" 2
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\blockpath.h" 2
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\blockpath.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\edgelist.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\edgelist.h" 2
...
#line 18 "graphviz-2.38.0\\lib\\circogen\\blockpath.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\nodeset.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\blockpath.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\deglist.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 21 "graphviz-2.38.0\\lib\\circogen\\deglist.h" 2
...
#line 20 "graphviz-2.38.0\\lib\\circogen\\blockpath.c" 2
...
static Agraph_t *clone_graph(Agraph_t * ing, Agraph_t ** xg)
{
    ...
    agbindrec(clone, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));	//node custom data
    sprintf(gname, "_clone_%d", id++);
    xclone = agopen(gname, ing->desc,((Agdisc_t *)0));
    for (n = agfstnode(ing); n; n = agnxtnode(ing, n)) {
	agsubnode(clone,n,1);
	xn = agnode(xclone, agnameof(n),1);
        agbindrec(xn, "Agnodeinfo_t", sizeof(Agnodeinfo_t), (!(0)));	//node custom data
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.clone) = xn;
    }

    for (n = agfstnode(ing); n; n = agnxtnode(ing, n)) {
	xn = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.clone);
	for (e = agfstout(ing, n); e; e = agnxtout(ing, e)) {
	    agsubedge(clone,e,1);
	    xh = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->alg)))->u.clone);
	    xe = agedge(xclone, xn, xh, NULL, 1);
	    agbindrec(xe, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));	//node custom data
	    ((((Agedgeinfo_t*)(((Agobj_t*)(xe))->data))->to_orig)) = e;
	    ((((Agnodeinfo_t*)(((Agobj_t*)(xn))->data))->order)) += 1;
	    ((((Agnodeinfo_t*)(((Agobj_t*)(xh))->data))->order)) += 1;
	}
    }
    *xg = xclone;
    return clone;
...
static void find_pair_edges(Agraph_t * g, Agnode_t * n, Agraph_t * outg)
{
    ...
    node_degree = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->order));
    neighbors_with = (Agnode_t **)gmalloc((node_degree)*sizeof(Agnode_t *));
    neighbors_without = (Agnode_t **)gmalloc((node_degree)*sizeof(Agnode_t *));

    for (e = agfstedge(g, n); e; e = agnxtedge(g, e, n)) {
	n1 = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	if (n1 == n)
	    n1 = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
	has_pair_edge = 0;
	for (ep = agfstedge(g, n); ep; ep = agnxtedge(g, ep, n)) {
	    if (ep == e)
		continue;
	    n2 = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);
	    if (n2 == n)
		n2 = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node);
	    ex = (agedge(g,n1,n2,NULL,0));
	    if (ex) {
		has_pair_edge = 1;
		if (n1 < n2) {	/* count edge only once */
		    edge_cnt++;
		    if (((((Agedgeinfo_t*)(((Agobj_t*)(ex))->data))->to_orig))) {
			agdelete(outg, ((((Agedgeinfo_t*)(((Agobj_t*)(ex))->data))->to_orig)));
			((((Agedgeinfo_t*)(((Agobj_t*)(ex))->data))->to_orig)) = 0;	/* delete only once */
		    }
		}
	    }
	}
	...
	if (diff < no_pair_count) {
		...
		agbindrec(agedge(g, tp, hp, NULL, 1), "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));   // edge custom data
		((((Agnodeinfo_t*)(((Agobj_t*)(tp))->data))->order))++;
		((((Agnodeinfo_t*)(((Agobj_t*)(hp))->data))->order))++;
		diff--;
	    }
		...
		hp = neighbors_without[mark];
		agbindrec(agedge(g, tp, hp, NULL, 1), "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));	//node custom data
		((((Agnodeinfo_t*)(((Agobj_t*)(tp))->data))->order))++;
		((((Agnodeinfo_t*)(((Agobj_t*)(hp))->data))->order))++;
	    }
	}
...
static Agraph_t *remove_pair_edges(Agraph_t * ing)
{
	...
	for (e = agfstedge(g, currnode); e; e = agnxtedge(g, e, currnode)) {
	    adjNode = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	    if (currnode == adjNode)
		adjNode = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
	...
	for (e = agfstedge(g, currnode); e; e = agnxtedge(g, e, currnode)) {
	    ...
	    ((((Agnodeinfo_t*)(((Agobj_t*)(adjNode))->data))->order))--;
		 ...
		 Agnode_t * change)
{
    ...
    parent = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(ancestor))->data))->alg)))->u.t.tparent);
    if (parent == NULL)
	return;
    ...
    if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.fdist) == 0) {
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.first) = n;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.fdist) = dist;
    } else if (dist > (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.fdist)) {
	if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.first) != change) {
	    if (!(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.sdist) || ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.second) != change))
		change = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.first);
	    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.second) = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.first);
	    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.sdist) = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.fdist);
	}
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.first) = n;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.fdist) = dist;
    } else if (dist > (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.sdist)) {
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.second) = n;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->u.t.sdist) = dist;
	return;
    } else
	return;
...
static nodelist_t *find_longest_path(Agraph_t * tree)
{
	...
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags) |= (1 << 4));
	return path;
    }
    ...
    for (n = agfstnode(tree); n; n = agnxtnode(tree, n)) {
	length = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.fdist) + (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.sdist);
	if (length > maxlength) {
	    common = n;
	    maxlength = length;
	}
    ...
    path = mkNodelist();
    for (n = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(common))->data))->alg)))->u.t.first); n != common; n = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.tparent)) {
	appendNodelist(path, NULL, n);
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags) |= (1 << 4));
    }
    appendNodelist(path, NULL, common);
    ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(common))->data))->alg)))->flags) |= (1 << 4));

    if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(common))->data))->alg)))->u.t.sdist)) {	/* 2nd path might be empty */
	endPath = mkNodelist();
	for (n = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(common))->data))->alg)))->u.t.second); n != common; n = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.tparent)) {
...
static void dfs(Agraph_t * g, Agnode_t * n, Agraph_t * tree)
{
    ...
    ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags) |= (1 << 0));
    for (e = agfstedge(g, n); e; e = agnxtedge(g, e, n)) {
	neighbor = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	if (neighbor == n)
	    neighbor = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);

	if (!((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(neighbor))->data))->alg)))->flags)&(1 << 0))) {
	    /* add the edge to the dfs tree */
	    agsubedge(tree,e,1);
	    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(neighbor))->data))->alg)))->u.t.tparent) = n;
	    dfs(g, neighbor, tree);
	}
    }
}
...
static Agraph_t *spanning_tree(Agraph_t * g)
{
    ...
    agbindrec(tree, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));	//node custom data

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	agsubnode(tree,n,1);
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.fdist) = 0;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.sdist) = 0;
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags) &= ~(1 << 0));
    }

    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if (!((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags)&(1 << 0))) {
	    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.t.tparent) = NULL;
	    dfs(g, n, tree);
	}
    }
...
static void block_graph(Agraph_t * g, block_t * sn)
{
	...
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->alg)))->block) == sn)
		agsubedge(subg,e,1);
	}
    }
}
...
static int count_all_crossings(nodelist_t * list, Agraph_t * subg)
{
	...
	for (e = agfstout(subg, n); e; e = agnxtout(subg, e)) {
	    (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) = 0;
	}
    }
	...
	for (e = agfstedge(subg, n); e; e = agnxtedge(subg, e, n)) {
	    if ((((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) > 0) {
		edgelistitem *eitem;
		Agedge_t *ep;

		for (eitem = (edgelistitem *) (*(((Dt_t*)(openEdgeList))->searchf))((openEdgeList),(void*)(0),0000200); eitem;
		     eitem =
		     (edgelistitem *) (*(((Dt_t*)(openEdgeList))->searchf))((openEdgeList),(void*)(eitem),0000010)) {
		    ep = eitem->edge;
		    if ((((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->alg)))->order) > (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order)) {
			if ((((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node) != n) && (((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node) != n))
			    crossings++;
		    }
		}
	...
	for (e = agfstedge(subg, n); e; e = agnxtedge(subg, e, n)) {
	    if ((((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) == 0) {
		(((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) = order;
...
static double largest_nodesize(nodelist_t * list)
{
    ...
    for (item = list->first; item; item = item->next) {
	n = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(item->curr))->data))->alg)))->orig.np);
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width) > size)
	    size = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->width);
	if ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height) > size)
	    size = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->height);
    }
    return size;
}
...
static void place_node(Agraph_t * g, Agnode_t * n, nodelist_t * list)
{
    ...
    for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	appendNodelist(neighbors, NULL, ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node));
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->alg)))->flags) |= (1 << 5));
    }
    for (e = agfstin(g, n); e; e = agnxtin(g, e)) {
	appendNodelist(neighbors, NULL, ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node));
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->alg)))->flags) |= (1 << 5));
    }
	...
	for (one = list->first; one; one = one->next) {
	    ...
	    if (((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(one->curr))->data))->alg)))->flags)&(1 << 5)) && ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(two->curr))->data))->alg)))->flags)&(1 << 5))) {
	...
	for (one = list->first; one; one = one->next) {
	    if (((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(one->curr))->data))->alg)))->flags)&(1 << 5))) {
		appendNodelist(list, one, n);
		placed = 1;
		break;
	    }
	...
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(one->curr))->data))->alg)))->flags) &= ~(1 << 5));
...
static void place_residual_nodes(Agraph_t * g, nodelist_t * list)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	if (!((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags)&(1 << 4)))
	    place_node(g, n, list);
    }
}
...
nodelist_t *layout_block(Agraph_t * g, block_t * sn, double min_dist)
{
	...
	radius = (N * (min_dist + largest_node)) / (2 * 3.14159265358979323846);

    for (item = longest_path->first; item; item = item->next) {
	n = item->curr;
	if (((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->flags)&(1 << 3))) {
    ...
    for (item = longest_path->first; item; item = item->next) {
	n = item->curr;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.f.pos) = k;
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.f.psi) = 0.0;
	theta = k * ((2.0 * 3.14159265358979323846) / N);

	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = radius * cos(theta);
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = radius * sin(theta);
