...
{
    nsitem_t *ap = (nsitem_t*)gmalloc(sizeof(nsitem_t));
...
{
    (*(((Dt_t*)(s))->searchf))((s),(void*)(0),0000100);
}
...
void insertNodeset(nodeset_t * ns, Agnode_t * n)
{
    ...
    key.np = n;
    (*(((Dt_t*)(ns))->searchf))((ns),(void*)(&key),0000001);
}
...
void removeNodeset(nodeset_t * ns, Agnode_t * n)
{
    ...
    key.np = n;
    (*(((Dt_t*)(ns))->searchf))((ns),(void*)(&key),0000002);
}
...
{
    nsitem_t *ip;
    for (ip = (nsitem_t *) (*(((Dt_t*)(ns))->searchf))((ns),(void*)(0),0000200); ip;
	 ip = (nsitem_t *) (*(((Dt_t*)(ns))->searchf))((ns),(void*)(ip),0000010)) {
