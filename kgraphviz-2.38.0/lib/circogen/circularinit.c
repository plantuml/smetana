#line 1 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 1
/* $Id$ $Revision$ */
...
#line 30 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 2
...
#line 31 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 2
...
#line 32 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\neatogen\\neatoprocs.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 33 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\circularinit.c" 1
...
static void circular_init_edge(edge_t * e)
{
    ...
    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->factor) = late_double(e, E_weight, 1.0, 0.0);
}
...
static void circular_init_node_edge(graph_t * g)
{
    ...
    edge_t *e;
    int i = 0;
    ndata* alg = (ndata*)zmalloc((agnnodes(g))*sizeof(ndata));

    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->neato_nlist) = (node_t **)zmalloc((agnnodes(g) + 1)*sizeof(node_t *));
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	neato_init_node(n);
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = alg + i;
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->neato_nlist)[i++] = n;
    }
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
			       ...
			       void *orig)
{
    ...
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg) = (void *) (cdata*)zmalloc(sizeof(cdata));
    if (isNode) {
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos) = (double*)zmalloc((Ndim)*sizeof(double));
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->lw) = (((Agnodeinfo_t*)(((Agobj_t*)((node_t *) orig))->data))->lw);
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->rw) = (((Agnodeinfo_t*)(((Agobj_t*)((node_t *) orig))->data))->rw);
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->ht) = (((Agnodeinfo_t*)(((Agobj_t*)((node_t *) orig))->data))->ht);
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.np) = (node_t *) orig;
    } else
	(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.g) = (graph_t *) orig;
    return n;
}
...
Agraph_t **circomps(Agraph_t * g, int *cnt)
{
    ...
    dg = agopen("derived", Agstrictundirected,((Agdisc_t *)0));
    agbindrec (dg, "info", sizeof(Agraphinfo_t), (!(0)));
    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg) = dg;  /* store derived graph for closing later */

    for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	if ((((ndata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->dnode))
	    continue;
	n = makeDerivedNode(dg, agnameof(v), 1, v);
	(((ndata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->dnode) = n;
    }

    for (v = agfstnode(g); v; v = agnxtnode(g, v)) {
	for (e = agfstout(g, v); e; e = agnxtout(g, e)) {
	    dt = (((ndata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 3?(e):((e)+1))->node)))->data))->alg)))->dnode);
	    dh = (((ndata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->alg)))->dnode);
	    if (dt != dh) {
		agbindrec(agedge(dg, dt, dh, (void *)0, 1), "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));	//node custom data
	    }
	}
    }
	...
	for (n = agfstnode(sg); n; n = agnxtnode(sg, n)) {
	    p = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.np);
	    for (e = agfstout(g, p); e; e = agnxtout(g, e)) {
		/* n = DNODE(agtail(e)); by construction since agtail(e) == p */
		dh = (((ndata*)((((Agnodeinfo_t*)(((Agobj_t*)(((((((Agobj_t*)(e))->tag).objtype) == 2?(e):((e)-1))->node)))->data))->alg)))->dnode);
		if (n != dh) {
		    ep = agedge(dg, n, dh, (void *)0, 1);
		    agbindrec(ep, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));	//node custom data
		    agsubedge(sg,ep,1);
		}
	    }
	}
	...
	for (e = agfstout(dg, n); e; e = agnxtout(dg, e)) {
	    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg) = (edata*)zmalloc(sizeof(edata));
	}
    }
...
static void closeDerivedGraph(graph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	for (e = agfstout(g, n); e; e = agnxtout(g, e)) {
	    free((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg));
	}
...
static void copyPosns(graph_t * g)
{
    ...
    for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	v = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.np);
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[0] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0];
	(((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->pos)[1] = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1];
    }
}
...
void circo_cleanup(graph_t * g)
{
    ...
    closeDerivedGraph((graph_t*)(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->alg));	/* delete derived graph */
