#line 1 "graphviz-2.38.0\\lib\\circogen\\blocktree.c" 1
/* $Id$ $Revision$ */
...
#line 1 "graphviz-2.38.0\\lib\\circogen\\blocktree.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\blocktree.h" 2
...
#line 20 "graphviz-2.38.0\\lib\\circogen\\blocktree.h" 2
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\blocktree.c" 2

static void addNode(block_t * bp, Agnode_t * n)
{
    agsubnode(bp->sub_graph, n,1);
    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->block) = bp;
}
...
static Agraph_t *makeBlockGraph(Agraph_t * g, circ_state * state)
{
    ...
    agbindrec(subg, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));	//node custom data
    return subg;
}
...
{
    (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->next) = s->top;
    s->top = e;
    s->sz += 1;
}
...
pop (estack* s)
{
    ...
    if (top) {
	assert(s->sz > 0);
	s->top = (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(top))->data))->alg)))->next);
	s->sz -= 1;
    } else {
	assert(0);
    }
...
static void dfs(Agraph_t * g, Agnode_t * u, circ_state * state, int isRoot, estack* stk)
{
    ...
    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val) = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.val) = state->orderCount++;
    for (e = agfstedge(g, u); e; e = agnxtedge(g, e, u)) {
	v = ((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node);
	if (v == u) {
            v = ((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node);
	    if (!(((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order)) (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) = -1;
	}
	else {
	    if (!(((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order)) (((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->alg)))->order) = 1;
	}

        if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.val) == 0) {   /* Since VAL(root) == 0, it gets treated as artificial cut point */
	    (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->parent) = u;
            push(stk, e);
            dfs(g, v, state, 0, stk);
            (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val) = (((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val))<((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.low_val))?((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val)):((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.low_val)));
            if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.low_val) >= (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.val)) {       /* u is an articulation point */
		block_t *block = NULL;
		Agnode_t *np;
		Agedge_t *ep;
                do {
                    ep = pop(stk);
		    if ((((edata*)((((Agedgeinfo_t*)(((Agobj_t*)(ep))->data))->alg)))->order) == 1)
			np = ((((((Agobj_t*)(ep))->tag).objtype) == 2? (ep): ((ep)-1))->node);
		    else
			np = ((((((Agobj_t*)(ep))->tag).objtype) == 3? (ep): ((ep)+1))->node);
		    if (!(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->alg)))->block)) {
			if (!block)
		...
		if (block) {	/* If block != NULL, it's not empty */
		    if (!(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->block) && blockSize (block) > 1)
			addNode(block, u);
		    if (isRoot && ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->block) == block))
			insertBlock(&state->bl, block);
		    else
			appendBlock(&state->bl, block);
		}
            }
        } else if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->parent) != v) {
            (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val) = (((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val))<((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.val))?((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->u.bc.low_val)):((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(v))->data))->alg)))->u.bc.val)));
        }
    }
    if (isRoot && !(((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(u))->data))->alg)))->block)) {
...
static void find_blocks(Agraph_t * g, circ_state * state)
{
	...
	for (n = agfstnode(g); n; n = agnxtnode(g, n)) {
	    if (late_bool((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.np), state->N_root, 0)) {
		root = n;
		break;
	    }
	}
...
block_t *createBlocktree(Agraph_t * g, circ_state * state)
{
	...
	min = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.bc.val);
	parent = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->parent);
	for (n = agnxtnode(subg, n); n; n = agnxtnode(subg, n)) {
	    if ((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.bc.val) < min) {
		child = n;
		min = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->u.bc.val);
		parent = (((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->parent);
	    }
	}
	((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->flags) |= (1 << 3));
	((bp)->child) = child;
	next = bp->next;	/* save next since list insertion destroys it */
	appendBlock(&((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(parent))->data))->alg)))->block)->children), bp);
    }
