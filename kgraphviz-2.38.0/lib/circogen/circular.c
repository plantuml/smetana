#line 1 "graphviz-2.38.0\\lib\\circogen\\circular.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\circular.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\circogen\\circular.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\circpos.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\circpos.h" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\circular.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 20 "graphviz-2.38.0\\lib\\circogen\\circpos.h" 2
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\circular.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\circular.c" 1
...
static void initGraphAttrs(Agraph_t * g, circ_state * state)
{
    ...
    rg = agraphof((((cdata*)((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->alg)))->orig.np));
    if (rg != rootg) {		/* new root graph */
	state->blockCount = 0;
	rootg = rg;
	G_mindist = agattr(rootg,0, "mindist", NULL);
	N_artpos = agattr(rootg,1, "articulation_pos", NULL);
	N_root = agattr(rootg,1, "root", NULL);
    }
    rootname = agget(rootg, "root");
    initBlocklist(&state->bl);
    state->orderCount = 1;
    state->min_dist = late_double(rootg, G_mindist, 1.0, 0.0);
...
void circularLayout(Agraph_t * g, Agraph_t* realg)
{
	...
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[0] = 0;
	(((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->pos)[1] = 0;
	return;
    }
