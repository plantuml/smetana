#line 1 "graphviz-2.38.0\\lib\\circogen\\deglist.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\deglist.c" 2
...
#line 18 "graphviz-2.38.0\\lib\\circogen\\deglist.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\circogen\\deglist.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\deglist.c" 1
...
{
    degitem *ap = (degitem*)gmalloc(sizeof(degitem));
...
void insertDeglist(deglist_t * ns, Agnode_t * n)
{
    ...
    key.deg = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->order));
    kp = (*(((Dt_t*)(ns))->searchf))((ns),(void*)(&key),0000001);
    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->next) = kp->np;
    kp->np = n;
}
...
void removeDeglist(deglist_t * list, Agnode_t * n)
{
    ...
    key.deg = ((((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->order));
    ip = (degitem *) (*(((Dt_t*)(list))->searchf))((list),(void*)(&key),0000004);
    assert(ip);
    if (ip->np == n) {
	ip->np = (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->next);
	if (ip->np == NULL)
	    (*(((Dt_t*)(list))->searchf))((list),(void*)(ip),0000002);
    } else {
	prev = ip->np;
	np = (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->next);
	while (np && (np != n)) {
	    prev = np;
	    np = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->next);
	}
	if (np)
	    (((Agnodeinfo_t*)(((Agobj_t*)(prev))->data))->next) = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->next);
    }
}
...
Agnode_t *firstDeglist(deglist_t * list)
{
    ...
    ip = (degitem *) (*(((Dt_t*)(list))->searchf))((list),(void*)(0),0000200);
    if (ip) {
	np = ip->np;
	ip->np = (((Agnodeinfo_t*)(((Agobj_t*)(np))->data))->next);
	if (ip->np == NULL)
	    (*(((Dt_t*)(list))->searchf))((list),(void*)(ip),0000002);
	return np;
    } else
