#line 1 "graphviz-2.38.0\\lib\\circogen\\edgelist.c" 1
/* $Id$ $Revision$ */
...
#line 17 "graphviz-2.38.0\\lib\\circogen\\edgelist.c" 2
#line 1 "graphviz-2.38.0\\lib\\circogen\\edgelist.c" 1

static edgelistitem *mkItem(Dt_t * d, edgelistitem * obj, Dtdisc_t * disc)
{
    edgelistitem *ap = (edgelistitem*)gmalloc(sizeof(edgelistitem));
...
void add_edge(edgelist * list, Agedge_t * e)
{
    ...
    temp.edge = e;
    (*(((Dt_t*)(list))->searchf))((list),(void*)(&temp),0000001);
}
...
void remove_edge(edgelist * list, Agedge_t * e)
{
    ...
    temp.edge = e;
    (*(((Dt_t*)(list))->searchf))((list),(void*)(&temp),0000002);
}
