#line 1 "graphviz-2.38.0\\lib\\gvc\\gvevent.c" 1
/* $Id$ $Revision$ */
...
#line 1 "graphviz-2.38.0\\lib\\gvc\\gvplugin_layout.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 17 "graphviz-2.38.0\\lib\\gvc\\gvplugin_layout.h" 2
...
#line 18 "graphviz-2.38.0\\lib\\gvc\\gvplugin_layout.h" 2
...
#line 19 "graphviz-2.38.0\\lib\\gvc\\gvplugin_layout.h" 2
...
#line 22 "graphviz-2.38.0\\lib\\gvc\\gvevent.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\gvc\\gvevent.c" 2
...
#line 24 "graphviz-2.38.0\\lib\\gvc\\gvevent.c" 2
...
static void gv_graph_state(GVJ_t *job, graph_t *g)
{
    ...
    a = (agattr(g,0,s_href,NULL));
    if (!a)
	a = (agattr(g,0,s_URL,NULL));
    if (a)
...
static void gv_node_state(GVJ_t *job, node_t *n)
{
    ...
    g = agroot(agraphof(n));
    a = NULL;
    while ((a = agnxtattr(g, 1, a))) {
        gv_argvlist_set_item(list, j++, a->name);
        gv_argvlist_set_item(list, j++, agxget(n, a));
    }
    list->argc = j;

    a = (agattr(agraphof(n),1,s_href,NULL));
    if (!a)
        a = (agattr(agraphof(n),1,s_URL,NULL));
    if (a)
...
static void gv_edge_state(GVJ_t *job, edge_t *e)
{
    ...
    gv_argvlist_set_item(nlist, j++, agnameof(((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node)));
    j++; /* skip tailport slot for now */
    gv_argvlist_set_item(nlist, j++, agisdirected(agraphof(((((((Agobj_t*)(e))->tag).objtype) == 3? (e): ((e)+1))->node)))?"->":"--");
    gv_argvlist_set_item(nlist, j++, agnameof(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)));
    ...
    a = (agattr(agraphof(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)),2,s_href,NULL));
    if (!a)
	a = (agattr(agraphof(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)),2,s_URL,NULL));
    if (a)
...
static void gvevent_refresh(GVJ_t * job)
{
    ...
    if (!job->selected_obj) {
	job->selected_obj = g;
	(((Agraphinfo_t*)(((Agobj_t*)(g))->data))->gui_state) |= (1<<1);
	gv_graph_state(job, g);
    }
    emit_graph(job, g);
    job->has_been_rendered = (!(0));
}
...
static graph_t *gvevent_find_cluster(graph_t *g, boxf b)
{
	...
	sg = gvevent_find_cluster((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->clust)[i], b);
	if (sg)
	    return(sg);
    }
    ((((bb).LL).x = (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).x,((bb).LL).y = (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).LL).y),(((bb).UR).x = (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).x,((bb).UR).y = (((((Agraphinfo_t*)(((Agobj_t*)(g))->data))->bb)).UR).y));
...
static void gvevent_leave_obj(GVJ_t * job)
{
    ...
    if (obj) {
        ...
        case 0:
	    (((Agraphinfo_t*)(((Agobj_t*)((graph_t*)obj))->data))->gui_state) &= ~(1<<0);
	    break;
        case 1:
	    (((Agnodeinfo_t*)(((Agobj_t*)((node_t*)obj))->data))->gui_state) &= ~(1<<0);
	    break;
        case 2:
	    (((Agedgeinfo_t*)(((Agobj_t*)((edge_t*)obj))->data))->gui_state) &= ~(1<<0);
	    break;
        }
    }
...
static void gvevent_enter_obj(GVJ_t * job)
{
    ...
    if (obj) {
        ...
        case 0:
	    g = (graph_t*)obj;
	    (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->gui_state) |= (1<<0);
	    a = (agattr(g,0,s_tooltip,NULL));
	    if (a)
		job->active_tooltip = strdup_and_subst_obj(agxget(g, a), obj);
	    break;
        case 1:
	    n = (node_t*)obj;
	    (((Agnodeinfo_t*)(((Agobj_t*)(n))->data))->gui_state) |= (1<<0);
	    a = (agattr(agraphof(n),1,s_tooltip,NULL));
	    if (a)
		job->active_tooltip = strdup_and_subst_obj(agxget(n, a), obj);
	    break;
        case 2:
	    e = (edge_t*)obj;
	    (((Agedgeinfo_t*)(((Agobj_t*)(e))->data))->gui_state) |= (1<<0);
	    a = (agattr(agraphof(((((((Agobj_t*)(e))->tag).objtype) == 2? (e): ((e)-1))->node)),2,s_tooltip,NULL));
	    if (a)
...
static void gvevent_select_current_obj(GVJ_t * job)
{
    ...
    if (obj) {
        switch (agobjkind(obj)) {
        case 0:
	    (((Agraphinfo_t*)(((Agobj_t*)((graph_t*)obj))->data))->gui_state) |= (1<<2);
	    (((Agraphinfo_t*)(((Agobj_t*)((graph_t*)obj))->data))->gui_state) &= ~(1<<1);
	    break;
        case 1:
	    (((Agnodeinfo_t*)(((Agobj_t*)((node_t*)obj))->data))->gui_state) |= (1<<2);
	    (((Agnodeinfo_t*)(((Agobj_t*)((node_t*)obj))->data))->gui_state) &= ~(1<<1);
	    break;
        case 2:
	    (((Agedgeinfo_t*)(((Agobj_t*)((edge_t*)obj))->data))->gui_state) |= (1<<2);
	    (((Agedgeinfo_t*)(((Agobj_t*)((edge_t*)obj))->data))->gui_state) &= ~(1<<1);
	    break;
        }
    }
...
/* FIXME - should code window 0,0 point as feature with Y_GOES_DOWN */
        ...
        if (job->rotation) {
            job->focus.x -= (pointer.y - job->height / 2.)
                    * (1.1 - 1.) / (job->zoom * job->devscale.y);
            job->focus.y += (pointer.x - job->width / 2.)
                    * (1.1 - 1.) / (job->zoom * job->devscale.x);
        }
        else {
...
static void gvevent_motion(GVJ_t * job, pointf pointer)
{
    ...
    if (abs(dx) < .0001 && abs(dy) < .0001)  /* ignore motion events with no motion */
	return;
...
/*      lib/gvc/gvevent.c */
	...
	job->zoom =
	    (((double) job->width /(double) dflt_width)<(
(double) job->height /(double) dflt_height)?((double) job->width /(double) dflt_width):(
...
static void gvevent_read (GVJ_t * job, const char *filename, const char *layout)
{
    ...
    aginit (g, 0, "Agraphinfo_t", sizeof(Agraphinfo_t), (!(0)));
    aginit (g, 1, "Agnodeinfo_t", sizeof(Agnodeinfo_t), (!(0)));
    aginit (g, 2, "Agedgeinfo_t", sizeof(Agedgeinfo_t), (!(0)));
    gvc->g = g;
