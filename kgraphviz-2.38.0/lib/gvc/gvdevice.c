#line 1 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 1
/* $Id$ $Revision$ */
...
#line 39 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 40 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 41 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
#line 1 "graphviz-2.38.0\\lib\\gvc\\gvcjob.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 42 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 43 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 44 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 45 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
...
#line 46 "graphviz-2.38.0\\lib\\gvc\\gvdevice.c" 2
    ...
    if (job->output_filename
      ...
      && ! job->external_context) {
        if (job->output_file) {
            ...
            job->output_file = (void *)0;
        }
	job->output_filename = (void *)0;
    }
}
...
static double maxnegnum = -999999999999999.99; static char maxnegnumstr[] = "-999999999999999.99";
...
static char * gvprintnum (size_t *len, double number)
{
	...
	*len = sizeof(maxnegnumstr)-2;  /* len doesn't include terminator or sign */
    ...
    number *= 100;		/* scale by DECPLACES_SCALE */
	...
	*len = 1;
    ...
    showzeros = 0;			/* don't print trailing zeros */
    for (i = 2; N || i > 0; i--) {  /* non zero remainder,
