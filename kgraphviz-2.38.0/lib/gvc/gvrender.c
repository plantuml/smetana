#line 1 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 1
/* $Id$ $Revision$ */
...
#line 25 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 26 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 27 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 28 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 29 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
#line 1 "graphviz-2.38.0\\lib\\cgraph\\cgraph.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 30 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 31 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\geom.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 32 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 33 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
#line 34 "graphviz-2.38.0\\lib\\gvc\\gvrender.c" 2
...
int gvrender_select(GVJ_t * job, const char *str)
{
	...
	return 999;	/* FIXME - should differentiate problem */
...
void gvrender_set_style(GVJ_t * job, char **s)
{
	...
	if (s)
	    while ((p = line = *s++)) {
		if ((*(line)==*("solid")&&!strcmp(line,"solid")))
		    obj->pen = PEN_SOLID;
		else if ((*(line)==*("dashed")&&!strcmp(line,"dashed")))
		    obj->pen = PEN_DASHED;
		else if ((*(line)==*("dotted")&&!strcmp(line,"dotted")))
		    obj->pen = PEN_DOTTED;
		else if ((*(line)==*("invis")&&!strcmp(line,"invis")) || (*(line)==*("invisible")&&!strcmp(line,"invisible")))
		    obj->pen = PEN_NONE;
		else if ((*(line)==*("bold")&&!strcmp(line,"bold")))
		    obj->penwidth = 2.;
		else if ((*(line)==*("setlinewidth")&&!strcmp(line,"setlinewidth"))) {
		    while (*p)
			p++;
		    p++;
		    obj->penwidth = atof(p);
		} else if ((*(line)==*("filled")&&!strcmp(line,"filled")))
		    obj->fill = FILL_SOLID;
		else if ((*(line)==*("unfilled")&&!strcmp(line,"unfilled")))
		    obj->fill = FILL_NONE;
		else if ((*(line)==*("tapered")&&!strcmp(line,"tapered")));
		else {
		    agerr(AGWARN,
			...
			boolean filled, char *imagescale)
{
    ...
    b.LL = b.UR = a[0];
    for (i = 1; i < n; i++) {
	((b).LL.x = (((b).LL.x)<((a[i]).x)?((b).LL.x):((a[i]).x)), (b).LL.y = (((b).LL.y)<((a[i]).y)?((b).LL.y):((a[i]).y)), (b).UR.x = (((b).UR.x)>((a[i]).x)?((b).UR.x):((a[i]).x)), (b).UR.y = (((b).UR.y)>((a[i]).y)?((b).UR.y):((a[i]).y)));
    }
