#line 1 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 1
 /* $Id$ $Revision$ */
...
#line 18 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
...
#line 19 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
...
#line 20 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
...
#line 21 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
...
#line 22 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
#line 1 "graphviz-2.38.0\\lib\\gvc\\gvconfig.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 19 "graphviz-2.38.0\\lib\\gvc\\gvconfig.h" 2
...
#line 23 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
...
#line 24 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 2
#line 1 "graphviz-2.38.0\\lib\\gvc\\gvc.c" 1
...
int gvRender(GVC_t *gvc, graph_t *g, const char *format, FILE *out)
{
    ...
    if (!(agbindrec(g, "Agraphinfo_t", 0, (!(0))) && (((Agraphinfo_t*)(((Agobj_t*)(g))->data))->drawing)) && !(job->flags & (1<<26))) {
...
/* page size on Linux, Mac OS X and Windows */
    ...
    if(!result || !(*result = malloc(4096))) {
	agerr(AGERR, "failure malloc'ing for result string");
	return -1;
    }

    job->output_data = *result;
    job->output_data_allocated = 4096;
