#line 1 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 1
/* $Id$ $Revision$ */
...
#line 20 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 21 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 22 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 23 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 24 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 25 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 26 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 27 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
#line 29 "graphviz-2.38.0\\lib\\gvc\\gvplugin.c" 2
...
static char *api_names[] = { "render", "layout", "textlayout", "device", "loadimage", };    /* "render", "layout", ... */
...
api_t gvplugin_api(char *str)
{
    ...
    for (api = 0; api < (sizeof(api_names)/sizeof(api_names[0])); api++) {
...
{
    if (api >= (sizeof(api_names)/sizeof(api_names[0])))
        return NULL;
                         ...
                         int quality, gvplugin_package_t * package, gvplugin_installed_t * typeptr)
{
    ...
    char *p, pins[63 + 1], pnxt[63 + 1];

    strncpy(pins, typestr, 63);
    if ((p = strchr(pins, ':')))
        *p = '\0';
    ...
    plugin = (gvplugin_available_t*)gmalloc(sizeof(gvplugin_available_t));
    plugin->next = *pnext;
    *pnext = plugin;
...
char *gvplugin_list(GVC_t * gvc, api_t api, const char *str)
{
    ...
    if (new)
        ...
        bp = (((((&xb)->ptr >= (&xb)->eptr) ? agxbmore(&xb,1) : 0), (int)(*(&xb)->ptr++ = ((unsigned char)'\0'))),(char*)((&xb)->ptr = (&xb)->buf));
    return bp;
}
...
Agraph_t *gvplugin_graph(GVC_t * gvc)
{
    ...
    agattr(g, AGNODE, "label", "\\N");
    agattr(g, AGNODE, "shape", "");
    agattr(g, AGNODE, "style", "");
    agattr(g, AGNODE, "width", "");
    agattr(g, AGEDGE, "style", "");

    a = (agattr(g,AGRAPH,"rankdir",NULL));
    agxset(g, a, "LR");

    a = (agattr(g,AGRAPH,"ranksep",NULL));
    agxset(g, a, "2.5");

    a = (agattr(g,AGRAPH,"label",NULL));
    agxset(g, a, "Plugins");
        ...
        for (api = 0; api < (sizeof(api_names)/sizeof(api_names[0])); api++) {
			...
			lq = q;
			    ...
			    lq = "tiff\\ntif";
                        ...
                        strcpy(buf2, q);
                        n = agnode(ssg, bufa, 1);
                        a = (agattr(g,AGNODE,"label",NULL));
                        agxset(n, a, lq);
                        a = (agattr(g,AGNODE,"width",NULL));
                        agxset(n, a, "1.0");
                        a = (agattr(g,AGNODE,"shape",NULL));
			if (api == API_device) {
                            agxset(n, a, "box");
                            device_n = n;
			}
