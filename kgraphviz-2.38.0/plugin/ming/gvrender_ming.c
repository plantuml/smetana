#line 1 "graphviz-2.38.0\\plugin\\ming\\gvrender_ming.c" 1
/* $Id$ $Revision$ */
...
#line 20 "graphviz-2.38.0\\plugin\\ming\\gvrender_ming.c" 2
...
/* FIXME - hardcoded to a Times-like font */
	...
	font_file_name = malloc(strlen(libdir)+strlen("Bitstream_Vera_Serif.fdb")+2);
	strcpy(font_file_name, libdir);
	strcat(font_file_name, "/");
	strcat(font_file_name, "Bitstream_Vera_Serif.fdb");
