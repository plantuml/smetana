#line 1 "graphviz-2.38.0\\plugin\\core\\gvloadimage_core.c" 1
/* $Id$ $Revision$ */
...
#line 22 "graphviz-2.38.0\\plugin\\core\\gvloadimage_core.c" 2
...
#line 23 "graphviz-2.38.0\\plugin\\core\\gvloadimage_core.c" 2
...
#line 24 "graphviz-2.38.0\\plugin\\core\\gvloadimage_core.c" 2
...
#line 25 "graphviz-2.38.0\\plugin\\core\\gvloadimage_core.c" 2
...
static void core_loadimage_fig(GVJ_t * job, usershape_t *us, boxf bf, boolean filled)
{
    ...
    ((((b).LL).x = ((((bf).LL).x>=0)?(int)(((bf).LL).x + .5):(int)(((bf).LL).x - .5)),((b).LL).y = ((((bf).LL).y>=0)?(int)(((bf).LL).y + .5):(int)(((bf).LL).y - .5))),(((b).UR).x = ((((bf).UR).x>=0)?(int)(((bf).UR).x + .5):(int)(((bf).UR).x - .5)),((b).UR).y = ((((bf).UR).y>=0)?(int)(((bf).UR).y + .5):(int)(((bf).UR).y - .5))));
