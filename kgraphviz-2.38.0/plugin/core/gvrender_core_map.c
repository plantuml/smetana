#line 1 "graphviz-2.38.0\\plugin\\core\\gvrender_core_map.c" 1
/* $Id$ $Revision$ */
...
#line 20 "graphviz-2.38.0\\plugin\\core\\gvrender_core_map.c" 2
...
#line 21 "graphviz-2.38.0\\plugin\\core\\gvrender_core_map.c" 2
...
#line 22 "graphviz-2.38.0\\plugin\\core\\gvrender_core_map.c" 2
                ...
                char* url, char *tooltip, char *target, char *id)
{
    ...
    for (i = 0; i < nump; i++)
	((A[i]).x = (((AF[i]).x>=0)?(int)((AF[i]).x + .5):(int)((AF[i]).x - .5)),(A[i]).y = (((AF[i]).y>=0)?(int)((AF[i]).y + .5):(int)((AF[i]).y - .5)));
