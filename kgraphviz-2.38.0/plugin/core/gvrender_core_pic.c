#line 1 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 1
/* $Id$ $Revision$ */
...
#line 23 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
#line 24 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
#line 25 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
#line 26 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
#line 27 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
#line 1 "graphviz-2.38.0\\lib\\common\\color.h" 1
/* $Id$ $Revision$ */
/* vim:set shiftwidth=4 ts=8: */
...
#line 28 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
#line 30 "graphviz-2.38.0\\plugin\\core\\gvrender_core_pic.c" 2
...
static void pic_begin_page(GVJ_t * job)
{
    ...
    height = (((double)(pbr.UR.y) -(double)(pbr.LL.y))/(double)72);
    width = (((double)(pbr.UR.x) -(double)(pbr.LL.x))/(double)72);
    if (job->rotation == 90) {
        double temp = width;
        width = height;
        height = temp;
...
static void pic_textspan(GVJ_t * job, pointf p, textspan_t * span)
{
    ...
    p.y += span->font->size / (3.0 * 72);
    p.x += span->size.x / (2.0 * 72);
...
static void pic_ellipse(GVJ_t * job, pointf * A, int filled)
{
    ...
    gvprintf(job,
		...
		filled ? "fill " : "",
		((2*(A[1].x - A[0].x))/(double)72),
		((2*(A[1].y - A[0].y))/(double)72),
		((A[0].x)/(double)72),
		((A[0].y)/(double)72));
}
