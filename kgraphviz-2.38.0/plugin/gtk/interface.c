#line 1 "graphviz-2.38.0\\plugin\\gtk\\interface.c" 1
/*
...
on_button1_button_press_event          (GtkWidget       *widget,
                                        GdkEventButton  *event,
                                        gpointer         user_data);
#line 17 "graphviz-2.38.0\\plugin\\gtk\\interface.c" 2
...
#line 18 "graphviz-2.38.0\\plugin\\gtk\\interface.c" 2
...
#line 19 "graphviz-2.38.0\\plugin\\gtk\\interface.c" 2
...
create_window1 (void)
{
  ...
  label1 = gtk_label_new (("type - name"));
  ...
  button1 = gtk_button_new_with_mnemonic (("Delete"));
  ...
  g_object_set_data_full (G_OBJECT (window1), "vbox1", gtk_widget_ref (vbox1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menubar1", gtk_widget_ref (menubar1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menuitem4", gtk_widget_ref (menuitem4), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menu4", gtk_widget_ref (menu4), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "new1", gtk_widget_ref (new1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "open1", gtk_widget_ref (open1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "save1", gtk_widget_ref (save1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "save_as1", gtk_widget_ref (save_as1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "separatormenuitem1", gtk_widget_ref (separatormenuitem1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "quit1", gtk_widget_ref (quit1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menuitem5", gtk_widget_ref (menuitem5), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menu5", gtk_widget_ref (menu5), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "cut1", gtk_widget_ref (cut1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "copy1", gtk_widget_ref (copy1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "paste1", gtk_widget_ref (paste1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "delete1", gtk_widget_ref (delete1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menuitem6", gtk_widget_ref (menuitem6), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menu6", gtk_widget_ref (menu6), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menuitem7", gtk_widget_ref (menuitem7), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "menu7", gtk_widget_ref (menu7), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "about1", gtk_widget_ref (about1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "hpaned1", gtk_widget_ref (hpaned1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "vbox2", gtk_widget_ref (vbox2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "hbox2", gtk_widget_ref (hbox2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "drawingarea2", gtk_widget_ref (drawingarea2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "scrolledwindow3", gtk_widget_ref (scrolledwindow3), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "treeview1", gtk_widget_ref (treeview1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "toolbar1", gtk_widget_ref (toolbar1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "toolitem1", gtk_widget_ref (toolitem1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "label1", gtk_widget_ref (label1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "toolitem2", gtk_widget_ref (toolitem2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "label2", gtk_widget_ref (label2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "toolitem3", gtk_widget_ref (toolitem3), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "button1", gtk_widget_ref (button1), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "scrolledwindow4", gtk_widget_ref (scrolledwindow4), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "treeview2", gtk_widget_ref (treeview2), (GDestroyNotify) gtk_widget_unref);
  g_object_set_data_full (G_OBJECT (window1), "drawingarea1", gtk_widget_ref (drawingarea1), (GDestroyNotify) gtk_widget_unref);
