#line 1 "graphviz-2.38.0\\plugin\\gtk\\callbacks.c" 1
/* $Id$ $Revision$ */
...
#line 20 "graphviz-2.38.0\\plugin\\gtk\\callbacks.c" 2

#line 1 "graphviz-2.38.0\\plugin\\gtk\\callbacks.h" 1
#line 1 "graphviz-2.38.0\\plugin\\gtk\\callbacks.h" 1
...
on_button1_button_press_event          (GtkWidget       *widget,
                                        GdkEventButton  *event,
                                        gpointer         user_data);
#line 22 "graphviz-2.38.0\\plugin\\gtk\\callbacks.c" 2
#line 1 "graphviz-2.38.0\\plugin\\gtk\\interface.h" 1
/*
 * DO NOT EDIT THIS FILE - it is generated by Glade.
 */

GtkWidget* create_window1 (void);
#line 23 "graphviz-2.38.0\\plugin\\gtk\\callbacks.c" 2
#line 1 "graphviz-2.38.0\\plugin\\gtk\\support.h" 1
/*
 * DO NOT EDIT THIS FILE - it is generated by Glade.
 */
...
#line 24 "graphviz-2.38.0\\plugin\\gtk\\callbacks.c" 2
                                        ...
                                        gpointer         user_data)
{
    ...
    tmp = job->zoom;
    job->zoom = ((job->width * 72 /(job->bb.UR.x * job->dpi.x))<(
 job->height * 72 /(job->bb.UR.y * job->dpi.y))?(job->width * 72 /(job->bb.UR.x * job->dpi.x)):(
 job->height * 72 /(job->bb.UR.y * job->dpi.y)));
    (job->callbacks->refresh)(job);
    job->zoom = tmp;
...
/*      lib/gvc/gvevent.c */
    ...
    job = (GVJ_t *)g_object_get_data(G_OBJECT(widget),"job");
    if (! job->has_been_rendered) {
	zoom_to_fit = (((double) event->width /(double) job->width)<(
(double) event->height /(double) job->height)?((double) event->width /(double) job->width):(
